...
pub type HALTMSK_L_R = crate::FR<u8, u8>;
#[doc = r"Proxy"]
...
#[doc = r"Reader of the field"]
pub type HALTMSK_H_R = crate::FR<u8, u8>;
#[doc = r"Proxy"]
...
impl R {
    ...
    pub fn haltmsk_l(&self) -> HALTMSK_L_R {
        HALTMSK_L_R::new((self.bits() & 0x3f) as u8)
    }
    #[doc = "Bits 16:21 - If bit n is one, event n sets the HALT_H bit in the CTRL register (event 0 = bit 16, event 1 = bit 17, event 5 = bit 21)."]
    #[inline(always)]
    pub fn haltmsk_h(&self) -> HALTMSK_H_R {
        HALTMSK_H_R::new(((self.bits() >> 16) & 0x3f) as u8)
    }
}
impl W {
