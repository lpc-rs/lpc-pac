...
pub type LIMMSK_L_R = crate::FR<u8, u8>;
#[doc = r"Proxy"]
...
#[doc = r"Reader of the field"]
pub type LIMMSK_H_R = crate::FR<u8, u8>;
#[doc = r"Proxy"]
...
impl R {
    ...
    #[doc = "Bits 16:21 - If bit n is one, event n is used as a counter limit for the H counter (event 0 = bit 16, event 1 = bit 17, event 5 = bit 21)."]
    #[inline(always)]
