...
pub type STARTMSK_L_R = crate::FR<u8, u8>;
#[doc = r"Proxy"]
...
#[doc = r"Reader of the field"]
pub type STARTMSK_H_R = crate::FR<u8, u8>;
#[doc = r"Proxy"]
...
impl R {
    ...
    pub fn startmsk_l(&self) -> STARTMSK_L_R {
        STARTMSK_L_R::new((self.bits() & 0x3f) as u8)
    }
    #[doc = "Bits 16:21 - If bit n is one, event n clears the STOP_H bit in the CTRL register (event 0 = bit 16, event 1 = bit 17, event 5 = bit 21)."]
    #[inline(always)]
    pub fn startmsk_h(&self) -> STARTMSK_H_R {
        STARTMSK_H_R::new(((self.bits() >> 16) & 0x3f) as u8)
    }
}
impl W {
