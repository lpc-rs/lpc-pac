...
impl FLASHTIMR {
    ...
    pub fn bits(&self) -> u8 {
        match *self {
            ...
            FLASHTIMR::RESERVED_ => 2,
            FLASHTIMR::RESERVED_ => 3,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    ...
    pub fn _from(value: u8) -> FLASHTIMR {
        match value {
            ...
            2 => FLASHTIMR::RESERVED_,
            3 => FLASHTIMR::RESERVED_,
            _ => unreachable!(),
        }
    }
...
impl FLASHTIMW {
    ...
    pub fn _bits(&self) -> u8 {
        match *self {
            ...
            FLASHTIMW::RESERVED_ => 2,
            FLASHTIMW::RESERVED_ => 3,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _FLASHTIMW<'a> {
    ...
    pub fn reserved_(self) -> &'a mut W {
        self.variant(FLASHTIMW::RESERVED_)
    }
    #[doc = "Reserved."]
    #[inline]
    pub fn reserved_(self) -> &'a mut W {
