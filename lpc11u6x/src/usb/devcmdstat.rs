...
impl LPM_SUPR {
    ...
    pub fn _from(value: bool) -> LPM_SUPR {
        match value {
            false => LPM_SUPR::LPM_NOT_SUPPORTED,
            true => LPM_SUPR::LPM_SUPPORTED,
        }
    }
...
impl INTONNAK_AOR {
    ...
    pub fn _from(value: bool) -> INTONNAK_AOR {
        match value {
            false => INTONNAK_AOR::ONLY_ACKNOWLEDGED_PA,
            true => INTONNAK_AOR::BOTH_ACKNOWLEDGED_AN,
        }
    }
...
impl INTONNAK_AIR {
    ...
    pub fn _from(value: bool) -> INTONNAK_AIR {
        match value {
            false => INTONNAK_AIR::ONLY_ACKNOWLEDGED_PA,
            true => INTONNAK_AIR::BOTH_ACKNOWLEDGED_AN,
        }
    }
    #[doc = "Checks if the value of the field is `ONLY_ACKNOWLEDGED_PA`"]
    #[inline]
...
impl INTONNAK_COR {
    ...
    pub fn _from(value: bool) -> INTONNAK_COR {
        match value {
            false => INTONNAK_COR::ONLY_ACKNOWLEDGED_PA,
            true => INTONNAK_COR::BOTH_ACKNOWLEDGED_AN,
        }
    }
    #[doc = "Checks if the value of the field is `ONLY_ACKNOWLEDGED_PA`"]
    #[inline]
...
impl INTONNAK_CIR {
    ...
    pub fn _from(value: bool) -> INTONNAK_CIR {
        match value {
            false => INTONNAK_CIR::ONLY_ACKNOWLEDGED_PA,
            true => INTONNAK_CIR::BOTH_ACKNOWLEDGED_AN,
        }
    }
    #[doc = "Checks if the value of the field is `ONLY_ACKNOWLEDGED_PA`"]
    #[inline]
