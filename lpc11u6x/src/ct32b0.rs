...
pub struct RegisterBlock {
    ...
    pub ccr: CCR,
    #[doc = "0x2c - Capture Register. CR is loaded with the value of TC when there is an event on the CAP input."]
    pub cr: [CR; 3],
...
#[doc = "Capture Control Register. The CCR controls which edges of the capture inputs are used to load the Capture Registers and whether or not an interrupt is generated when a capture takes place."]
pub mod ccr;
#[doc = "Capture Register. CR is loaded with the value of TC when there is an event on the CAP input."]
pub struct CR {
    register: vcell::VolatileCell<u32>,
}
#[doc = "Capture Register. CR is loaded with the value of TC when there is an event on the CAP input."]
