#[doc = "Reader of register DMA_OTRIG_INMUX[%s]"]
pub type R = crate::R<u32, super::DMA_OTRIG_INMUX>;
#[doc = "Writer for register DMA_OTRIG_INMUX[%s]"]
pub type W = crate::W<u32, super::DMA_OTRIG_INMUX>;
#[doc = "Register DMA_OTRIG_INMUX[%s]
`reset()`'s with value 0x1f"]
impl crate::ResetValue for super::DMA_OTRIG_INMUX {
    type Type = u32;
    #[inline(always)]
