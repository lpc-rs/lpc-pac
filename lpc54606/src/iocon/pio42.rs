#[doc = "Reader of register PIO42"]
pub type R = crate::R<u32, super::PIO42>;
#[doc = "Writer for register PIO42"]
pub type W = crate::W<u32, super::PIO42>;
#[doc = "Register PIO42 `reset()`'s with value 0x0320"]
impl crate::ResetValue for super::PIO42 {
    type Type = u32;
    #[inline(always)]
