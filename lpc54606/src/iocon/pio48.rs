#[doc = "Reader of register PIO48"]
pub type R = crate::R<u32, super::PIO48>;
#[doc = "Writer for register PIO48"]
pub type W = crate::W<u32, super::PIO48>;
#[doc = "Register PIO48 `reset()`'s with value 0x0320"]
impl crate::ResetValue for super::PIO48 {
    type Type = u32;
    #[inline(always)]
