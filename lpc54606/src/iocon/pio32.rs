#[doc = "Reader of register PIO32"]
pub type R = crate::R<u32, super::PIO32>;
#[doc = "Writer for register PIO32"]
pub type W = crate::W<u32, super::PIO32>;
#[doc = "Register PIO32 `reset()`'s with value 0x0320"]
impl crate::ResetValue for super::PIO32 {
    type Type = u32;
    #[inline(always)]
