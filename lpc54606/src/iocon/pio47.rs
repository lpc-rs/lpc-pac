#[doc = "Reader of register PIO47"]
pub type R = crate::R<u32, super::PIO47>;
#[doc = "Writer for register PIO47"]
pub type W = crate::W<u32, super::PIO47>;
#[doc = "Register PIO47 `reset()`'s with value 0x0320"]
impl crate::ResetValue for super::PIO47 {
    type Type = u32;
    #[inline(always)]
