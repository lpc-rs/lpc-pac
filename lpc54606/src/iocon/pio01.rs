#[doc = "Reader of register PIO01"]
pub type R = crate::R<u32, super::PIO01>;
#[doc = "Writer for register PIO01"]
pub type W = crate::W<u32, super::PIO01>;
#[doc = "Register PIO01 `reset()`'s with value 0x0320"]
impl crate::ResetValue for super::PIO01 {
    type Type = u32;
    #[inline(always)]
