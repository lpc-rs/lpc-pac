#[doc = "Reader of register PIO52"]
pub type R = crate::R<u32, super::PIO52>;
#[doc = "Writer for register PIO52"]
pub type W = crate::W<u32, super::PIO52>;
#[doc = "Register PIO52 `reset()`'s with value 0x0320"]
impl crate::ResetValue for super::PIO52 {
    type Type = u32;
    #[inline(always)]
