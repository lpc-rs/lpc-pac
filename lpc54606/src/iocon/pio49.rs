#[doc = "Reader of register PIO49"]
pub type R = crate::R<u32, super::PIO49>;
#[doc = "Writer for register PIO49"]
pub type W = crate::W<u32, super::PIO49>;
#[doc = "Register PIO49 `reset()`'s with value 0x0320"]
impl crate::ResetValue for super::PIO49 {
    type Type = u32;
    #[inline(always)]
