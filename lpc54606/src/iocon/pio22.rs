#[doc = "Reader of register PIO22"]
pub type R = crate::R<u32, super::PIO22>;
#[doc = "Writer for register PIO22"]
pub type W = crate::W<u32, super::PIO22>;
#[doc = "Register PIO22 `reset()`'s with value 0x0320"]
impl crate::ResetValue for super::PIO22 {
    type Type = u32;
    #[inline(always)]
