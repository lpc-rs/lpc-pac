#[doc = "Reader of register PIO07"]
pub type R = crate::R<u32, super::PIO07>;
#[doc = "Writer for register PIO07"]
pub type W = crate::W<u32, super::PIO07>;
#[doc = "Register PIO07 `reset()`'s with value 0x0320"]
impl crate::ResetValue for super::PIO07 {
    type Type = u32;
    #[inline(always)]
