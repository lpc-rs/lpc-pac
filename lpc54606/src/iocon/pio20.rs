#[doc = "Reader of register PIO20"]
pub type R = crate::R<u32, super::PIO20>;
#[doc = "Writer for register PIO20"]
pub type W = crate::W<u32, super::PIO20>;
#[doc = "Register PIO20 `reset()`'s with value 0x0320"]
impl crate::ResetValue for super::PIO20 {
    type Type = u32;
    #[inline(always)]
