#[doc = "Reader of register PIO53"]
pub type R = crate::R<u32, super::PIO53>;
#[doc = "Writer for register PIO53"]
pub type W = crate::W<u32, super::PIO53>;
#[doc = "Register PIO53 `reset()`'s with value 0x0320"]
impl crate::ResetValue for super::PIO53 {
    type Type = u32;
    #[inline(always)]
