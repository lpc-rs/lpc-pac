#[doc = "Reader of register PIO55"]
pub type R = crate::R<u32, super::PIO55>;
#[doc = "Writer for register PIO55"]
pub type W = crate::W<u32, super::PIO55>;
#[doc = "Register PIO55 `reset()`'s with value 0x0320"]
impl crate::ResetValue for super::PIO55 {
    type Type = u32;
    #[inline(always)]
