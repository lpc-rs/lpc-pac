#[doc = "Reader of register PIO39"]
pub type R = crate::R<u32, super::PIO39>;
#[doc = "Writer for register PIO39"]
pub type W = crate::W<u32, super::PIO39>;
#[doc = "Register PIO39 `reset()`'s with value 0x0320"]
impl crate::ResetValue for super::PIO39 {
    type Type = u32;
    #[inline(always)]
