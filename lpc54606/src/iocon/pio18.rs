#[doc = "Reader of register PIO18"]
pub type R = crate::R<u32, super::PIO18>;
#[doc = "Writer for register PIO18"]
pub type W = crate::W<u32, super::PIO18>;
#[doc = "Register PIO18 `reset()`'s with value 0x0320"]
impl crate::ResetValue for super::PIO18 {
    type Type = u32;
    #[inline(always)]
