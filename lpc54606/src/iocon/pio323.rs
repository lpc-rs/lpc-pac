...
impl core::convert::From<crate::R<PIO323_SPEC>> for R {
    fn from(reader: crate::R<PIO323_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PIO323` writer"]
...
impl core::convert::From<crate::W<PIO323_SPEC>> for W {
...
#[doc = "`read()` method returns [pio323::R](R) reader structure"]
impl crate::Readable for PIO323_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pio323::W](W) writer structure"]
impl crate::Writable for PIO323_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PIO323 to value 0x0340"]
