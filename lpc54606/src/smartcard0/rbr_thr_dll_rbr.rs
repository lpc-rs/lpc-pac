...
impl core::convert::From<crate::R<RBR_THR_DLL_RBR_SPEC>> for R {
    fn from(reader: crate::R<RBR_THR_DLL_RBR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Field `RBR` reader - The SCIn Receiver Buffer Register contains the oldest received byte in the SCIn Rx FIFO."]
...
impl R {
    #[doc = "Bits 0:7 - The SCIn Receiver Buffer Register contains the oldest received byte in the SCIn Rx FIFO."]
    #[inline(always)]
...
#[doc = "`read()` method returns [rbr_thr_dll_rbr::R](R) reader structure"]
