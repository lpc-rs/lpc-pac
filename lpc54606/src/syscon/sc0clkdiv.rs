...
impl core::convert::From<crate::R<SC0CLKDIV_SPEC>> for R {
    fn from(reader: crate::R<SC0CLKDIV_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SC0CLKDIV` writer"]
...
impl core::convert::From<crate::W<SC0CLKDIV_SPEC>> for W {
...
#[doc = "`read()` method returns [sc0clkdiv::R](R) reader structure"]
impl crate::Readable for SC0CLKDIV_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [sc0clkdiv::W](W) writer structure"]
impl crate::Writable for SC0CLKDIV_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SC0CLKDIV to value 0x4000_0000"]
