...
impl core::convert::From<crate::R<FCLKSEL_SPEC>> for R {
...
impl core::convert::From<crate::W<FCLKSEL_SPEC>> for W {
...
#[doc = "Field `SEL` reader - Flexcomm clock source selection. One per Flexcomm."]
...
#[doc = "Field `SEL` writer - Flexcomm clock source selection. One per Flexcomm."]
pub struct SEL_W<'a> {
    w: &'a mut W,
}
impl<'a> SEL_W<'a> {
