#[doc = "Register `DMICCLKSEL` reader"]
pub struct R(crate::R<DMICCLKSEL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DMICCLKSEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<DMICCLKSEL_SPEC>> for R {
    fn from(reader: crate::R<DMICCLKSEL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DMICCLKSEL` writer"]
pub struct W(crate::W<DMICCLKSEL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DMICCLKSEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<DMICCLKSEL_SPEC>> for W {
    fn from(writer: crate::W<DMICCLKSEL_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "DMIC (audio subsystem) clock source select.\n\nValue on reset: 7"]
...
#[doc = "Field `SEL` reader - DMIC (audio subsystem) clock source select."]
...
#[doc = "Field `SEL` writer - DMIC (audio subsystem) clock source select."]
pub struct SEL_W<'a> {
    w: &'a mut W,
}
impl<'a> SEL_W<'a> {
...
impl R {
    #[doc = "Bits 0:2 - DMIC (audio subsystem) clock source select."]
    #[inline(always)]
...
#[doc = "Digital microphone (DMIC) subsystem clock select\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dmicclksel](index.html) module"]
pub struct DMICCLKSEL_SPEC;
impl crate::RegisterSpec for DMICCLKSEL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dmicclksel::R](R) reader structure"]
impl crate::Readable for DMICCLKSEL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dmicclksel::W](W) writer structure"]
impl crate::Writable for DMICCLKSEL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets DMICCLKSEL to value 0x07"]
impl crate::Resettable for DMICCLKSEL_SPEC {
    #[inline(always)]
