#[doc = "Register `FROHFCLKDIV` reader"]
...
impl core::convert::From<crate::R<FROHFCLKDIV_SPEC>> for R {
    fn from(reader: crate::R<FROHFCLKDIV_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `FROHFCLKDIV` writer"]
...
impl core::convert::From<crate::W<FROHFCLKDIV_SPEC>> for W {
...
#[doc = "`read()` method returns [frohfclkdiv::R](R) reader structure"]
impl crate::Readable for FROHFCLKDIV_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [frohfclkdiv::W](W) writer structure"]
impl crate::Writable for FROHFCLKDIV_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets FROHFCLKDIV to value 0x4000_0000"]
