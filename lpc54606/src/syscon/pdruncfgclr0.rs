#[doc = "Register `PDRUNCFGCLR0` reader"]
...
impl core::convert::From<crate::R<PDRUNCFGCLR0_SPEC>> for R {
...
impl core::convert::From<crate::W<PDRUNCFGCLR0_SPEC>> for W {
...
#[doc = "`read()` method returns [pdruncfgclr0::R](R) reader structure"]
