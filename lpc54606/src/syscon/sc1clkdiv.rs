...
impl core::convert::From<crate::R<SC1CLKDIV_SPEC>> for R {
    fn from(reader: crate::R<SC1CLKDIV_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SC1CLKDIV` writer"]
...
impl core::convert::From<crate::W<SC1CLKDIV_SPEC>> for W {
...
#[doc = "`read()` method returns [sc1clkdiv::R](R) reader structure"]
impl crate::Readable for SC1CLKDIV_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [sc1clkdiv::W](W) writer structure"]
impl crate::Writable for SC1CLKDIV_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SC1CLKDIV to value 0x4000_0000"]
