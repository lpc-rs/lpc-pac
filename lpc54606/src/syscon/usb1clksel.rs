#[doc = "Reader of register USB1CLKSEL"]
pub type R = crate::R<u32, super::USB1CLKSEL>;
#[doc = "Writer for register USB1CLKSEL"]
pub type W = crate::W<u32, super::USB1CLKSEL>;
#[doc = "Register USB1CLKSEL `reset()`'s with value 0x07"]
impl crate::ResetValue for super::USB1CLKSEL {
    type Type = u32;
    #[inline(always)]
