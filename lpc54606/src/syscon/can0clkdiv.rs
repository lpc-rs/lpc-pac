#[doc = "Register `CAN0CLKDIV` reader"]
...
impl core::convert::From<crate::R<CAN0CLKDIV_SPEC>> for R {
    fn from(reader: crate::R<CAN0CLKDIV_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CAN0CLKDIV` writer"]
...
impl core::convert::From<crate::W<CAN0CLKDIV_SPEC>> for W {
...
#[doc = "`read()` method returns [can0clkdiv::R](R) reader structure"]
impl crate::Readable for CAN0CLKDIV_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [can0clkdiv::W](W) writer structure"]
impl crate::Writable for CAN0CLKDIV_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CAN0CLKDIV to value 0x4000_0000"]
