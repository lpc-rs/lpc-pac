#[doc = "Register `ARMTRACECLKDIV` reader"]
...
impl core::convert::From<crate::R<ARMTRACECLKDIV_SPEC>> for R {
    fn from(reader: crate::R<ARMTRACECLKDIV_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ARMTRACECLKDIV` writer"]
...
impl core::convert::From<crate::W<ARMTRACECLKDIV_SPEC>> for W {
...
#[doc = "`read()` method returns [armtraceclkdiv::R](R) reader structure"]
impl crate::Readable for ARMTRACECLKDIV_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [armtraceclkdiv::W](W) writer structure"]
impl crate::Writable for ARMTRACECLKDIV_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets ARMTRACECLKDIV to value 0x4000_0000"]
