#[doc = "Reader of register MAC_WD_TIMEROUT"]
pub type R = crate::R<u32, super::MAC_WD_TIMEROUT>;
#[doc = "Writer for register MAC_WD_TIMEROUT"]
pub type W = crate::W<u32, super::MAC_WD_TIMEROUT>;
#[doc = "Register MAC_WD_TIMEROUT `reset()`'s with value 0"]
impl crate::ResetValue for super::MAC_WD_TIMEROUT {
    type Type = u32;
    #[inline(always)]
