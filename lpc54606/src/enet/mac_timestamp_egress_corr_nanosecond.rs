#[doc = "Register `MAC_TIMESTAMP_EGRESS_CORR_NANOSECOND` reader"]
...
impl core::convert::From<crate::R<MAC_TIMESTAMP_EGRESS_CORR_NANOSECOND_SPEC>> for R {
    fn from(reader: crate::R<MAC_TIMESTAMP_EGRESS_CORR_NANOSECOND_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MAC_TIMESTAMP_EGRESS_CORR_NANOSECOND` writer"]
...
impl core::convert::From<crate::W<MAC_TIMESTAMP_EGRESS_CORR_NANOSECOND_SPEC>> for W {
    fn from(writer: crate::W<MAC_TIMESTAMP_EGRESS_CORR_NANOSECOND_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `TSEC` reader - Transmit egress correction."]
...
#[doc = "Field `TSEC` writer - Transmit egress correction."]
pub struct TSEC_W<'a> {
    w: &'a mut W,
}
impl<'a> TSEC_W<'a> {
...
impl R {
    #[doc = "Bits 0:31 - Transmit egress correction."]
    #[inline(always)]
...
#[doc = "`read()` method returns [mac_timestamp_egress_corr_nanosecond::R](R) reader structure"]
impl crate::Readable for MAC_TIMESTAMP_EGRESS_CORR_NANOSECOND_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [mac_timestamp_egress_corr_nanosecond::W](W) writer structure"]
impl crate::Writable for MAC_TIMESTAMP_EGRESS_CORR_NANOSECOND_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets MAC_TIMESTAMP_EGRESS_CORR_NANOSECOND to value 0"]
