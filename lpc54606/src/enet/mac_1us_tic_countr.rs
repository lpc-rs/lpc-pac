#[doc = "Reader of register MAC_1US_TIC_COUNTR"]
pub type R = crate::R<u32, super::MAC_1US_TIC_COUNTR>;
#[doc = "Writer for register MAC_1US_TIC_COUNTR"]
pub type W = crate::W<u32, super::MAC_1US_TIC_COUNTR>;
#[doc = "Register MAC_1US_TIC_COUNTR `reset()`'s with value 0"]
impl crate::ResetValue for super::MAC_1US_TIC_COUNTR {
    type Type = u32;
    #[inline(always)]
