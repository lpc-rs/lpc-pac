#[doc = "Register `MTL_TXQx_ETS_STAT` reader"]
...
impl core::convert::From<crate::R<MTL_TXQX_ETS_STAT_SPEC>> for R {
    fn from(reader: crate::R<MTL_TXQX_ETS_STAT_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MTL_TXQx_ETS_STAT` writer"]
...
impl core::convert::From<crate::W<MTL_TXQX_ETS_STAT_SPEC>> for W {
    fn from(writer: crate::W<MTL_TXQX_ETS_STAT_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `ABS` reader - Average Bits per Slot."]
...
#[doc = "Field `ABS` writer - Average Bits per Slot."]
pub struct ABS_W<'a> {
    w: &'a mut W,
}
impl<'a> ABS_W<'a> {
...
impl R {
    #[doc = "Bits 0:23 - Average Bits per Slot."]
    #[inline(always)]
...
#[doc = "`read()` method returns [mtl_txqx_ets_stat::R](R) reader structure"]
impl crate::Readable for MTL_TXQX_ETS_STAT_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [mtl_txqx_ets_stat::W](W) writer structure"]
impl crate::Writable for MTL_TXQX_ETS_STAT_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets MTL_TXQx_ETS_STAT to value 0"]
