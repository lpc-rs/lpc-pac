...
impl core::convert::From<crate::R<MMFAR_SPEC>> for R {
...
impl core::convert::From<crate::W<MMFAR_SPEC>> for W {
    fn from(writer: crate::W<MMFAR_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `ADDRESS` reader - Address of MemManage fault location"]
...
#[doc = "Field `ADDRESS` writer - Address of MemManage fault location"]
...
impl R {
    #[doc = "Bits 0:31 - Address of MemManage fault location"]
    #[inline(always)]
