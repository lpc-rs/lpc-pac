#[doc = "Reader of register CAP2"]
pub type R = crate::R<u32, super::CAP2>;
#[doc = "Writer for register CAP2"]
pub type W = crate::W<u32, super::CAP2>;
#[doc = "Register CAP2 `reset()`'s with value 0"]
impl crate::ResetValue for super::CAP2 {
    type Type = u32;
    #[inline(always)]
