#[doc = "Reader of register CAPCTRL8"]
pub type R = crate::R<u32, super::CAPCTRL8>;
#[doc = "Writer for register CAPCTRL8"]
pub type W = crate::W<u32, super::CAPCTRL8>;
#[doc = "Register CAPCTRL8 `reset()`'s with value 0"]
impl crate::ResetValue for super::CAPCTRL8 {
    type Type = u32;
    #[inline(always)]
