#[doc = "Reader of register MATCH4"]
pub type R = crate::R<u32, super::MATCH4>;
#[doc = "Writer for register MATCH4"]
pub type W = crate::W<u32, super::MATCH4>;
#[doc = "Register MATCH4 `reset()`'s with value 0"]
impl crate::ResetValue for super::MATCH4 {
    type Type = u32;
    #[inline(always)]
