#[doc = "Reader of register MATCHREL5"]
pub type R = crate::R<u32, super::MATCHREL5>;
#[doc = "Writer for register MATCHREL5"]
pub type W = crate::W<u32, super::MATCHREL5>;
#[doc = "Register MATCHREL5 `reset()`'s with value 0"]
impl crate::ResetValue for super::MATCHREL5 {
    type Type = u32;
    #[inline(always)]
