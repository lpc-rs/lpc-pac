#[doc = "Reader of register MATCHREL8"]
pub type R = crate::R<u32, super::MATCHREL8>;
#[doc = "Writer for register MATCHREL8"]
pub type W = crate::W<u32, super::MATCHREL8>;
#[doc = "Register MATCHREL8 `reset()`'s with value 0"]
impl crate::ResetValue for super::MATCHREL8 {
    type Type = u32;
    #[inline(always)]
