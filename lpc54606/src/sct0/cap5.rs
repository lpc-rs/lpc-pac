#[doc = "Reader of register CAP5"]
pub type R = crate::R<u32, super::CAP5>;
#[doc = "Writer for register CAP5"]
pub type W = crate::W<u32, super::CAP5>;
#[doc = "Register CAP5 `reset()`'s with value 0"]
impl crate::ResetValue for super::CAP5 {
    type Type = u32;
    #[inline(always)]
