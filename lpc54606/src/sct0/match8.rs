#[doc = "Reader of register MATCH8"]
pub type R = crate::R<u32, super::MATCH8>;
#[doc = "Writer for register MATCH8"]
pub type W = crate::W<u32, super::MATCH8>;
#[doc = "Register MATCH8 `reset()`'s with value 0"]
impl crate::ResetValue for super::MATCH8 {
    type Type = u32;
    #[inline(always)]
