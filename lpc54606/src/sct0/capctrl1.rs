#[doc = "Reader of register CAPCTRL1"]
pub type R = crate::R<u32, super::CAPCTRL1>;
#[doc = "Writer for register CAPCTRL1"]
pub type W = crate::W<u32, super::CAPCTRL1>;
#[doc = "Register CAPCTRL1 `reset()`'s with value 0"]
impl crate::ResetValue for super::CAPCTRL1 {
    type Type = u32;
    #[inline(always)]
