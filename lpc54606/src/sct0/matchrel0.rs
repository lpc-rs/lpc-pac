#[doc = "Reader of register MATCHREL0"]
pub type R = crate::R<u32, super::MATCHREL0>;
#[doc = "Writer for register MATCHREL0"]
pub type W = crate::W<u32, super::MATCHREL0>;
#[doc = "Register MATCHREL0 `reset()`'s with value 0"]
impl crate::ResetValue for super::MATCHREL0 {
    type Type = u32;
    #[inline(always)]
