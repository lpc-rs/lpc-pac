#[doc = "Reader of register CAPCTRL5"]
pub type R = crate::R<u32, super::CAPCTRL5>;
#[doc = "Writer for register CAPCTRL5"]
pub type W = crate::W<u32, super::CAPCTRL5>;
#[doc = "Register CAPCTRL5 `reset()`'s with value 0"]
impl crate::ResetValue for super::CAPCTRL5 {
    type Type = u32;
    #[inline(always)]
