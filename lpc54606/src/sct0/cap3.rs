#[doc = "Reader of register CAP3"]
pub type R = crate::R<u32, super::CAP3>;
#[doc = "Writer for register CAP3"]
pub type W = crate::W<u32, super::CAP3>;
#[doc = "Register CAP3 `reset()`'s with value 0"]
impl crate::ResetValue for super::CAP3 {
    type Type = u32;
    #[inline(always)]
