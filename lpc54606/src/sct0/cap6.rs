#[doc = "Reader of register CAP6"]
pub type R = crate::R<u32, super::CAP6>;
#[doc = "Writer for register CAP6"]
pub type W = crate::W<u32, super::CAP6>;
#[doc = "Register CAP6 `reset()`'s with value 0"]
impl crate::ResetValue for super::CAP6 {
    type Type = u32;
    #[inline(always)]
