#[doc = "Reader of register CAP8"]
pub type R = crate::R<u32, super::CAP8>;
#[doc = "Writer for register CAP8"]
pub type W = crate::W<u32, super::CAP8>;
#[doc = "Register CAP8 `reset()`'s with value 0"]
impl crate::ResetValue for super::CAP8 {
    type Type = u32;
    #[inline(always)]
