#[doc = "Reader of register MATCH3"]
pub type R = crate::R<u32, super::MATCH3>;
#[doc = "Writer for register MATCH3"]
pub type W = crate::W<u32, super::MATCH3>;
#[doc = "Register MATCH3 `reset()`'s with value 0"]
impl crate::ResetValue for super::MATCH3 {
    type Type = u32;
    #[inline(always)]
