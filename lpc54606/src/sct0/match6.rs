#[doc = "Reader of register MATCH6"]
pub type R = crate::R<u32, super::MATCH6>;
#[doc = "Writer for register MATCH6"]
pub type W = crate::W<u32, super::MATCH6>;
#[doc = "Register MATCH6 `reset()`'s with value 0"]
impl crate::ResetValue for super::MATCH6 {
    type Type = u32;
    #[inline(always)]
