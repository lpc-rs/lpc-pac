#[doc = "Reader of register CAPCTRL7"]
pub type R = crate::R<u32, super::CAPCTRL7>;
#[doc = "Writer for register CAPCTRL7"]
pub type W = crate::W<u32, super::CAPCTRL7>;
#[doc = "Register CAPCTRL7 `reset()`'s with value 0"]
impl crate::ResetValue for super::CAPCTRL7 {
    type Type = u32;
    #[inline(always)]
