///Register `HCINTERRUPTDISABLE` reader
...
///Field `SO` reader - Scheduling Overrun interrupt.
...
///Field `SO` writer - Scheduling Overrun interrupt.
pub struct SO_W<'a> {
    w: &'a mut W,
}
impl<'a> SO_W<'a> {
...
///Field `WDH` reader - HcDoneHead Writeback interrupt.
...
///Field `WDH` writer - HcDoneHead Writeback interrupt.
pub struct WDH_W<'a> {
    w: &'a mut W,
}
impl<'a> WDH_W<'a> {
...
///Field `SF` reader - Start of Frame interrupt.
...
///Field `SF` writer - Start of Frame interrupt.
pub struct SF_W<'a> {
    w: &'a mut W,
}
impl<'a> SF_W<'a> {
...
///Field `RD` reader - Resume Detect interrupt.
...
///Field `RD` writer - Resume Detect interrupt.
pub struct RD_W<'a> {
    w: &'a mut W,
}
impl<'a> RD_W<'a> {
...
///Field `UE` reader - Unrecoverable Error interrupt.
...
///Field `UE` writer - Unrecoverable Error interrupt.
pub struct UE_W<'a> {
    w: &'a mut W,
}
impl<'a> UE_W<'a> {
...
///Field `FNO` reader - Frame Number Overflow interrupt.
...
///Field `FNO` writer - Frame Number Overflow interrupt.
pub struct FNO_W<'a> {
    w: &'a mut W,
}
impl<'a> FNO_W<'a> {
...
///Field `RHSC` reader - Root Hub Status Change interrupt.
...
///Field `RHSC` writer - Root Hub Status Change interrupt.
pub struct RHSC_W<'a> {
    w: &'a mut W,
}
impl<'a> RHSC_W<'a> {
...
///Field `OC` reader - Ownership Change interrupt.
...
///Field `OC` writer - Ownership Change interrupt.
pub struct OC_W<'a> {
    w: &'a mut W,
}
impl<'a> OC_W<'a> {
...
///Field `MIE` reader - A 0 written to this field is ignored by HC.
...
///Field `MIE` writer - A 0 written to this field is ignored by HC.
pub struct MIE_W<'a> {
    w: &'a mut W,
}
impl<'a> MIE_W<'a> {
...
///`read()` method returns [hcinterruptdisable::R](R) reader structure
impl crate::Readable for HCINTERRUPTDISABLE_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [hcinterruptdisable::W](W) writer structure
impl crate::Writable for HCINTERRUPTDISABLE_SPEC {
    type Writer = W;
}
///`reset()` method sets HCINTERRUPTDISABLE to value 0
