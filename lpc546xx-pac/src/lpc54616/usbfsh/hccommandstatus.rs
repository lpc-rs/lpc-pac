///Register `HCCOMMANDSTATUS` reader
...
///Register `HCCOMMANDSTATUS` writer
...
///Field `HCR` reader - HostControllerReset This bit is set by HCD to initiate a software reset of HC.
...
///Field `HCR` writer - HostControllerReset This bit is set by HCD to initiate a software reset of HC.
pub struct HCR_W<'a> {
    w: &'a mut W,
}
impl<'a> HCR_W<'a> {
...
///Field `CLF` reader - ControlListFilled This bit is used to indicate whether there are any TDs on the Control list.
...
///Field `CLF` writer - ControlListFilled This bit is used to indicate whether there are any TDs on the Control list.
pub struct CLF_W<'a> {
    w: &'a mut W,
}
impl<'a> CLF_W<'a> {
...
///Field `BLF` reader - BulkListFilled This bit is used to indicate whether there are any TDs on the Bulk list.
...
///Field `BLF` writer - BulkListFilled This bit is used to indicate whether there are any TDs on the Bulk list.
pub struct BLF_W<'a> {
    w: &'a mut W,
}
impl<'a> BLF_W<'a> {
...
///Field `OCR` reader - OwnershipChangeRequest This bit is set by an OS HCD to request a change of control of the HC.
...
///Field `OCR` writer - OwnershipChangeRequest This bit is set by an OS HCD to request a change of control of the HC.
pub struct OCR_W<'a> {
    w: &'a mut W,
}
impl<'a> OCR_W<'a> {
...
///Field `SOC` reader - SchedulingOverrunCount These bits are incremented on each scheduling overrun error.
...
///Field `SOC` writer - SchedulingOverrunCount These bits are incremented on each scheduling overrun error.
pub struct SOC_W<'a> {
    w: &'a mut W,
}
impl<'a> SOC_W<'a> {
...
///`read()` method returns [hccommandstatus::R](R) reader structure
impl crate::Readable for HCCOMMANDSTATUS_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [hccommandstatus::W](W) writer structure
impl crate::Writable for HCCOMMANDSTATUS_SPEC {
    type Writer = W;
}
///`reset()` method sets HCCOMMANDSTATUS to value 0
