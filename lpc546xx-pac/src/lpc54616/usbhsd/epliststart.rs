...
///Field `EP_LIST_PRG` reader - Programmable portion of the USB EP Command/Status List address.
...
///Field `EP_LIST_PRG` writer - Programmable portion of the USB EP Command/Status List address.
...
///Field `EP_LIST_FIXED` reader - Fixed portion of USB EP Command/Status List address.
...
///`read()` method returns [epliststart::R](R) reader structure
impl crate::Readable for EPLISTSTART_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [epliststart::W](W) writer structure
impl crate::Writable for EPLISTSTART_SPEC {
    type Writer = W;
}
///`reset()` method sets EPLISTSTART to value 0
