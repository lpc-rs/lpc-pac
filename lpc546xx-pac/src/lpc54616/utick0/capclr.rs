...
///Field `CAPCLR0` writer - Clear capture 0. Writing 1 to this bit clears the CAP0 register value.
...
///Field `CAPCLR1` writer - Clear capture 1. Writing 1 to this bit clears the CAP1 register value.
...
///Field `CAPCLR2` writer - Clear capture 2. Writing 1 to this bit clears the CAP2 register value.
...
///Field `CAPCLR3` writer - Clear capture 3. Writing 1 to this bit clears the CAP3 register value.
...
///`write(|w| ..)` method takes [capclr::W](W) writer structure
impl crate::Writable for CAPCLR_SPEC {
    type Writer = W;
}
///`reset()` method sets CAPCLR to value 0
