...
///`read()` method returns [pio111::R](R) reader structure
impl crate::Readable for PIO111_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio111::W](W) writer structure
impl crate::Writable for PIO111_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO111 to value 0x0320
