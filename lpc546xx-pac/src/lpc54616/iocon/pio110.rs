...
///`read()` method returns [pio110::R](R) reader structure
impl crate::Readable for PIO110_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio110::W](W) writer structure
impl crate::Writable for PIO110_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO110 to value 0x0320
