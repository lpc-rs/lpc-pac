...
///`read()` method returns [pio122::R](R) reader structure
impl crate::Readable for PIO122_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio122::W](W) writer structure
impl crate::Writable for PIO122_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO122 to value 0x0320
