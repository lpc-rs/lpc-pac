...
///`read()` method returns [pio525::R](R) reader structure
impl crate::Readable for PIO525_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio525::W](W) writer structure
impl crate::Writable for PIO525_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO525 to value 0x0320
