...
///`read()` method returns [pio518::R](R) reader structure
impl crate::Readable for PIO518_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio518::W](W) writer structure
impl crate::Writable for PIO518_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO518 to value 0x0320
