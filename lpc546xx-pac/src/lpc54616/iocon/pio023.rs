...
///`read()` method returns [pio023::R](R) reader structure
impl crate::Readable for PIO023_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio023::W](W) writer structure
impl crate::Writable for PIO023_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO023 to value 0x0320
