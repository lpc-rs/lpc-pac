...
///`read()` method returns [pio52::R](R) reader structure
impl crate::Readable for PIO52_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio52::W](W) writer structure
impl crate::Writable for PIO52_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO52 to value 0x0320
