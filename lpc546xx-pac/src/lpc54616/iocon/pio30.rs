...
///`read()` method returns [pio30::R](R) reader structure
impl crate::Readable for PIO30_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio30::W](W) writer structure
impl crate::Writable for PIO30_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO30 to value 0x0320
