...
///`read()` method returns [pio413::R](R) reader structure
impl crate::Readable for PIO413_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio413::W](W) writer structure
impl crate::Writable for PIO413_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO413 to value 0x0320
