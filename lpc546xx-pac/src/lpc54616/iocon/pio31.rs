...
///`read()` method returns [pio31::R](R) reader structure
impl crate::Readable for PIO31_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio31::W](W) writer structure
impl crate::Writable for PIO31_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO31 to value 0x0320
