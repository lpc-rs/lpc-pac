...
///`read()` method returns [pio315::R](R) reader structure
impl crate::Readable for PIO315_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio315::W](W) writer structure
impl crate::Writable for PIO315_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO315 to value 0x0320
