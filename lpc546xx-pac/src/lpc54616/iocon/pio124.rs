...
///`read()` method returns [pio124::R](R) reader structure
impl crate::Readable for PIO124_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio124::W](W) writer structure
impl crate::Writable for PIO124_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO124 to value 0x0320
