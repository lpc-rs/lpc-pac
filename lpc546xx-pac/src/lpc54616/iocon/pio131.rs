...
///`read()` method returns [pio131::R](R) reader structure
impl crate::Readable for PIO131_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio131::W](W) writer structure
impl crate::Writable for PIO131_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO131 to value 0x0320
