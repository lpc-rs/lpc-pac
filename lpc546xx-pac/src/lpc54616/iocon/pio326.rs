...
///`read()` method returns [pio326::R](R) reader structure
impl crate::Readable for PIO326_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio326::W](W) writer structure
impl crate::Writable for PIO326_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO326 to value 0x0320
