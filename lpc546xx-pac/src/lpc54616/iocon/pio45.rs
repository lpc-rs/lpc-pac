...
///`read()` method returns [pio45::R](R) reader structure
impl crate::Readable for PIO45_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio45::W](W) writer structure
impl crate::Writable for PIO45_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO45 to value 0x0320
