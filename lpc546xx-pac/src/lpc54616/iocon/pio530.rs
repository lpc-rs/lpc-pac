...
///`read()` method returns [pio530::R](R) reader structure
impl crate::Readable for PIO530_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio530::W](W) writer structure
impl crate::Writable for PIO530_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO530 to value 0x0320
