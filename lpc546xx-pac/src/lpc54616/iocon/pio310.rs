...
///`read()` method returns [pio310::R](R) reader structure
impl crate::Readable for PIO310_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio310::W](W) writer structure
impl crate::Writable for PIO310_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO310 to value 0x0320
