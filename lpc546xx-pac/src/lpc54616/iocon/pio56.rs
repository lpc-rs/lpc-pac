...
///`read()` method returns [pio56::R](R) reader structure
impl crate::Readable for PIO56_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio56::W](W) writer structure
impl crate::Writable for PIO56_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO56 to value 0x0320
