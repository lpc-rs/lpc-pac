...
///`read()` method returns [pio225::R](R) reader structure
impl crate::Readable for PIO225_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio225::W](W) writer structure
impl crate::Writable for PIO225_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO225 to value 0x0320
