...
///`read()` method returns [pio027::R](R) reader structure
impl crate::Readable for PIO027_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio027::W](W) writer structure
impl crate::Writable for PIO027_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO027 to value 0x0320
