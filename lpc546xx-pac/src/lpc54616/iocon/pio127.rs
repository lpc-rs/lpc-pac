...
///`read()` method returns [pio127::R](R) reader structure
impl crate::Readable for PIO127_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio127::W](W) writer structure
impl crate::Writable for PIO127_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO127 to value 0x0320
