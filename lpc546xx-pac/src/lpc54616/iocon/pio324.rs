...
///`read()` method returns [pio324::R](R) reader structure
impl crate::Readable for PIO324_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio324::W](W) writer structure
impl crate::Writable for PIO324_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO324 to value 0x0340
