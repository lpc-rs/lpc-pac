...
///Field `COUNT` reader - Watchdog time-out value.
...
///Field `COUNT` writer - Watchdog time-out value.
...
///`read()` method returns [tc::R](R) reader structure
impl crate::Readable for TC_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [tc::W](W) writer structure
impl crate::Writable for TC_SPEC {
    type Writer = W;
}
///`reset()` method sets TC to value 0xff
