...
///Field `ETMPD` reader - ETM power down. This bit can be used by an implementation to control if the ETM is in a low power state. This bit must be cleared by the trace software tools at the beginning of a debug session. When this bit is set to 1, writes to some registers and fields might be ignored.
...
///Field `ETMPD` writer - ETM power down. This bit can be used by an implementation to control if the ETM is in a low power state. This bit must be cleared by the trace software tools at the beginning of a debug session. When this bit is set to 1, writes to some registers and fields might be ignored.
...
///Field `PS` reader - Port size. The ETM-M4 has no influence over the external pins used for trace. These bits are implemented but not used. On an ETM reset these bits reset to 0b001.
...
///Field `PS` writer - Port size. The ETM-M4 has no influence over the external pins used for trace. These bits are implemented but not used. On an ETM reset these bits reset to 0b001.
pub struct PS_W<'a> {
    w: &'a mut W,
}
impl<'a> PS_W<'a> {
...
///Field `SP` writer - Stall processor. The FIFOFULL output can be used to stall the processor to prevent overflow. The FIFOFULL output is only enabled when the stall processor bit is set to 1. When the bit is 0 the FIFOFULL output remains LOW at all times and the FIFO overflows if there are too many trace packets. Trace resumes without corruption once the FIFO has drained, if overflow does occur. An ETM reset sets this bit to 0.
pub struct SP_W<'a> {
    w: &'a mut W,
}
impl<'a> SP_W<'a> {
...
///Field `BO` reader - Branch output. When set to 1 all branch addresses are output, even if the branch was because of a direct branch instruction. Setting this bit enables reconstruction of the program flow without having access to the memory image of the code being executed. When this bit is set to 1, more trace data is generated, and this may affect the performance of the trace system. Information about the execution of a branch is traced regardless of the state of this bit. An ETM reset sets this bit to 0.
...
///Field `BO` writer - Branch output. When set to 1 all branch addresses are output, even if the branch was because of a direct branch instruction. Setting this bit enables reconstruction of the program flow without having access to the memory image of the code being executed. When this bit is set to 1, more trace data is generated, and this may affect the performance of the trace system. Information about the execution of a branch is traced regardless of the state of this bit. An ETM reset sets this bit to 0.
pub struct BO_W<'a> {
    w: &'a mut W,
}
impl<'a> BO_W<'a> {
...
///Field `DRC` reader - Debug request control. When set to 1 and the trigger event occurs, the DBGRQ output is asserted until DBGACK is observed. This enables the ARM processor to be forced into Debug state. An ETM reset sets this bit to 0.
...
///Field `DRC` writer - Debug request control. When set to 1 and the trigger event occurs, the DBGRQ output is asserted until DBGACK is observed. This enables the ARM processor to be forced into Debug state. An ETM reset sets this bit to 0.
pub struct DRC_W<'a> {
    w: &'a mut W,
}
impl<'a> DRC_W<'a> {
...
///Field `ETMP` reader - ETM programming. This bit must be set to 1 at the start of the ETM programming sequence. Tracing is prevented while this bit is set to 1. On an ETM reset this bit is set to b1.
...
///Field `ETMP` writer - ETM programming. This bit must be set to 1 at the start of the ETM programming sequence. Tracing is prevented while this bit is set to 1. On an ETM reset this bit is set to b1.
pub struct ETMP_W<'a> {
    w: &'a mut W,
}
impl<'a> ETMP_W<'a> {
...
///Field `ETMPS` reader - ETM port selection. This bit can be used to control other trace components in an implementation. This bit must be set by the trace software tools to ensure that trace output is enabled from this ETM. An ETM reset sets this bit to 0.
...
///Field `ETMPS` writer - ETM port selection. This bit can be used to control other trace components in an implementation. This bit must be set by the trace software tools to ensure that trace output is enabled from this ETM. An ETM reset sets this bit to 0.
...
///Field `PM2` reader - This bit is implemented but has no function. An ETM reset sets this bit to 0.
...
///Field `PM2` writer - This bit is implemented but has no function. An ETM reset sets this bit to 0.
pub struct PM2_W<'a> {
    w: &'a mut W,
}
impl<'a> PM2_W<'a> {
...
///Field `PM` reader - These bits are implemented but have no function. An ETM reset sets these bits to 0.
...
///Field `PM` writer - These bits are implemented but have no function. An ETM reset sets these bits to 0.
pub struct PM_W<'a> {
    w: &'a mut W,
}
impl<'a> PM_W<'a> {
...
///Field `PS3` reader - This bit is implemented but has no function. An ETM reset sets this bit to 0.
...
///Field `PS3` writer - This bit is implemented but has no function. An ETM reset sets this bit to 0.
pub struct PS3_W<'a> {
    w: &'a mut W,
}
impl<'a> PS3_W<'a> {
...
///Field `TE` reader - When set, this bit enables timestamping. An ETM reset sets this bit to 0.
...
///Field `TE` writer - When set, this bit enables timestamping. An ETM reset sets this bit to 0.
pub struct TE_W<'a> {
    w: &'a mut W,
}
impl<'a> TE_W<'a> {
