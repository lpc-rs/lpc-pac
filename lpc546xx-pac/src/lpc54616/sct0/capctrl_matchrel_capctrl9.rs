...
impl From<crate::R<CAPCTRL_MATCHREL_CAPCTRL9_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CAPCTRL_MATCHREL_CAPCTRL9_SPEC>) -> Self {
        R(reader)
    }
}
///Register `CAPCTRL9` writer
...
impl From<crate::W<CAPCTRL_MATCHREL_CAPCTRL9_SPEC>> for W {
    #[inline(always)]
...
///`read()` method returns [capctrl_matchrel_capctrl9::R](R) reader structure
impl crate::Readable for CAPCTRL_MATCHREL_CAPCTRL9_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [capctrl_matchrel_capctrl9::W](W) writer structure
impl crate::Writable for CAPCTRL_MATCHREL_CAPCTRL9_SPEC {
    type Writer = W;
}
///`reset()` method sets CAPCTRL9 to value 0
