...
///`read()` method returns [thr0_high::R](R) reader structure
impl crate::Readable for THR0_HIGH_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [thr0_high::W](W) writer structure
impl crate::Writable for THR0_HIGH_SPEC {
    type Writer = W;
}
///`reset()` method sets THR0_HIGH to value 0
