...
///Field `RAM0X` reader - When 1, automatic clock gating for RAMX and RAM0 are turned off.
...
///Field `RAM0X` writer - When 1, automatic clock gating for RAMX and RAM0 are turned off.
...
///Field `RAM1` reader - When 1, automatic clock gating for RAM1 are turned off.
...
///Field `RAM1` writer - When 1, automatic clock gating for RAM1 are turned off.
pub struct RAM1_W<'a> {
    w: &'a mut W,
}
impl<'a> RAM1_W<'a> {
...
///Field `RAM2` reader - When 1, automatic clock gating for RAM1 are turned off.
...
///Field `RAM2` writer - When 1, automatic clock gating for RAM1 are turned off.
pub struct RAM2_W<'a> {
    w: &'a mut W,
}
impl<'a> RAM2_W<'a> {
...
///Field `RAM3` reader - When 1, automatic clock gating for RAM1 are turned off.
...
///Field `RAM3` writer - When 1, automatic clock gating for RAM1 are turned off.
pub struct RAM3_W<'a> {
    w: &'a mut W,
}
impl<'a> RAM3_W<'a> {
...
///`read()` method returns [autocgor::R](R) reader structure
impl crate::Readable for AUTOCGOR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [autocgor::W](W) writer structure
impl crate::Writable for AUTOCGOR_SPEC {
    type Writer = W;
}
///`reset()` method sets AUTOCGOR to value 0
