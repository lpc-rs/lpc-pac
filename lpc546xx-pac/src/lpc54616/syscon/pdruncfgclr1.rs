...
///`read()` method returns [pdruncfgclr1::R](R) reader structure
impl crate::Readable for PDRUNCFGCLR1_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pdruncfgclr1::W](W) writer structure
impl crate::Writable for PDRUNCFGCLR1_SPEC {
    type Writer = W;
}
///`reset()` method sets PDRUNCFGCLR1 to value 0
