///Register `PDRUNCFGCLR0` reader
pub struct R(crate::R<PDRUNCFGCLR0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PDRUNCFGCLR0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PDRUNCFGCLR0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PDRUNCFGCLR0_SPEC>) -> Self {
        R(reader)
    }
}
///Register `PDRUNCFGCLR0` writer
...
///`read()` method returns [pdruncfgclr0::R](R) reader structure
impl crate::Readable for PDRUNCFGCLR0_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pdruncfgclr0::W](W) writer structure
impl crate::Writable for PDRUNCFGCLR0_SPEC {
    type Writer = W;
}
///`reset()` method sets PDRUNCFGCLR0 to value 0
