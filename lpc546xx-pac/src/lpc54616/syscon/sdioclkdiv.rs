///Register `SDIOCLKDIV` reader
pub struct R(crate::R<SDIOCLKDIV_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SDIOCLKDIV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SDIOCLKDIV_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SDIOCLKDIV_SPEC>) -> Self {
        R(reader)
    }
}
///Register `SDIOCLKDIV` writer
pub struct W(crate::W<SDIOCLKDIV_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SDIOCLKDIV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SDIOCLKDIV_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SDIOCLKDIV_SPEC>) -> Self {
        W(writer)
    }
}
...
///
///For information about available fields see [sdioclkdiv](index.html) module
pub struct SDIOCLKDIV_SPEC;
impl crate::RegisterSpec for SDIOCLKDIV_SPEC {
    type Ux = u32;
}
///`read()` method returns [sdioclkdiv::R](R) reader structure
impl crate::Readable for SDIOCLKDIV_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [sdioclkdiv::W](W) writer structure
impl crate::Writable for SDIOCLKDIV_SPEC {
    type Writer = W;
}
///`reset()` method sets SDIOCLKDIV to value 0x4000_0000
impl crate::Resettable for SDIOCLKDIV_SPEC {
    #[inline(always)]
