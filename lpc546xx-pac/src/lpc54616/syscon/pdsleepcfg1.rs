...
///`read()` method returns [pdsleepcfg1::R](R) reader structure
impl crate::Readable for PDSLEEPCFG1_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pdsleepcfg1::W](W) writer structure
impl crate::Writable for PDSLEEPCFG1_SPEC {
    type Writer = W;
}
///`reset()` method sets PDSLEEPCFG1 to value 0x00f8_1f40
