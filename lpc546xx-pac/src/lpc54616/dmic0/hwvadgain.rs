...
///Field `INPUTGAIN` reader - Shift value for input bits 0x00 -10 bits 0x01 -8 bits 0x02 -6 bits 0x03 -4 bits 0x04 -2 bits 0x05 0 bits (default) 0x06 +2 bits 0x07 +4 bits 0x08 +6 bits 0x09 +8 bits 0x0A +10 bits 0x0B +12 bits 0x0C +14 bits 0x0D to 0x0F Reserved.
...
///Field `INPUTGAIN` writer - Shift value for input bits 0x00 -10 bits 0x01 -8 bits 0x02 -6 bits 0x03 -4 bits 0x04 -2 bits 0x05 0 bits (default) 0x06 +2 bits 0x07 +4 bits 0x08 +6 bits 0x09 +8 bits 0x0A +10 bits 0x0B +12 bits 0x0C +14 bits 0x0D to 0x0F Reserved.
...
///`read()` method returns [hwvadgain::R](R) reader structure
impl crate::Readable for HWVADGAIN_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [hwvadgain::W](W) writer structure
impl crate::Writable for HWVADGAIN_SPEC {
    type Writer = W;
}
///`reset()` method sets HWVADGAIN to value 0x05
