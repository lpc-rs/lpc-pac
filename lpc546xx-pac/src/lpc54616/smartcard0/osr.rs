...
///Field `OSFRAC` reader - Fractional part of the oversampling ratio, in units of 1/8th of an input clock period.
...
///Field `OSFRAC` writer - Fractional part of the oversampling ratio, in units of 1/8th of an input clock period.
...
///Field `OSINT` reader - Integer part of the oversampling ratio, minus 1.
...
///Field `OSINT` writer - Integer part of the oversampling ratio, minus 1.
...
///Field `FDINT` reader - These bits act as a more-significant extension of the OSint field, allowing an oversampling ratio up to 2048 as required by ISO7816-3.
...
///Field `FDINT` writer - These bits act as a more-significant extension of the OSint field, allowing an oversampling ratio up to 2048 as required by ISO7816-3.
...
///`reset()` method sets OSR to value 0xf0
