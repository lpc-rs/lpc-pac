...
///Field `TXDATA` writer - Transmit data to the FIFO. Whether this register is used and the number of bits used depends on configuration details.
...
///`write(|w| ..)` method takes [fifowr48h::W](W) writer structure
impl crate::Writable for FIFOWR48H_SPEC {
    type Writer = W;
}
///`reset()` method sets FIFOWR48H to value 0
