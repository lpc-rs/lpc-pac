...
///Field `TI` reader - Transmit Interrupt This bit indicates that the packet transmission is complete.
...
///Field `TI` writer - Transmit Interrupt This bit indicates that the packet transmission is complete.
pub struct TI_W<'a> {
    w: &'a mut W,
}
impl<'a> TI_W<'a> {
...
///Field `TBU` reader - Transmit Buffer Unavailable This bit indicates that the application owns the next descriptor in the transmit list, and the DMA cannot acquire it.
...
///Field `TBU` writer - Transmit Buffer Unavailable This bit indicates that the application owns the next descriptor in the transmit list, and the DMA cannot acquire it.
pub struct TBU_W<'a> {
    w: &'a mut W,
}
impl<'a> TBU_W<'a> {
...
///Field `RI` reader - Receive Interrupt This bit indicates that the packet reception is complete.
...
///Field `RI` writer - Receive Interrupt This bit indicates that the packet reception is complete.
pub struct RI_W<'a> {
    w: &'a mut W,
}
impl<'a> RI_W<'a> {
...
///Field `RBU` reader - Receive Buffer Unavailable This bit indicates that the application owns the next in the receive list, and the DMA cannot acquire it.
...
///Field `RBU` writer - Receive Buffer Unavailable This bit indicates that the application owns the next in the receive list, and the DMA cannot acquire it.
pub struct RBU_W<'a> {
    w: &'a mut W,
}
impl<'a> RBU_W<'a> {
...
///Field `RWT` reader - Receive Watchdog time out This bit is asserted when a packet with length greater than 2,048 bytes (10,240 bytes when Jumbo Packet mode is enabled) is received.
...
///Field `RWT` writer - Receive Watchdog time out This bit is asserted when a packet with length greater than 2,048 bytes (10,240 bytes when Jumbo Packet mode is enabled) is received.
pub struct RWT_W<'a> {
    w: &'a mut W,
}
impl<'a> RWT_W<'a> {
...
///Field `ERI` reader - Early Receive Interrupt This bit indicates that the DMA filled the first data buffer of the packet.
...
///Field `ERI` writer - Early Receive Interrupt This bit indicates that the DMA filled the first data buffer of the packet.
pub struct ERI_W<'a> {
    w: &'a mut W,
}
impl<'a> ERI_W<'a> {
...
///Field `FBE` reader - Fatal Bus Error This bit indicates that a bus error occurred (as described in the EB field).
...
///Field `FBE` writer - Fatal Bus Error This bit indicates that a bus error occurred (as described in the EB field).
pub struct FBE_W<'a> {
    w: &'a mut W,
}
impl<'a> FBE_W<'a> {
...
///Field `EB` reader - DMA Error Bits This field indicates the type of error that caused a Bus Error.
...
///Field `EB` writer - DMA Error Bits This field indicates the type of error that caused a Bus Error.
pub struct EB_W<'a> {
    w: &'a mut W,
}
impl<'a> EB_W<'a> {
...
///`read()` method returns [dma_chx_stat::R](R) reader structure
impl crate::Readable for DMA_CHX_STAT_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [dma_chx_stat::W](W) writer structure
impl crate::Writable for DMA_CHX_STAT_SPEC {
    type Writer = W;
}
///`reset()` method sets DMA_CHx_STAT to value 0
