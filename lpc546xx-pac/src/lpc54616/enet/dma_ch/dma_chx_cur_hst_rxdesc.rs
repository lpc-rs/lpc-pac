///Register `DMA_CHx_CUR_HST_RXDESC` reader
...
///Field `HRD` reader - Host Receive descriptor Address Pointer Cleared on Reset.
...
///`read()` method returns [dma_chx_cur_hst_rxdesc::R](R) reader structure
impl crate::Readable for DMA_CHX_CUR_HST_RXDESC_SPEC {
    type Reader = R;
}
///`reset()` method sets DMA_CHx_CUR_HST_RXDESC to value 0
