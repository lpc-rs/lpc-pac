///Register `DMA_CHx_INT_EN` reader
...
///Register `DMA_CHx_INT_EN` writer
...
///Field `TIE` reader - Transmit interrupt enable When this bit is set with Normal Interrupt Summary Enable (bit 16 in this register), Transmit Interrupt is enabled.
...
///Field `TIE` writer - Transmit interrupt enable When this bit is set with Normal Interrupt Summary Enable (bit 16 in this register), Transmit Interrupt is enabled.
pub struct TIE_W<'a> {
    w: &'a mut W,
}
impl<'a> TIE_W<'a> {
...
///Field `TSE` reader - Transmit stopped enable When this bit is set with Abnormal Interrupt Summary Enable (bit 15 in this register), Transmission Stopped Interrupt is enabled.
...
///Field `TSE` writer - Transmit stopped enable When this bit is set with Abnormal Interrupt Summary Enable (bit 15 in this register), Transmission Stopped Interrupt is enabled.
pub struct TSE_W<'a> {
    w: &'a mut W,
}
impl<'a> TSE_W<'a> {
...
///Field `TBUE` reader - Transmit buffer unavailable enable When this bit is set with Normal Interrupt Summary Enable (bit 16 in this register), Transmit Buffer Unavailable Interrupt is enabled.
...
///Field `TBUE` writer - Transmit buffer unavailable enable When this bit is set with Normal Interrupt Summary Enable (bit 16 in this register), Transmit Buffer Unavailable Interrupt is enabled.
pub struct TBUE_W<'a> {
    w: &'a mut W,
}
impl<'a> TBUE_W<'a> {
...
///Field `RIE` reader - Receive interrupt enable When this bit is set with Normal Interrupt Summary Enable (bit 16 in this register), Receive Interrupt is enabled.
...
///Field `RIE` writer - Receive interrupt enable When this bit is set with Normal Interrupt Summary Enable (bit 16 in this register), Receive Interrupt is enabled.
pub struct RIE_W<'a> {
    w: &'a mut W,
}
impl<'a> RIE_W<'a> {
...
///Field `RBUE` reader - Receive buffer unavailable enable When this bit is set with Abnormal Interrupt Summary Enable (bit 15 in this register), Receive Buffer Unavailable Interrupt is enabled.
...
///Field `RBUE` writer - Receive buffer unavailable enable When this bit is set with Abnormal Interrupt Summary Enable (bit 15 in this register), Receive Buffer Unavailable Interrupt is enabled.
pub struct RBUE_W<'a> {
    w: &'a mut W,
}
impl<'a> RBUE_W<'a> {
...
///Field `RSE` reader - Received stopped enable When this bit is set with Abnormal Interrupt Summary Enable (bit 15 in this register), Receive Stopped Interrupt is enabled.
...
///Field `RSE` writer - Received stopped enable When this bit is set with Abnormal Interrupt Summary Enable (bit 15 in this register), Receive Stopped Interrupt is enabled.
pub struct RSE_W<'a> {
    w: &'a mut W,
}
impl<'a> RSE_W<'a> {
...
///Field `RWTE` reader - Receive watchdog timeout enable When this bit is set with Abnormal Interrupt Summary Enable (bit 15 in this register), the Receive Watchdog Timeout Interrupt is enabled.
...
///Field `RWTE` writer - Receive watchdog timeout enable When this bit is set with Abnormal Interrupt Summary Enable (bit 15 in this register), the Receive Watchdog Timeout Interrupt is enabled.
pub struct RWTE_W<'a> {
    w: &'a mut W,
}
impl<'a> RWTE_W<'a> {
...
///Field `ETIE` reader - Early transmit interrupt enable When this bit is set with an Abnormal Interrupt Summary Enable (bit 15 in this register), Early Transmit Interrupt is enabled.
...
///Field `ETIE` writer - Early transmit interrupt enable When this bit is set with an Abnormal Interrupt Summary Enable (bit 15 in this register), Early Transmit Interrupt is enabled.
pub struct ETIE_W<'a> {
    w: &'a mut W,
}
impl<'a> ETIE_W<'a> {
...
///Field `ERIE` reader - Early receive interrupt enable When this bit is set with Normal Interrupt Summary Enable (bit 16 in this register), Early Receive Interrupt is enabled.
...
///Field `ERIE` writer - Early receive interrupt enable When this bit is set with Normal Interrupt Summary Enable (bit 16 in this register), Early Receive Interrupt is enabled.
pub struct ERIE_W<'a> {
    w: &'a mut W,
}
impl<'a> ERIE_W<'a> {
...
///Field `FBEE` reader - Fatal bus error enable When this bit is set with Abnormal Interrupt Summary Enable (bit 15 in this register), the Fatal Bus Error Interrupt is enabled.
...
///Field `FBEE` writer - Fatal bus error enable When this bit is set with Abnormal Interrupt Summary Enable (bit 15 in this register), the Fatal Bus Error Interrupt is enabled.
pub struct FBEE_W<'a> {
    w: &'a mut W,
}
impl<'a> FBEE_W<'a> {
...
///Field `AIE` reader - Abnormal interrupt summary enable When this bit is set, an Abnormal Interrupt summary is enabled.
...
///Field `AIE` writer - Abnormal interrupt summary enable When this bit is set, an Abnormal Interrupt summary is enabled.
pub struct AIE_W<'a> {
    w: &'a mut W,
}
impl<'a> AIE_W<'a> {
...
///Field `NIE` reader - Normal interrupt summary enable When this bit is set, a normal interrupt is enabled.
...
///Field `NIE` writer - Normal interrupt summary enable When this bit is set, a normal interrupt is enabled.
pub struct NIE_W<'a> {
    w: &'a mut W,
}
impl<'a> NIE_W<'a> {
...
///`read()` method returns [dma_chx_int_en::R](R) reader structure
impl crate::Readable for DMA_CHX_INT_EN_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [dma_chx_int_en::W](W) writer structure
impl crate::Writable for DMA_CHX_INT_EN_SPEC {
    type Writer = W;
}
///`reset()` method sets DMA_CHx_INT_EN to value 0
