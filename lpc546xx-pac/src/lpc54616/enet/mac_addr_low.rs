...
///Field `A31_0` reader - MAC Address0 \[31:0\]
...
///Field `A31_0` writer - MAC Address0 \[31:0\]
///This field contains the lower 32 bits of the 6-byte first MAC address.
...
///`read()` method returns [mac_addr_low::R](R) reader structure
impl crate::Readable for MAC_ADDR_LOW_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [mac_addr_low::W](W) writer structure
impl crate::Writable for MAC_ADDR_LOW_SPEC {
    type Writer = W;
}
///`reset()` method sets MAC_ADDR_LOW to value 0xffff_ffff
