...
impl From<crate::R<MTL_INTR_STAT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MTL_INTR_STAT_SPEC>) -> Self {
        R(reader)
    }
}
///Field `Q0IS` reader - Queue 0 Interrupt status This bit indicates that there is an interrupt from Queue 0.
...
///Field `Q1IS` reader - Queue 1 Interrupt status This bit indicates that there is an interrupt from Queue 1.
...
///`read()` method returns [mtl_intr_stat::R](R) reader structure
impl crate::Readable for MTL_INTR_STAT_SPEC {
    type Reader = R;
}
///`reset()` method sets MTL_INTR_STAT to value 0
