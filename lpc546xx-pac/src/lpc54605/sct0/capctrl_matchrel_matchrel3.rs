...
impl From<crate::R<CAPCTRL_MATCHREL_MATCHREL3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CAPCTRL_MATCHREL_MATCHREL3_SPEC>) -> Self {
        R(reader)
    }
}
///Register `MATCHREL3` writer
...
impl From<crate::W<CAPCTRL_MATCHREL_MATCHREL3_SPEC>> for W {
    #[inline(always)]
...
///`read()` method returns [capctrl_matchrel_matchrel3::R](R) reader structure
impl crate::Readable for CAPCTRL_MATCHREL_MATCHREL3_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [capctrl_matchrel_matchrel3::W](W) writer structure
impl crate::Writable for CAPCTRL_MATCHREL_MATCHREL3_SPEC {
    type Writer = W;
}
///`reset()` method sets MATCHREL3 to value 0
