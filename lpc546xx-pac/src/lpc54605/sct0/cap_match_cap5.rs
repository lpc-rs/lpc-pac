...
///`read()` method returns [cap_match_cap5::R](R) reader structure
impl crate::Readable for CAP_MATCH_CAP5_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [cap_match_cap5::W](W) writer structure
impl crate::Writable for CAP_MATCH_CAP5_SPEC {
    type Writer = W;
}
///`reset()` method sets CAP5 to value 0
