...
///Field `INTSTATUS` reader - Interrupt status.
...
///Field `INTID` reader - Interrupt identification.
...
///Field `FIFOENABLE` reader - Copies of SCInFCR\[0\].
...
///`read()` method returns [iir_fcr_iir::R](R) reader structure
