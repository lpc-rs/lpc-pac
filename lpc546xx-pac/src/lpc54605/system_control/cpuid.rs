...
///Field `REVISION` reader - Indicates patch release: 0x0 = Patch 0
...
///Field `PARTNO` reader - Indicates part number
...
///Field `VARIANT` reader - Indicates processor revision: 0x2 = Revision 2
...
///Field `IMPLEMENTER` reader - Implementer code
...
///`read()` method returns [cpuid::R](R) reader structure
