///Register `HCRHPORTSTATUS` reader
...
///Field `CCS` reader - (read) CurrentConnectStatus This bit reflects the current state of the downstream port.
...
///Field `CCS` writer - (read) CurrentConnectStatus This bit reflects the current state of the downstream port.
pub struct CCS_W<'a> {
    w: &'a mut W,
}
impl<'a> CCS_W<'a> {
...
///Field `PES` reader - (read) PortEnableStatus This bit indicates whether the port is enabled or disabled.
...
///Field `PES` writer - (read) PortEnableStatus This bit indicates whether the port is enabled or disabled.
pub struct PES_W<'a> {
    w: &'a mut W,
}
impl<'a> PES_W<'a> {
...
///Field `PSS` reader - (read) PortSuspendStatus This bit indicates the port is suspended or in the resume sequence.
...
///Field `PSS` writer - (read) PortSuspendStatus This bit indicates the port is suspended or in the resume sequence.
pub struct PSS_W<'a> {
    w: &'a mut W,
}
impl<'a> PSS_W<'a> {
...
///Field `POCI` reader - (read) PortOverCurrentIndicator This bit is only valid when the Root Hub is configured in such a way that overcurrent conditions are reported on a per-port basis.
...
///Field `POCI` writer - (read) PortOverCurrentIndicator This bit is only valid when the Root Hub is configured in such a way that overcurrent conditions are reported on a per-port basis.
pub struct POCI_W<'a> {
    w: &'a mut W,
}
impl<'a> POCI_W<'a> {
...
///Field `PRS` reader - (read) PortResetStatus When this bit is set by a write to SetPortReset, port reset signaling is asserted.
...
///Field `PRS` writer - (read) PortResetStatus When this bit is set by a write to SetPortReset, port reset signaling is asserted.
pub struct PRS_W<'a> {
    w: &'a mut W,
}
impl<'a> PRS_W<'a> {
...
///Field `PPS` reader - (read) PortPowerStatus This bit reflects the porta's power status, regardless of the type of power switching implemented.
...
///Field `PPS` writer - (read) PortPowerStatus This bit reflects the porta's power status, regardless of the type of power switching implemented.
pub struct PPS_W<'a> {
    w: &'a mut W,
}
impl<'a> PPS_W<'a> {
...
///Field `LSDA` reader - (read) LowSpeedDeviceAttached This bit indicates the speed of the device attached to this port.
...
///Field `LSDA` writer - (read) LowSpeedDeviceAttached This bit indicates the speed of the device attached to this port.
pub struct LSDA_W<'a> {
    w: &'a mut W,
}
impl<'a> LSDA_W<'a> {
...
///Field `CSC` reader - ConnectStatusChange This bit is set whenever a connect or disconnect event occurs.
...
///Field `CSC` writer - ConnectStatusChange This bit is set whenever a connect or disconnect event occurs.
pub struct CSC_W<'a> {
    w: &'a mut W,
}
impl<'a> CSC_W<'a> {
...
///Field `PESC` reader - PortEnableStatusChange This bit is set when hardware events cause the PortEnableStatus bit to be cleared.
...
///Field `PESC` writer - PortEnableStatusChange This bit is set when hardware events cause the PortEnableStatus bit to be cleared.
pub struct PESC_W<'a> {
    w: &'a mut W,
}
impl<'a> PESC_W<'a> {
...
///Field `PSSC` reader - PortSuspendStatusChange This bit is set when the full resume sequence is completed.
...
///Field `PSSC` writer - PortSuspendStatusChange This bit is set when the full resume sequence is completed.
pub struct PSSC_W<'a> {
    w: &'a mut W,
}
impl<'a> PSSC_W<'a> {
...
///Field `OCIC` reader - PortOverCurrentIndicatorChange This bit is valid only if overcurrent conditions are reported on a per-port basis.
...
///Field `OCIC` writer - PortOverCurrentIndicatorChange This bit is valid only if overcurrent conditions are reported on a per-port basis.
pub struct OCIC_W<'a> {
    w: &'a mut W,
}
impl<'a> OCIC_W<'a> {
...
///Field `PRSC` reader - PortResetStatusChange This bit is set at the end of the 10 ms port reset signal.
...
///Field `PRSC` writer - PortResetStatusChange This bit is set at the end of the 10 ms port reset signal.
pub struct PRSC_W<'a> {
    w: &'a mut W,
}
impl<'a> PRSC_W<'a> {
...
///`read()` method returns [hcrhportstatus::R](R) reader structure
impl crate::Readable for HCRHPORTSTATUS_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [hcrhportstatus::W](W) writer structure
impl crate::Writable for HCRHPORTSTATUS_SPEC {
    type Writer = W;
}
///`reset()` method sets HCRHPORTSTATUS to value 0
