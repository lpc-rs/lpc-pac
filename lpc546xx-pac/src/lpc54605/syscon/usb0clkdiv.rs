///Register `USB0CLKDIV` reader
pub struct R(crate::R<USB0CLKDIV_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USB0CLKDIV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USB0CLKDIV_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USB0CLKDIV_SPEC>) -> Self {
        R(reader)
    }
}
///Register `USB0CLKDIV` writer
pub struct W(crate::W<USB0CLKDIV_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USB0CLKDIV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USB0CLKDIV_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USB0CLKDIV_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct USB0CLKDIV_SPEC;
impl crate::RegisterSpec for USB0CLKDIV_SPEC {
    type Ux = u32;
}
///`read()` method returns [usb0clkdiv::R](R) reader structure
impl crate::Readable for USB0CLKDIV_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [usb0clkdiv::W](W) writer structure
impl crate::Writable for USB0CLKDIV_SPEC {
    type Writer = W;
}
///`reset()` method sets USB0CLKDIV to value 0x4000_0000
impl crate::Resettable for USB0CLKDIV_SPEC {
    #[inline(always)]
