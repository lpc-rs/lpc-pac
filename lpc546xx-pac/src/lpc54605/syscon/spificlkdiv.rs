...
///`read()` method returns [spificlkdiv::R](R) reader structure
impl crate::Readable for SPIFICLKDIV_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [spificlkdiv::W](W) writer structure
impl crate::Writable for SPIFICLKDIV_SPEC {
    type Writer = W;
}
///`reset()` method sets SPIFICLKDIV to value 0x4000_0000
