...
///Field `DIV` reader - Denominator of the fractional divider. DIV is equal to the programmed value +1. Always set to 0xFF to use with the fractional baud rate generator.
...
///Field `DIV` writer - Denominator of the fractional divider. DIV is equal to the programmed value +1. Always set to 0xFF to use with the fractional baud rate generator.
pub struct DIV_W<'a> {
    w: &'a mut W,
}
impl<'a> DIV_W<'a> {
...
///Field `MULT` reader - Numerator of the fractional divider. MULT is equal to the programmed value.
...
///Field `MULT` writer - Numerator of the fractional divider. MULT is equal to the programmed value.
pub struct MULT_W<'a> {
    w: &'a mut W,
}
impl<'a> MULT_W<'a> {
...
///`read()` method returns [frgctrl::R](R) reader structure
impl crate::Readable for FRGCTRL_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [frgctrl::W](W) writer structure
impl crate::Writable for FRGCTRL_SPEC {
    type Writer = W;
}
///`reset()` method sets FRGCTRL to value 0xff
