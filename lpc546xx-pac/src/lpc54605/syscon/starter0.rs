...
///Field `WDT_BOD` reader - WWDT and BOD interrupt wake-up.
...
///Field `WDT_BOD` writer - WWDT and BOD interrupt wake-up.
...
///Field `GINT0` reader - Group interrupt 0 wake-up.
...
///Field `GINT0` writer - Group interrupt 0 wake-up.
...
///Field `GINT1` reader - Group interrupt 1 wake-up.
...
///Field `GINT1` writer - Group interrupt 1 wake-up.
...
///Field `PIN_INT0` reader - GPIO pin interrupt 0 wake-up.
...
///Field `PIN_INT0` writer - GPIO pin interrupt 0 wake-up.
...
///Field `PIN_INT1` reader - GPIO pin interrupt 1 wake-up.
...
///Field `PIN_INT1` writer - GPIO pin interrupt 1 wake-up.
...
///Field `PIN_INT2` reader - GPIO pin interrupt 2 wake-up.
...
///Field `PIN_INT2` writer - GPIO pin interrupt 2 wake-up.
...
///Field `PIN_INT3` reader - GPIO pin interrupt 3 wake-up.
...
///Field `PIN_INT3` writer - GPIO pin interrupt 3 wake-up.
...
///Field `UTICK` reader - Micro-tick Timer wake-up.
...
///Field `UTICK` writer - Micro-tick Timer wake-up.
...
///Field `MRT` reader - Multi-Rate Timer wake-up.
...
///Field `MRT` writer - Multi-Rate Timer wake-up.
pub struct MRT_W<'a> {
    w: &'a mut W,
}
impl<'a> MRT_W<'a> {
...
///Field `CTIMER0` reader - Standard counter/timer CTIMER0 wake-up.
...
///Field `CTIMER0` writer - Standard counter/timer CTIMER0 wake-up.
...
///Field `CTIMER1` reader - Standard counter/timer CTIMER1 wake-up.
...
///Field `CTIMER1` writer - Standard counter/timer CTIMER1 wake-up.
...
///Field `SCT0` reader - SCT0 wake-up.
...
///Field `SCT0` writer - SCT0 wake-up.
pub struct SCT0_W<'a> {
    w: &'a mut W,
}
impl<'a> SCT0_W<'a> {
...
///Field `CTIMER3` reader - Standard counter/timer CTIMER3 wake-up.
...
///Field `CTIMER3` writer - Standard counter/timer CTIMER3 wake-up.
...
///Field `FLEXCOMM0` reader - Flexcomm0 peripheral interrupt wake-up.
...
///Field `FLEXCOMM0` writer - Flexcomm0 peripheral interrupt wake-up.
...
///Field `FLEXCOMM1` reader - Flexcomm1 peripheral interrupt wake-up.
...
///Field `FLEXCOMM1` writer - Flexcomm1 peripheral interrupt wake-up.
...
///Field `FLEXCOMM2` reader - Flexcomm2 peripheral interrupt wake-up.
...
///Field `FLEXCOMM2` writer - Flexcomm2 peripheral interrupt wake-up.
...
///Field `FLEXCOMM3` reader - Flexcomm3 peripheral interrupt wake-up.
...
///Field `FLEXCOMM3` writer - Flexcomm3 peripheral interrupt wake-up.
...
///Field `FLEXCOMM4` reader - Flexcomm4 peripheral interrupt wake-up.
...
///Field `FLEXCOMM4` writer - Flexcomm4 peripheral interrupt wake-up.
...
///Field `FLEXCOMM5` reader - Flexcomm5 peripheral interrupt wake-up.
...
///Field `FLEXCOMM5` writer - Flexcomm5 peripheral interrupt wake-up.
...
///Field `FLEXCOMM6` reader - Flexcomm6 peripheral interrupt wake-up.
...
///Field `FLEXCOMM6` writer - Flexcomm6 peripheral interrupt wake-up.
...
///Field `FLEXCOMM7` reader - Flexcomm7 peripheral interrupt wake-up.
...
///Field `FLEXCOMM7` writer - Flexcomm7 peripheral interrupt wake-up.
...
///Field `ADC0_SEQA` reader - ADC0 sequence A interrupt wake-up.
...
///Field `ADC0_SEQA` writer - ADC0 sequence A interrupt wake-up.
...
///Field `ADC0_SEQB` reader - ADC0 sequence B interrupt wake-up.
...
///Field `ADC0_SEQB` writer - ADC0 sequence B interrupt wake-up.
...
///Field `ADC0_THCMP` reader - ADC0 threshold and error interrupt wake-up.
...
///Field `ADC0_THCMP` writer - ADC0 threshold and error interrupt wake-up.
...
///Field `DMIC` reader - Digital microphone interrupt wake-up.
...
///Field `DMIC` writer - Digital microphone interrupt wake-up.
pub struct DMIC_W<'a> {
    w: &'a mut W,
}
impl<'a> DMIC_W<'a> {
...
///Field `HWVAD` reader - Hardware voice activity detect interrupt wake-up.
...
///Field `HWVAD` writer - Hardware voice activity detect interrupt wake-up.
...
///Field `USB0_NEEDCLK` reader - USB activity interrupt wake-up.
...
///Field `USB0_NEEDCLK` writer - USB activity interrupt wake-up.
...
///Field `USB0` reader - USB function interrupt wake-up.
...
///Field `USB0` writer - USB function interrupt wake-up.
pub struct USB0_W<'a> {
    w: &'a mut W,
}
impl<'a> USB0_W<'a> {
...
///Field `RTC` reader - RTC interrupt alarm and wake-up timer.
...
///Field `RTC` writer - RTC interrupt alarm and wake-up timer.
pub struct RTC_W<'a> {
    w: &'a mut W,
}
impl<'a> RTC_W<'a> {
...
///`read()` method returns [starter0::R](R) reader structure
impl crate::Readable for STARTER0_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [starter0::W](W) writer structure
impl crate::Writable for STARTER0_SPEC {
    type Writer = W;
}
///`reset()` method sets STARTER0 to value 0
