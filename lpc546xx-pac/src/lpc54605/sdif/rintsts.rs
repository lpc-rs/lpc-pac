...
///Field `RTO_BAR` reader - Response time-out (RTO)/Boot Ack Received (BAR).
pub struct RTO_BAR_R(crate::FieldReader<bool, bool>);
impl RTO_BAR_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        RTO_BAR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RTO_BAR_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
///Field `RTO_BAR` writer - Response time-out (RTO)/Boot Ack Received (BAR).
...
///Field `DRTO_BDS` reader - Data read time-out (DRTO)/Boot Data Start (BDS).
pub struct DRTO_BDS_R(crate::FieldReader<bool, bool>);
impl DRTO_BDS_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        DRTO_BDS_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DRTO_BDS_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
///Field `DRTO_BDS` writer - Data read time-out (DRTO)/Boot Data Start (BDS).
...
impl core::ops::Deref for SDIO_INTERRUPT_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
