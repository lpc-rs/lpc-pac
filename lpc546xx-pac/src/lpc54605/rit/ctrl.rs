...
///Field `RITINT` reader - Interrupt flag.
...
///Field `RITENCLR` reader - Timer enable clear.
...
///Field `RITENCLR` writer - Timer enable clear.
...
///Field `RITENBR` reader - Timer enable for debug.
...
///Field `RITENBR` writer - Timer enable for debug.
...
///Field `RITEN` reader - Timer enable.
...
///`reset()` method sets CTRL to value 0x0c
