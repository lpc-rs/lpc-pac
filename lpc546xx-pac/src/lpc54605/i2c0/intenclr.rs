...
///Field `MSTPENDINGCLR` writer - Master Pending interrupt clear. Writing 1 to this bit clears the corresponding bit in the INTENSET register if implemented.
...
///Field `MSTARBLOSSCLR` writer - Master Arbitration Loss interrupt clear.
...
///Field `MSTSTSTPERRCLR` writer - Master Start/Stop Error interrupt clear.
...
///Field `SLVPENDINGCLR` writer - Slave Pending interrupt clear.
...
///Field `SLVNOTSTRCLR` writer - Slave Not Stretching interrupt clear.
...
///Field `SLVDESELCLR` writer - Slave Deselect interrupt clear.
...
///Field `MONRDYCLR` writer - Monitor data Ready interrupt clear.
...
///Field `MONOVCLR` writer - Monitor Overrun interrupt clear.
...
///Field `MONIDLECLR` writer - Monitor Idle interrupt clear.
...
///Field `EVENTTIMEOUTCLR` writer - Event time-out interrupt clear.
...
///Field `SCLTIMEOUTCLR` writer - SCL time-out interrupt clear.
