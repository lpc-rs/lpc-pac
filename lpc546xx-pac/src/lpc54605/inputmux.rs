...
pub struct RegisterBlock {
    ///0x00..0x1c - Trigger select register for DMA channel
    pub sct0_inmux: [crate::Reg<sct0_inmux::SCT0_INMUX_SPEC>; 7],
    _reserved1: [u8; 0xa4],
    ///0xc0..0xe0 - Pin interrupt select register
    pub pintsel: [crate::Reg<pintsel::PINTSEL_SPEC>; 8],
    ///0xe0..0x158 - Trigger select register for DMA channel
    pub dma_itrig_inmux: [crate::Reg<dma_itrig_inmux::DMA_ITRIG_INMUX_SPEC>; 30],
    _reserved3: [u8; 0x08],
    ///0x160..0x170 - DMA output trigger selection to become DMA trigger
...
///FREQMEAS_REF register accessor: an alias for `Reg<FREQMEAS_REF_SPEC>`
...
///FREQMEAS_TARGET register accessor: an alias for `Reg<FREQMEAS_TARGET_SPEC>`
