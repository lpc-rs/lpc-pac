...
///Field `INT` reader - Group interrupt status. This bit is cleared by writing a one to it. Writing zero has no effect.
...
///Field `INT` writer - Group interrupt status. This bit is cleared by writing a one to it. Writing zero has no effect.
pub struct INT_W<'a> {
    w: &'a mut W,
}
impl<'a> INT_W<'a> {
...
///Field `COMB` reader - Combine enabled inputs for group interrupt
...
///Field `COMB` writer - Combine enabled inputs for group interrupt
pub struct COMB_W<'a> {
    w: &'a mut W,
}
impl<'a> COMB_W<'a> {
...
///Field `TRIG` reader - Group interrupt trigger
...
///Field `TRIG` writer - Group interrupt trigger
pub struct TRIG_W<'a> {
    w: &'a mut W,
}
impl<'a> TRIG_W<'a> {
