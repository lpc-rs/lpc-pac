...
///Field `PCDE` reader - Port Change Detect Interrupt Enable: 1: enable 0: disable.
...
///Field `PCDE` writer - Port Change Detect Interrupt Enable: 1: enable 0: disable.
pub struct PCDE_W<'a> {
    w: &'a mut W,
}
impl<'a> PCDE_W<'a> {
...
///Field `FLRE` reader - Frame List Rollover Interrupt Enable: 1: enable 0: disable.
...
///Field `FLRE` writer - Frame List Rollover Interrupt Enable: 1: enable 0: disable.
pub struct FLRE_W<'a> {
    w: &'a mut W,
}
impl<'a> FLRE_W<'a> {
...
///Field `ATL_IRQ_E` reader - ATL IRQ Enable bit: 1: enable 0: disable.
...
///Field `ATL_IRQ_E` writer - ATL IRQ Enable bit: 1: enable 0: disable.
...
///Field `ISO_IRQ_E` reader - ISO IRQ Enable bit: 1: enable 0: disable.
...
///Field `ISO_IRQ_E` writer - ISO IRQ Enable bit: 1: enable 0: disable.
...
///Field `INT_IRQ_E` reader - INT IRQ Enable bit: 1: enable 0: disable.
...
///Field `INT_IRQ_E` writer - INT IRQ Enable bit: 1: enable 0: disable.
...
///Field `SOF_E` reader - SOF Interrupt Enable bit: 1: enable 0: disable.
...
///Field `SOF_E` writer - SOF Interrupt Enable bit: 1: enable 0: disable.
