...
///Field `N_PORTS` reader - This register specifies the number of physical downstream ports implemented on this host controller.
...
///Field `PPC` reader - This field indicates whether the host controller implementation includes port power control.
...
///Field `P_INDICATOR` reader - This bit indicates whether the ports support port indicator control.
...
///`read()` method returns [hcsparams::R](R) reader structure
impl crate::Readable for HCSPARAMS_SPEC {
    type Reader = R;
}
///`reset()` method sets HCSPARAMS to value 0x0001_0011
