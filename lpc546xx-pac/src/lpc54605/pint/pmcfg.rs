...
///Field `PROD_ENDPTS0` reader - Determines whether slice 0 is an endpoint.
...
///Field `PROD_ENDPTS0` writer - Determines whether slice 0 is an endpoint.
...
///Field `PROD_ENDPTS1` reader - Determines whether slice 1 is an endpoint.
...
///Field `PROD_ENDPTS1` writer - Determines whether slice 1 is an endpoint.
...
///Field `PROD_ENDPTS2` reader - Determines whether slice 2 is an endpoint.
...
///Field `PROD_ENDPTS2` writer - Determines whether slice 2 is an endpoint.
...
///Field `PROD_ENDPTS3` reader - Determines whether slice 3 is an endpoint.
...
///Field `PROD_ENDPTS3` writer - Determines whether slice 3 is an endpoint.
...
///Field `PROD_ENDPTS4` reader - Determines whether slice 4 is an endpoint.
...
///Field `PROD_ENDPTS4` writer - Determines whether slice 4 is an endpoint.
...
///Field `PROD_ENDPTS5` reader - Determines whether slice 5 is an endpoint.
...
///Field `PROD_ENDPTS5` writer - Determines whether slice 5 is an endpoint.
...
///Field `PROD_ENDPTS6` reader - Determines whether slice 6 is an endpoint.
...
///Field `PROD_ENDPTS6` writer - Determines whether slice 6 is an endpoint.
...
///Field `CFG0` reader - Specifies the match contribution condition for bit slice 0.
...
///Field `CFG0` writer - Specifies the match contribution condition for bit slice 0.
pub struct CFG0_W<'a> {
    w: &'a mut W,
}
impl<'a> CFG0_W<'a> {
...
///Field `CFG1` reader - Specifies the match contribution condition for bit slice 1.
...
///Field `CFG1` writer - Specifies the match contribution condition for bit slice 1.
pub struct CFG1_W<'a> {
    w: &'a mut W,
}
impl<'a> CFG1_W<'a> {
...
///Field `CFG2` reader - Specifies the match contribution condition for bit slice 2.
...
///Field `CFG2` writer - Specifies the match contribution condition for bit slice 2.
pub struct CFG2_W<'a> {
    w: &'a mut W,
}
impl<'a> CFG2_W<'a> {
...
///Field `CFG3` reader - Specifies the match contribution condition for bit slice 3.
...
///Field `CFG3` writer - Specifies the match contribution condition for bit slice 3.
pub struct CFG3_W<'a> {
    w: &'a mut W,
}
impl<'a> CFG3_W<'a> {
...
///Field `CFG4` reader - Specifies the match contribution condition for bit slice 4.
...
///Field `CFG5` reader - Specifies the match contribution condition for bit slice 5.
...
///Field `CFG5` writer - Specifies the match contribution condition for bit slice 5.
pub struct CFG5_W<'a> {
    w: &'a mut W,
}
impl<'a> CFG5_W<'a> {
...
///Field `CFG6` reader - Specifies the match contribution condition for bit slice 6.
...
///Field `CFG6` writer - Specifies the match contribution condition for bit slice 6.
pub struct CFG6_W<'a> {
    w: &'a mut W,
}
impl<'a> CFG6_W<'a> {
...
///Field `CFG7` reader - Specifies the match contribution condition for bit slice 7.
...
///Field `CFG7` writer - Specifies the match contribution condition for bit slice 7.
pub struct CFG7_W<'a> {
    w: &'a mut W,
}
impl<'a> CFG7_W<'a> {
...
///`read()` method returns [pmcfg::R](R) reader structure
impl crate::Readable for PMCFG_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pmcfg::W](W) writer structure
impl crate::Writable for PMCFG_SPEC {
    type Writer = W;
}
///`reset()` method sets PMCFG to value 0
