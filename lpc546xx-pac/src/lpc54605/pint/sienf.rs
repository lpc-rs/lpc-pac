...
///Field `SETENAF` writer - Ones written to this address set bits in the IENF, thus enabling interrupts. Bit n sets bit n in the IENF register. 0 = No operation. 1 = Select HIGH-active interrupt or enable falling edge interrupt.
...
///`write(|w| ..)` method takes [sienf::W](W) writer structure
impl crate::Writable for SIENF_SPEC {
    type Writer = W;
}
///`reset()` method sets SIENF to value 0
