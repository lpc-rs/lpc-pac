...
///Field `FDET` reader - Falling edge detect. Bit n detects the falling edge of the pin selected in PINTSELn. Read 0: No falling edge has been detected on this pin since Reset or the last time a one was written to this bit. Write 0: no operation. Read 1: a falling edge has been detected since Reset or the last time a one was written to this bit. Write 1: clear falling edge detection for this pin.
...
///Field `FDET` writer - Falling edge detect. Bit n detects the falling edge of the pin selected in PINTSELn. Read 0: No falling edge has been detected on this pin since Reset or the last time a one was written to this bit. Write 0: no operation. Read 1: a falling edge has been detected since Reset or the last time a one was written to this bit. Write 1: clear falling edge detection for this pin.
pub struct FDET_W<'a> {
    w: &'a mut W,
}
impl<'a> FDET_W<'a> {
...
///`read()` method returns [fall::R](R) reader structure
impl crate::Readable for FALL_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [fall::W](W) writer structure
impl crate::Writable for FALL_SPEC {
    type Writer = W;
}
///`reset()` method sets FALL to value 0
