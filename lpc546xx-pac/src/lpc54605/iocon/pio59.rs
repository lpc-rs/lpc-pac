...
///`read()` method returns [pio59::R](R) reader structure
impl crate::Readable for PIO59_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio59::W](W) writer structure
impl crate::Writable for PIO59_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO59 to value 0x0320
