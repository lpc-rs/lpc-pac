...
///`read()` method returns [pio226::R](R) reader structure
impl crate::Readable for PIO226_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio226::W](W) writer structure
impl crate::Writable for PIO226_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO226 to value 0x0320
