...
///`read()` method returns [pio317::R](R) reader structure
impl crate::Readable for PIO317_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio317::W](W) writer structure
impl crate::Writable for PIO317_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO317 to value 0x0320
