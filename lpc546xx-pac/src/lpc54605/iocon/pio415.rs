...
///`read()` method returns [pio415::R](R) reader structure
impl crate::Readable for PIO415_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio415::W](W) writer structure
impl crate::Writable for PIO415_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO415 to value 0x0320
