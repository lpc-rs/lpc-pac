...
///`read()` method returns [pio013::R](R) reader structure
impl crate::Readable for PIO013_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio013::W](W) writer structure
impl crate::Writable for PIO013_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO013 to value 0x0340
