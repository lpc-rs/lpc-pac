...
///`read()` method returns [pio12::R](R) reader structure
impl crate::Readable for PIO12_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio12::W](W) writer structure
impl crate::Writable for PIO12_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO12 to value 0x0320
