...
///`read()` method returns [pio414::R](R) reader structure
impl crate::Readable for PIO414_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio414::W](W) writer structure
impl crate::Writable for PIO414_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO414 to value 0x0320
