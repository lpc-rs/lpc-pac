...
///`read()` method returns [pio214::R](R) reader structure
impl crate::Readable for PIO214_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio214::W](W) writer structure
impl crate::Writable for PIO214_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO214 to value 0x0320
