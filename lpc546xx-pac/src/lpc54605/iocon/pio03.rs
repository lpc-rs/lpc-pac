...
///`read()` method returns [pio03::R](R) reader structure
impl crate::Readable for PIO03_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio03::W](W) writer structure
impl crate::Writable for PIO03_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO03 to value 0x0320
