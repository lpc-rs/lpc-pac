...
///`read()` method returns [pio54::R](R) reader structure
impl crate::Readable for PIO54_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio54::W](W) writer structure
impl crate::Writable for PIO54_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO54 to value 0x0320
