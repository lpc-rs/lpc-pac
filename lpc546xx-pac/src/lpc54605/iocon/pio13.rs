...
///`read()` method returns [pio13::R](R) reader structure
impl crate::Readable for PIO13_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio13::W](W) writer structure
impl crate::Writable for PIO13_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO13 to value 0x0320
