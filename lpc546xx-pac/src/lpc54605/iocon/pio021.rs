...
///`read()` method returns [pio021::R](R) reader structure
impl crate::Readable for PIO021_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio021::W](W) writer structure
impl crate::Writable for PIO021_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO021 to value 0x0320
