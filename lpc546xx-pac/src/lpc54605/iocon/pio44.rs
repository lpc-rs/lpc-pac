...
///`read()` method returns [pio44::R](R) reader structure
impl crate::Readable for PIO44_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio44::W](W) writer structure
impl crate::Writable for PIO44_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO44 to value 0x0320
