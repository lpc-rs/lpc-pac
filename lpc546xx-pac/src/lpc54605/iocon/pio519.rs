...
///`read()` method returns [pio519::R](R) reader structure
impl crate::Readable for PIO519_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio519::W](W) writer structure
impl crate::Writable for PIO519_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO519 to value 0x0320
