...
///`read()` method returns [pio55::R](R) reader structure
impl crate::Readable for PIO55_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio55::W](W) writer structure
impl crate::Writable for PIO55_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO55 to value 0x0320
