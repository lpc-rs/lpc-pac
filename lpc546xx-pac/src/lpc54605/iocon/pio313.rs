...
///`read()` method returns [pio313::R](R) reader structure
impl crate::Readable for PIO313_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio313::W](W) writer structure
impl crate::Writable for PIO313_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO313 to value 0x0320
