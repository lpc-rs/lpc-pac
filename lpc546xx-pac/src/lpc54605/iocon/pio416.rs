...
///`read()` method returns [pio416::R](R) reader structure
impl crate::Readable for PIO416_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio416::W](W) writer structure
impl crate::Writable for PIO416_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO416 to value 0x0320
