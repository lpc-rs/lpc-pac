...
///`read()` method returns [pio40::R](R) reader structure
impl crate::Readable for PIO40_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio40::W](W) writer structure
impl crate::Writable for PIO40_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO40 to value 0x0320
