...
///`read()` method returns [pio411::R](R) reader structure
impl crate::Readable for PIO411_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio411::W](W) writer structure
impl crate::Writable for PIO411_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO411 to value 0x0320
