...
///`read()` method returns [pio213::R](R) reader structure
impl crate::Readable for PIO213_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio213::W](W) writer structure
impl crate::Writable for PIO213_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO213 to value 0x0320
