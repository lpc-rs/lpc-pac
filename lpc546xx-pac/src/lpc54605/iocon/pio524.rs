...
///`read()` method returns [pio524::R](R) reader structure
impl crate::Readable for PIO524_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio524::W](W) writer structure
impl crate::Writable for PIO524_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO524 to value 0x0320
