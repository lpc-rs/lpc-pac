...
///`read()` method returns [pio46::R](R) reader structure
impl crate::Readable for PIO46_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio46::W](W) writer structure
impl crate::Writable for PIO46_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO46 to value 0x0320
