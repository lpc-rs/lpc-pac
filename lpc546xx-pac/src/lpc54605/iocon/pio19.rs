...
///`read()` method returns [pio19::R](R) reader structure
impl crate::Readable for PIO19_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio19::W](W) writer structure
impl crate::Writable for PIO19_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO19 to value 0x0320
