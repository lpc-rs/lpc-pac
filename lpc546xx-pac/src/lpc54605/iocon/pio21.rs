...
///`read()` method returns [pio21::R](R) reader structure
impl crate::Readable for PIO21_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio21::W](W) writer structure
impl crate::Writable for PIO21_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO21 to value 0x0320
