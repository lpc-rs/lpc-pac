...
///`read()` method returns [pio426::R](R) reader structure
impl crate::Readable for PIO426_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio426::W](W) writer structure
impl crate::Writable for PIO426_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO426 to value 0x0320
