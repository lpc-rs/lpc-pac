...
///`read()` method returns [pio39::R](R) reader structure
impl crate::Readable for PIO39_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio39::W](W) writer structure
impl crate::Writable for PIO39_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO39 to value 0x0320
