...
///`read()` method returns [pio419::R](R) reader structure
impl crate::Readable for PIO419_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio419::W](W) writer structure
impl crate::Writable for PIO419_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO419 to value 0x0320
