...
///`read()` method returns [pio129::R](R) reader structure
impl crate::Readable for PIO129_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio129::W](W) writer structure
impl crate::Writable for PIO129_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO129 to value 0x0320
