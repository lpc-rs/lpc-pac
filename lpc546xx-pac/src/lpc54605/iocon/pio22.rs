...
///`read()` method returns [pio22::R](R) reader structure
impl crate::Readable for PIO22_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio22::W](W) writer structure
impl crate::Writable for PIO22_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO22 to value 0x0320
