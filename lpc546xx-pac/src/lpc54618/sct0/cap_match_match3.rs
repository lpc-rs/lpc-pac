...
///`read()` method returns [cap_match_match3::R](R) reader structure
impl crate::Readable for CAP_MATCH_MATCH3_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [cap_match_match3::W](W) writer structure
impl crate::Writable for CAP_MATCH_MATCH3_SPEC {
    type Writer = W;
}
///`reset()` method sets MATCH3 to value 0
