...
///Field `PWMEN0` reader - PWM mode enable for channel0.
...
///Field `PWMEN0` writer - PWM mode enable for channel0.
...
///Field `PWMEN1` reader - PWM mode enable for channel1.
...
///Field `PWMEN1` writer - PWM mode enable for channel1.
...
///Field `PWMEN2` reader - PWM mode enable for channel2.
...
///Field `PWMEN2` writer - PWM mode enable for channel2.
...
///Field `PWMEN3` reader - PWM mode enable for channel3. Note: It is recommended to use match channel 3 to set the PWM cycle.
...
///Field `PWMEN3` writer - PWM mode enable for channel3. Note: It is recommended to use match channel 3 to set the PWM cycle.
...
///`read()` method returns [pwmc::R](R) reader structure
impl crate::Readable for PWMC_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pwmc::W](W) writer structure
impl crate::Writable for PWMC_SPEC {
    type Writer = W;
}
///`reset()` method sets PWMC to value 0
