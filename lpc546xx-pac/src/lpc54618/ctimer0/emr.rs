...
pub enum EMC0_A {
    ///0: Do Nothing.
    DO_NOTHING = 0,
    ///1: Clear. Clear the corresponding External Match bit/output to 0 (MAT0 pin is LOW if pinned out).
    CLEAR = 1,
    ///2: Set. Set the corresponding External Match bit/output to 1 (MAT0 pin is HIGH if pinned out).
    SET = 2,
...
///Field `EMC0` reader - External Match Control 0. Determines the functionality of External Match 0.
...
pub enum EMC1_A {
    ///0: Do Nothing.
    DO_NOTHING = 0,
    ///1: Clear. Clear the corresponding External Match bit/output to 0 (MAT1 pin is LOW if pinned out).
    CLEAR = 1,
    ///2: Set. Set the corresponding External Match bit/output to 1 (MAT1 pin is HIGH if pinned out).
    SET = 2,
    ///3: Toggle. Toggle the corresponding External Match bit/output.
    TOGGLE = 3,
}
...
///Field `EMC1` reader - External Match Control 1. Determines the functionality of External Match 1.
...
///Field `EMC1` writer - External Match Control 1. Determines the functionality of External Match 1.
pub struct EMC1_W<'a> {
    w: &'a mut W,
}
impl<'a> EMC1_W<'a> {
...
pub enum EMC2_A {
    ///0: Do Nothing.
    DO_NOTHING = 0,
    ///1: Clear. Clear the corresponding External Match bit/output to 0 (MAT2 pin is LOW if pinned out).
    CLEAR = 1,
    ///2: Set. Set the corresponding External Match bit/output to 1 (MAT2 pin is HIGH if pinned out).
    SET = 2,
    ///3: Toggle. Toggle the corresponding External Match bit/output.
    TOGGLE = 3,
}
...
///Field `EMC2` reader - External Match Control 2. Determines the functionality of External Match 2.
...
///Field `EMC2` writer - External Match Control 2. Determines the functionality of External Match 2.
pub struct EMC2_W<'a> {
    w: &'a mut W,
}
impl<'a> EMC2_W<'a> {
...
pub enum EMC3_A {
    ///0: Do Nothing.
    DO_NOTHING = 0,
    ///1: Clear. Clear the corresponding External Match bit/output to 0 (MAT3 pin is LOW if pinned out).
    CLEAR = 1,
    ///2: Set. Set the corresponding External Match bit/output to 1 (MAT3 pin is HIGH if pinned out).
    SET = 2,
    ///3: Toggle. Toggle the corresponding External Match bit/output.
    TOGGLE = 3,
}
...
///Field `EMC3` reader - External Match Control 3. Determines the functionality of External Match 3.
...
///Field `EMC3` writer - External Match Control 3. Determines the functionality of External Match 3.
pub struct EMC3_W<'a> {
    w: &'a mut W,
}
impl<'a> EMC3_W<'a> {
