...
///Field `CLR` writer - Writing ones to this register clears corresponding bits in the INTENSET0. Bit n corresponds to DMA channel n. The number of bits = number of DMA channels in this device. Other bits are reserved.
pub struct CLR_W<'a> {
    w: &'a mut W,
}
impl<'a> CLR_W<'a> {
...
///`write(|w| ..)` method takes [intenclr0::W](W) writer structure
impl crate::Writable for INTENCLR0_SPEC {
    type Writer = W;
}
///`reset()` method sets INTENCLR0 to value 0
