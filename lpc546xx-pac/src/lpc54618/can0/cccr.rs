...
///Field `FDOE` reader - CAN FD operation enable.
...
///Field `FDOE` writer - CAN FD operation enable.
pub struct FDOE_W<'a> {
    w: &'a mut W,
}
impl<'a> FDOE_W<'a> {
...
///Field `BRSE` reader - When CAN FD operation is disabled, this bit is not evaluated.
...
///Field `BRSE` writer - When CAN FD operation is disabled, this bit is not evaluated.
pub struct BRSE_W<'a> {
    w: &'a mut W,
}
impl<'a> BRSE_W<'a> {
