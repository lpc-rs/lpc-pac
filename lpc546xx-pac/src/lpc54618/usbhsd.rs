...
pub struct RegisterBlock {
    ...
    _reserved12: [u8; 0x04],
    ///0x3c - UTMI/ULPI debug register
    pub ulpidebug: crate::Reg<ulpidebug::ULPIDEBUG_SPEC>,
}
///DEVCMDSTAT register accessor: an alias for `Reg<DEVCMDSTAT_SPEC>`
pub type DEVCMDSTAT = crate::Reg<devcmdstat::DEVCMDSTAT_SPEC>;
///USB Device Command/Status register
pub mod devcmdstat;
///INFO register accessor: an alias for `Reg<INFO_SPEC>`
pub type INFO = crate::Reg<info::INFO_SPEC>;
///USB Info register
pub mod info;
///EPLISTSTART register accessor: an alias for `Reg<EPLISTSTART_SPEC>`
pub type EPLISTSTART = crate::Reg<epliststart::EPLISTSTART_SPEC>;
///USB EP Command/Status List start address
pub mod epliststart;
///DATABUFSTART register accessor: an alias for `Reg<DATABUFSTART_SPEC>`
pub type DATABUFSTART = crate::Reg<databufstart::DATABUFSTART_SPEC>;
///USB Data buffer start address
pub mod databufstart;
///LPM register accessor: an alias for `Reg<LPM_SPEC>`
pub type LPM = crate::Reg<lpm::LPM_SPEC>;
///USB Link Power Management register
pub mod lpm;
///EPSKIP register accessor: an alias for `Reg<EPSKIP_SPEC>`
pub type EPSKIP = crate::Reg<epskip::EPSKIP_SPEC>;
///USB Endpoint skip
pub mod epskip;
///EPINUSE register accessor: an alias for `Reg<EPINUSE_SPEC>`
pub type EPINUSE = crate::Reg<epinuse::EPINUSE_SPEC>;
///USB Endpoint Buffer in use
pub mod epinuse;
///EPBUFCFG register accessor: an alias for `Reg<EPBUFCFG_SPEC>`
...
pub mod inten;
///INTSETSTAT register accessor: an alias for `Reg<INTSETSTAT_SPEC>`
pub type INTSETSTAT = crate::Reg<intsetstat::INTSETSTAT_SPEC>;
///USB set interrupt status register
pub mod intsetstat;
///EPTOGGLE register accessor: an alias for `Reg<EPTOGGLE_SPEC>`
pub type EPTOGGLE = crate::Reg<eptoggle::EPTOGGLE_SPEC>;
///USB Endpoint toggle register
pub mod eptoggle;
///ULPIDEBUG register accessor: an alias for `Reg<ULPIDEBUG_SPEC>`
pub type ULPIDEBUG = crate::Reg<ulpidebug::ULPIDEBUG_SPEC>;
