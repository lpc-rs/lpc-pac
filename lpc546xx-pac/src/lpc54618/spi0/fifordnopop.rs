...
///Field `RXSSEL0_N` reader - Slave Select for receive.
...
///Field `RXSSEL1_N` reader - Slave Select for receive.
...
///Field `RXSSEL2_N` reader - Slave Select for receive.
...
///Field `RXSSEL3_N` reader - Slave Select for receive.
...
///Field `SOT` reader - Start of transfer flag.
