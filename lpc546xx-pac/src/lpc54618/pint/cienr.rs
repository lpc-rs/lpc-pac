...
///Field `CENRL` writer - Ones written to this address clear bits in the IENR, thus disabling the interrupts. Bit n clears bit n in the IENR register. 0 = No operation. 1 = Disable rising edge or level interrupt.
...
///`write(|w| ..)` method takes [cienr::W](W) writer structure
impl crate::Writable for CIENR_SPEC {
    type Writer = W;
}
///`reset()` method sets CIENR to value 0
