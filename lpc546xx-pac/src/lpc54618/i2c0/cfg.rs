...
pub enum MSTEN_A {
    ///0: Disabled. The I2C Master function is disabled.
    DISABLED = 0,
    ///1: Enabled. The I2C Master function is enabled.
    ENABLED = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum SLVEN_A {
    ///0: Disabled. The I2C slave function is disabled.
    DISABLED = 0,
    ///1: Enabled. The I2C slave function is enabled.
    ENABLED = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum MONEN_A {
    ///0: Disabled. The I2C Monitor function is disabled.
    DISABLED = 0,
    ///1: Enabled. The I2C Monitor function is enabled.
    ENABLED = 1,
}
...
///Field `HSCAPABLE` reader - High-speed mode Capable enable. Since High Speed mode alters the way I2C pins drive and filter, as well as the timing for certain I2C signalling, enabling High-speed mode applies to all functions: Master, Slave, and Monitor.
...
///Field `HSCAPABLE` writer - High-speed mode Capable enable. Since High Speed mode alters the way I2C pins drive and filter, as well as the timing for certain I2C signalling, enabling High-speed mode applies to all functions: Master, Slave, and Monitor.
