...
///Field `DATA` reader - Master function data register. Read: read the most recently received data for the Master function. Write: transmit data using the Master function.
...
///Field `DATA` writer - Master function data register. Read: read the most recently received data for the Master function. Write: transmit data using the Master function.
pub struct DATA_W<'a> {
    w: &'a mut W,
}
impl<'a> DATA_W<'a> {
...
///`read()` method returns [mstdat::R](R) reader structure
impl crate::Readable for MSTDAT_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [mstdat::W](W) writer structure
impl crate::Writable for MSTDAT_SPEC {
    type Writer = W;
}
///`reset()` method sets MSTDAT to value 0
