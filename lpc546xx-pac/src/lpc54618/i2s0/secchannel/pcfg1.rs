...
///Field `PAIRENABLE` reader - Enable for this channel pair..
...
///Field `PAIRENABLE` writer - Enable for this channel pair..
...
///Field `ONECHANNEL` reader - Single channel mode.
...
///Field `ONECHANNEL` writer - Single channel mode.
...
///`read()` method returns [pcfg1::R](R) reader structure
impl crate::Readable for PCFG1_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pcfg1::W](W) writer structure
impl crate::Writable for PCFG1_SPEC {
    type Writer = W;
}
///`reset()` method sets PCFG1 to value 0
