///Register `LAST_PTD_INUSE` reader
...
///Register `LAST_PTD_INUSE` writer
...
///Field `ATL_LAST` reader - If hardware has reached this PTD and the J bit is not set, it will go to PTD0 as the next PTD to be processed.
...
///Field `ATL_LAST` writer - If hardware has reached this PTD and the J bit is not set, it will go to PTD0 as the next PTD to be processed.
...
///Field `ISO_LAST` reader - This indicates the last PTD in the ISO list.
...
///Field `ISO_LAST` writer - This indicates the last PTD in the ISO list.
...
///Field `INT_LAST` reader - This indicates the last PTD in the INT list.
...
///Field `INT_LAST` writer - This indicates the last PTD in the INT list.
...
///`read()` method returns [last_ptd_inuse::R](R) reader structure
impl crate::Readable for LAST_PTD_INUSE_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [last_ptd_inuse::W](W) writer structure
impl crate::Writable for LAST_PTD_INUSE_SPEC {
    type Writer = W;
}
///`reset()` method sets LAST_PTD_INUSE to value 0
