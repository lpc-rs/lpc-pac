...
///Field `RS` reader - Run/Stop: 1b = Run.
...
///Field `RS` writer - Run/Stop: 1b = Run.
pub struct RS_W<'a> {
    w: &'a mut W,
}
impl<'a> RS_W<'a> {
...
///Field `HCRESET` reader - Host Controller Reset: This control bit is used by the software to reset the host controller.
...
///Field `HCRESET` writer - Host Controller Reset: This control bit is used by the software to reset the host controller.
...
///Field `FLS` reader - Frame List Size: This field specifies the size of the frame list.
...
///Field `FLS` writer - Frame List Size: This field specifies the size of the frame list.
pub struct FLS_W<'a> {
    w: &'a mut W,
}
impl<'a> FLS_W<'a> {
...
///Field `LHCR` reader - Light Host Controller Reset: This bit allows the driver software to reset the host controller without affecting the state of the ports.
...
///Field `LHCR` writer - Light Host Controller Reset: This bit allows the driver software to reset the host controller without affecting the state of the ports.
pub struct LHCR_W<'a> {
    w: &'a mut W,
}
impl<'a> LHCR_W<'a> {
...
///Field `ATL_EN` reader - ATL List enabled.
...
///Field `ATL_EN` writer - ATL List enabled.
...
///Field `ISO_EN` reader - ISO List enabled.
...
///Field `ISO_EN` writer - ISO List enabled.
...
///Field `INT_EN` reader - INT List enabled.
...
///Field `INT_EN` writer - INT List enabled.
...
///Field `HIRD` reader - Host-Initiated Resume Duration.
...
///Field `HIRD` writer - Host-Initiated Resume Duration.
pub struct HIRD_W<'a> {
    w: &'a mut W,
}
impl<'a> HIRD_W<'a> {
...
///Field `LPM_RWU` reader - bRemoteWake field.
...
///Field `LPM_RWU` writer - bRemoteWake field.
