...
///Field `VLHASH` reader - Hash Table Based Filtering option.
...
///Field `RWKSEL` reader - PMT Remote Wake-up Packet Detection.
...
///Field `MGKSEL` reader - PMT magic packet detection.
...
///Field `MGKSEL` writer - PMT magic packet detection.
...
///Field `TSSEL` reader - IEEE 1588-2008 Timestamp support .
...
///Field `EEESEL` reader - Energy Efficient Ethernet Support .
...
///Field `TXCOESEL` reader - Transmit Checksum Offload Support.
...
///Field `RXCOESEL` reader - Receive Checksum Offload Support.
...
///Field `RXCOESEL` writer - Receive Checksum Offload Support.
...
///`read()` method returns [mac_hw_feat0::R](R) reader structure
impl crate::Readable for MAC_HW_FEAT0_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [mac_hw_feat0::W](W) writer structure
impl crate::Writable for MAC_HW_FEAT0_SPEC {
    type Writer = W;
}
///`reset()` method sets MAC_HW_FEAT0 to value 0
