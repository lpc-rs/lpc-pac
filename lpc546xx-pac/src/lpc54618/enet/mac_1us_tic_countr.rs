///Register `MAC_1US_TIC_COUNTR` reader
...
///Register `MAC_1US_TIC_COUNTR` writer
...
///Field `TIC_1US_CNTR` reader - 1US TIC Counter The application must program this counter so that the number of clock cycles of CSR clock is 1us.
...
///Field `TIC_1US_CNTR` writer - 1US TIC Counter The application must program this counter so that the number of clock cycles of CSR clock is 1us.
...
///`read()` method returns [mac_1us_tic_countr::R](R) reader structure
impl crate::Readable for MAC_1US_TIC_COUNTR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [mac_1us_tic_countr::W](W) writer structure
impl crate::Writable for MAC_1US_TIC_COUNTR_SPEC {
    type Writer = W;
}
///`reset()` method sets MAC_1US_TIC_COUNTR to value 0
