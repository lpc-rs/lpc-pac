///Register `MAC_LPI_CTRL_STAT` reader
...
///Register `MAC_LPI_CTRL_STAT` writer
...
///Field `TLPIEN` reader - Transmit LPI Entry When this bit is set, it indicates that the MAC Transmitter has entered the LPI state because of the setting of the LPIEN bit.
...
///Field `TLPIEX` reader - Transmit LPI Exit When this bit is set, it indicates that the MAC transmitter exited the LPI state after the application cleared the LPIEN bit and the LPI TW Timer has expired.
...
///Field `RLPIEN` reader - Receive LPI Entry When this bit is set, it indicates that the MAC Receiver has received an LPI pattern and entered the LPI state.
...
///Field `RLPIEX` reader - Receive LPI Exit When this bit is set, it indicates that the MAC Receiver has stopped receiving the LPI pattern on the MII interface, exited the LPI state, and resumed the normal reception.
...
///Field `LPIEN` reader - LPI Enable When this bit is set, it instructs the MAC Transmitter to enter the LPI state.
...
///Field `LPIEN` writer - LPI Enable When this bit is set, it instructs the MAC Transmitter to enter the LPI state.
...
///Field `PLS` reader - PHY Link Status This bit indicates the link status of the PHY.
...
///Field `PLS` writer - PHY Link Status This bit indicates the link status of the PHY.
pub struct PLS_W<'a> {
    w: &'a mut W,
}
impl<'a> PLS_W<'a> {
...
///Field `LPITXA` reader - LPI Tx Automate This bit controls the behavior of the MAC when it is entering or coming out of the LPI mode on the Transmit side.
...
///Field `LPITXA` writer - LPI Tx Automate This bit controls the behavior of the MAC when it is entering or coming out of the LPI mode on the Transmit side.
...
///Field `LPIATE` reader - LPI Timer Enable This bit controls the automatic entry of the MAC Transmitter into and exit out of the LPI state.
...
///Field `LPIATE` writer - LPI Timer Enable This bit controls the automatic entry of the MAC Transmitter into and exit out of the LPI state.
...
///Field `LPITCSE` reader - LPI Tx Clock Stop Enable When this bit is set, the MAC asserts LPI Tx Clock Gating Control signal high after it enters Tx LPI mode to indicate that the Tx clock to MAC can be stopped.
...
///Field `LPITCSE` writer - LPI Tx Clock Stop Enable When this bit is set, the MAC asserts LPI Tx Clock Gating Control signal high after it enters Tx LPI mode to indicate that the Tx clock to MAC can be stopped.
...
///`read()` method returns [mac_lpi_ctrl_stat::R](R) reader structure
impl crate::Readable for MAC_LPI_CTRL_STAT_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [mac_lpi_ctrl_stat::W](W) writer structure
impl crate::Writable for MAC_LPI_CTRL_STAT_SPEC {
    type Writer = W;
}
///`reset()` method sets MAC_LPI_CTRL_STAT to value 0
