...
///Field `LCDLPBASE` reader - LCD lower panel base address.
...
///Field `LCDLPBASE` writer - LCD lower panel base address.
...
impl R {
    ///Bits 3:31 - LCD lower panel base address.
    #[inline(always)]
...
///`read()` method returns [lpbase::R](R) reader structure
impl crate::Readable for LPBASE_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [lpbase::W](W) writer structure
impl crate::Writable for LPBASE_SPEC {
    type Writer = W;
}
///`reset()` method sets LPBASE to value 0
