...
impl From<crate::R<CRSR_PAL0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CRSR_PAL0_SPEC>) -> Self {
        R(reader)
    }
}
///Register `CRSR_PAL0` writer
...
impl From<crate::W<CRSR_PAL0_SPEC>> for W {
    #[inline(always)]
...
///`read()` method returns [crsr_pal0::R](R) reader structure
impl crate::Readable for CRSR_PAL0_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [crsr_pal0::W](W) writer structure
impl crate::Writable for CRSR_PAL0_SPEC {
    type Writer = W;
}
///`reset()` method sets CRSR_PAL0 to value 0
