///Register `STATICEXTENDEDWAIT` reader
...
///Register `STATICEXTENDEDWAIT` writer
...
///Field `EXTENDEDWAIT` reader - Extended wait time out.
...
///Field `EXTENDEDWAIT` writer - Extended wait time out.
...
///`read()` method returns [staticextendedwait::R](R) reader structure
impl crate::Readable for STATICEXTENDEDWAIT_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [staticextendedwait::W](W) writer structure
impl crate::Writable for STATICEXTENDEDWAIT_SPEC {
    type Writer = W;
}
///`reset()` method sets STATICEXTENDEDWAIT to value 0
