...
///Field `TRC` reader - Active to active command period.
...
///Field `TRC` writer - Active to active command period.
pub struct TRC_W<'a> {
    w: &'a mut W,
}
impl<'a> TRC_W<'a> {
...
///`read()` method returns [dynamicrc::R](R) reader structure
impl crate::Readable for DYNAMICRC_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [dynamicrc::W](W) writer structure
impl crate::Writable for DYNAMICRC_SPEC {
    type Writer = W;
}
///`reset()` method sets DYNAMICRC to value 0x1f
