...
///Field `TDAL` reader - Data-in to active command.
...
///Field `TDAL` writer - Data-in to active command.
pub struct TDAL_W<'a> {
    w: &'a mut W,
}
impl<'a> TDAL_W<'a> {
...
///`read()` method returns [dynamicdal::R](R) reader structure
impl crate::Readable for DYNAMICDAL_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [dynamicdal::W](W) writer structure
impl crate::Writable for DYNAMICDAL_SPEC {
    type Writer = W;
}
///`reset()` method sets DYNAMICDAL to value 0x0f
