...
///Field `TX_WMARK` reader - FIFO threshold watermark level when transmitting data to card.
...
///Field `TX_WMARK` writer - FIFO threshold watermark level when transmitting data to card.
...
///Field `RX_WMARK` reader - FIFO threshold watermark level when receiving data to card.
...
///Field `RX_WMARK` writer - FIFO threshold watermark level when receiving data to card.
...
///Field `DMA_MTS` reader - Burst size of multiple transaction; should be programmed same as DW-DMA controller multiple-transaction-size SRC/DEST_MSIZE.
...
///Field `DMA_MTS` writer - Burst size of multiple transaction; should be programmed same as DW-DMA controller multiple-transaction-size SRC/DEST_MSIZE.
...
///`reset()` method sets FIFOTH to value 0x001f_0000
