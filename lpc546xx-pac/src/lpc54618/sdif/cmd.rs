...
///Field `RESPONSE_EXPECT` reader - Response expect.
...
///Field `RESPONSE_EXPECT` writer - Response expect.
...
///Field `RESPONSE_LENGTH` reader - Response length.
...
///Field `RESPONSE_LENGTH` writer - Response length.
...
///Field `CHECK_RESPONSE_CRC` reader - Check response CRC.
...
///Field `CHECK_RESPONSE_CRC` writer - Check response CRC.
...
///Field `DATA_EXPECTED` reader - Data expected.
...
///Field `DATA_EXPECTED` writer - Data expected.
...
///Field `READ_WRITE` reader - read/write.
...
///Field `READ_WRITE` writer - read/write.
...
///Field `TRANSFER_MODE` reader - Transfer mode.
...
///Field `TRANSFER_MODE` writer - Transfer mode.
...
///Field `SEND_AUTO_STOP` reader - Send auto stop.
...
///Field `SEND_AUTO_STOP` writer - Send auto stop.
...
///Field `WAIT_PRVDATA_COMPLETE` reader - Wait prvdata complete.
...
///Field `WAIT_PRVDATA_COMPLETE` writer - Wait prvdata complete.
...
///Field `STOP_ABORT_CMD` reader - Stop abort command.
...
///Field `STOP_ABORT_CMD` writer - Stop abort command.
...
///Field `SEND_INITIALIZATION` reader - Send initialization.
...
///Field `SEND_INITIALIZATION` writer - Send initialization.
...
///Field `UPDATE_CLOCK_REGISTERS_ONLY` reader - Update clock registers only.
...
///Field `UPDATE_CLOCK_REGISTERS_ONLY` writer - Update clock registers only.
...
///Field `READ_CEATA_DEVICE` reader - Read ceata device.
...
///Field `READ_CEATA_DEVICE` writer - Read ceata device.
...
///Field `CCS_EXPECTED` reader - CCS expected.
...
///Field `CCS_EXPECTED` writer - CCS expected.
...
///Field `ENABLE_BOOT` reader - Enable Boot - this bit should be set only for mandatory boot mode.
...
///Field `ENABLE_BOOT` writer - Enable Boot - this bit should be set only for mandatory boot mode.
...
///Field `EXPECT_BOOT_ACK` reader - Expect Boot Acknowledge.
...
///Field `EXPECT_BOOT_ACK` writer - Expect Boot Acknowledge.
...
///Field `DISABLE_BOOT` reader - Disable Boot.
...
///Field `DISABLE_BOOT` writer - Disable Boot.
...
///Field `VOLT_SWITCH` reader - Voltage switch bit.
...
///Field `VOLT_SWITCH` writer - Voltage switch bit.
...
///Field `USE_HOLD_REG` reader - Use Hold Register.
...
///Field `USE_HOLD_REG` writer - Use Hold Register.
...
///Field `START_CMD` reader - Start command.
...
///Field `START_CMD` writer - Start command.
