...
///Field `FBE` reader - Fatal Bus Error Interrupt.
...
///Field `FBE` writer - Fatal Bus Error Interrupt.
pub struct FBE_W<'a> {
    w: &'a mut W,
}
impl<'a> FBE_W<'a> {
...
///Field `CES` reader - Card Error Summary.
...
///Field `CES` writer - Card Error Summary.
pub struct CES_W<'a> {
    w: &'a mut W,
}
impl<'a> CES_W<'a> {
...
///Field `FSM` reader - DMAC state machine present state.
...
///Field `FSM` writer - DMAC state machine present state.
pub struct FSM_W<'a> {
    w: &'a mut W,
}
impl<'a> FSM_W<'a> {
