...
///Field `CARDRDTHREN` reader - Card Read Threshold Enable.
...
///Field `CARDRDTHREN` writer - Card Read Threshold Enable.
...
///Field `BSYCLRINTEN` reader - Busy Clear Interrupt Enable.
...
///Field `BSYCLRINTEN` writer - Busy Clear Interrupt Enable.
...
///Field `CARDTHRESHOLD` reader - Card Threshold size.
...
///Field `CARDTHRESHOLD` writer - Card Threshold size.
