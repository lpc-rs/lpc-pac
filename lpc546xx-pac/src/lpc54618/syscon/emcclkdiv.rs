...
impl From<crate::R<EMCCLKDIV_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<EMCCLKDIV_SPEC>) -> Self {
        R(reader)
    }
}
///Register `EMCCLKDIV` writer
...
impl From<crate::W<EMCCLKDIV_SPEC>> for W {
    #[inline(always)]
...
///`read()` method returns [emcclkdiv::R](R) reader structure
impl crate::Readable for EMCCLKDIV_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [emcclkdiv::W](W) writer structure
impl crate::Writable for EMCCLKDIV_SPEC {
    type Writer = W;
}
///`reset()` method sets EMCCLKDIV to value 0x4000_0000
