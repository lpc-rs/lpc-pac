...
///`read()` method returns [sctclkdiv::R](R) reader structure
impl crate::Readable for SCTCLKDIV_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [sctclkdiv::W](W) writer structure
impl crate::Writable for SCTCLKDIV_SPEC {
    type Writer = W;
}
///`reset()` method sets SCTCLKDIV to value 0x4000_0000
