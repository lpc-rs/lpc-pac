...
///Field `PINT4` reader - GPIO pin interrupt 4 wake-up.
...
///Field `PINT4` writer - GPIO pin interrupt 4 wake-up.
...
///Field `PINT5` reader - GPIO pin interrupt 5 wake-up.
...
///Field `PINT5` writer - GPIO pin interrupt 5 wake-up.
...
///Field `PINT6` reader - GPIO pin interrupt 6 wake-up.
...
///Field `PINT6` writer - GPIO pin interrupt 6 wake-up.
...
///Field `PINT7` reader - GPIO pin interrupt 7 wake-up.
...
///Field `PINT7` writer - GPIO pin interrupt 7 wake-up.
...
///Field `CTIMER2` reader - Standard counter/timer CTIMER2 wake-up.
...
///Field `CTIMER2` writer - Standard counter/timer CTIMER2 wake-up.
...
///Field `CTIMER4` reader - Standard counter/timer CTIMER4 wake-up.
...
///Field `CTIMER4` writer - Standard counter/timer CTIMER4 wake-up.
...
///Field `SPIFI` reader - SPIFI interrupt wake-up. 0 = Wake-up disabled. 1 = Wake-up enabled.
...
///Field `SPIFI` writer - SPIFI interrupt wake-up. 0 = Wake-up disabled. 1 = Wake-up enabled.
...
///Field `FLEXCOMM8` reader - Flexcomm Interface 8 wake-up.
...
///Field `FLEXCOMM8` writer - Flexcomm Interface 8 wake-up.
...
///Field `FLEXCOMM9` reader - Flexcomm Interface 9 wake-up.
...
///Field `FLEXCOMM9` writer - Flexcomm Interface 9 wake-up.
...
///Field `USB1` reader - USB 1 wake-up.
...
///Field `USB1` writer - USB 1 wake-up.
pub struct USB1_W<'a> {
    w: &'a mut W,
}
impl<'a> USB1_W<'a> {
...
///Field `USB1_ACT` reader - USB 1 activity wake-up.
...
///Field `USB1_ACT` writer - USB 1 activity wake-up.
...
///Field `ENET_INT1` reader - Ethernet.
...
///Field `ENET_INT1` writer - Ethernet.
...
///Field `ENET_INT2` reader - Ethernet.
...
///Field `ENET_INT2` writer - Ethernet.
...
///Field `ENET_INT0` reader - Ethernet.
...
///Field `ENET_INT0` writer - Ethernet.
...
///Field `SMARTCARD0` reader - Smart card 0 wake-up.
...
///Field `SMARTCARD0` writer - Smart card 0 wake-up.
...
///Field `SMARTCARD1` reader - Smart card 1 wake-up.
...
///Field `SMARTCARD1` writer - Smart card 1 wake-up.
...
///`read()` method returns [starter1::R](R) reader structure
impl crate::Readable for STARTER1_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [starter1::W](W) writer structure
impl crate::Writable for STARTER1_SPEC {
    type Writer = W;
}
///`reset()` method sets STARTER1 to value 0
