...
///`read()` method returns [adcclkdiv::R](R) reader structure
impl crate::Readable for ADCCLKDIV_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [adcclkdiv::W](W) writer structure
impl crate::Writable for ADCCLKDIV_SPEC {
    type Writer = W;
}
///`reset()` method sets ADCCLKDIV to value 0x4000_0000
