...
///Field `SEL` reader - ADC clock source selection
...
///Field `SEL` writer - ADC clock source selection
pub struct SEL_W<'a> {
    w: &'a mut W,
}
impl<'a> SEL_W<'a> {
...
///`read()` method returns [adcclksel::R](R) reader structure
impl crate::Readable for ADCCLKSEL_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [adcclksel::W](W) writer structure
impl crate::Writable for ADCCLKSEL_SPEC {
    type Writer = W;
}
///`reset()` method sets ADCCLKSEL to value 0x07
