///Register `FROHFCLKDIV` reader
pub struct R(crate::R<FROHFCLKDIV_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<FROHFCLKDIV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<FROHFCLKDIV_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<FROHFCLKDIV_SPEC>) -> Self {
        R(reader)
    }
}
///Register `FROHFCLKDIV` writer
pub struct W(crate::W<FROHFCLKDIV_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<FROHFCLKDIV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<FROHFCLKDIV_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<FROHFCLKDIV_SPEC>) -> Self {
        W(writer)
    }
}
...
///
///For information about available fields see [frohfclkdiv](index.html) module
pub struct FROHFCLKDIV_SPEC;
impl crate::RegisterSpec for FROHFCLKDIV_SPEC {
    type Ux = u32;
}
///`read()` method returns [frohfclkdiv::R](R) reader structure
impl crate::Readable for FROHFCLKDIV_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [frohfclkdiv::W](W) writer structure
impl crate::Writable for FROHFCLKDIV_SPEC {
    type Writer = W;
}
///`reset()` method sets FROHFCLKDIV to value 0x4000_0000
impl crate::Resettable for FROHFCLKDIV_SPEC {
    #[inline(always)]
