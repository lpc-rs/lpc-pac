...
///`read()` method returns [spificlksel::R](R) reader structure
impl crate::Readable for SPIFICLKSEL_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [spificlksel::W](W) writer structure
impl crate::Writable for SPIFICLKSEL_SPEC {
    type Writer = W;
}
///`reset()` method sets SPIFICLKSEL to value 0x07
