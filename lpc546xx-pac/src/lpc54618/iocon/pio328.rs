...
///`read()` method returns [pio328::R](R) reader structure
impl crate::Readable for PIO328_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio328::W](W) writer structure
impl crate::Writable for PIO328_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO328 to value 0x0320
