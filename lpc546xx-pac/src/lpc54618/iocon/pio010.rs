...
///`read()` method returns [pio010::R](R) reader structure
impl crate::Readable for PIO010_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio010::W](W) writer structure
impl crate::Writable for PIO010_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO010 to value 0x0320
