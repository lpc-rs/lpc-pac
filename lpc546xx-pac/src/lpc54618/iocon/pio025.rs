...
///`read()` method returns [pio025::R](R) reader structure
impl crate::Readable for PIO025_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio025::W](W) writer structure
impl crate::Writable for PIO025_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO025 to value 0x0320
