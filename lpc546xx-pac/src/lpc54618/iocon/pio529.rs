...
///`read()` method returns [pio529::R](R) reader structure
impl crate::Readable for PIO529_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio529::W](W) writer structure
impl crate::Writable for PIO529_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO529 to value 0x0320
