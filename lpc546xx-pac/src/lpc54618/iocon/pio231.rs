...
///`read()` method returns [pio231::R](R) reader structure
impl crate::Readable for PIO231_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio231::W](W) writer structure
impl crate::Writable for PIO231_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO231 to value 0x0320
