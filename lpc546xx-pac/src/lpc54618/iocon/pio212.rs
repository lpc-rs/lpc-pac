...
///`read()` method returns [pio212::R](R) reader structure
impl crate::Readable for PIO212_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio212::W](W) writer structure
impl crate::Writable for PIO212_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO212 to value 0x0320
