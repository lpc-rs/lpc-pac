...
///`read()` method returns [pio217::R](R) reader structure
impl crate::Readable for PIO217_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio217::W](W) writer structure
impl crate::Writable for PIO217_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO217 to value 0x0320
