...
///`read()` method returns [pio24::R](R) reader structure
impl crate::Readable for PIO24_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio24::W](W) writer structure
impl crate::Writable for PIO24_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO24 to value 0x0320
