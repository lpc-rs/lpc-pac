...
///`read()` method returns [pio521::R](R) reader structure
impl crate::Readable for PIO521_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio521::W](W) writer structure
impl crate::Writable for PIO521_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO521 to value 0x0320
