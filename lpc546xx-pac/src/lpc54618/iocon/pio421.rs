...
///`read()` method returns [pio421::R](R) reader structure
impl crate::Readable for PIO421_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio421::W](W) writer structure
impl crate::Writable for PIO421_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO421 to value 0x0320
