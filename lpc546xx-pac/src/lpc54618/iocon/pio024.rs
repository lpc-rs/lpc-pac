...
///`read()` method returns [pio024::R](R) reader structure
impl crate::Readable for PIO024_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio024::W](W) writer structure
impl crate::Writable for PIO024_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO024 to value 0x0320
