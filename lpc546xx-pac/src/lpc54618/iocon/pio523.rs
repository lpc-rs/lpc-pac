...
///`read()` method returns [pio523::R](R) reader structure
impl crate::Readable for PIO523_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio523::W](W) writer structure
impl crate::Writable for PIO523_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO523 to value 0x0320
