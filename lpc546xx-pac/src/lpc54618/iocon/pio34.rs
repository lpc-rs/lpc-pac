...
///`read()` method returns [pio34::R](R) reader structure
impl crate::Readable for PIO34_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio34::W](W) writer structure
impl crate::Writable for PIO34_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO34 to value 0x0320
