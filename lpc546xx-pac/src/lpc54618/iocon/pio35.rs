...
///`read()` method returns [pio35::R](R) reader structure
impl crate::Readable for PIO35_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio35::W](W) writer structure
impl crate::Writable for PIO35_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO35 to value 0x0320
