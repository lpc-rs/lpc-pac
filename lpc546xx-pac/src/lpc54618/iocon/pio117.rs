...
///`read()` method returns [pio117::R](R) reader structure
impl crate::Readable for PIO117_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio117::W](W) writer structure
impl crate::Writable for PIO117_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO117 to value 0x0320
