...
///`read()` method returns [pio522::R](R) reader structure
impl crate::Readable for PIO522_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio522::W](W) writer structure
impl crate::Writable for PIO522_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO522 to value 0x0320
