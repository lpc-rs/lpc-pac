...
///`read()` method returns [pio017::R](R) reader structure
impl crate::Readable for PIO017_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio017::W](W) writer structure
impl crate::Writable for PIO017_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO017 to value 0x0320
