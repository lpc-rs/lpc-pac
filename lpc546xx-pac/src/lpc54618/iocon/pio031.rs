...
///`read()` method returns [pio031::R](R) reader structure
impl crate::Readable for PIO031_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio031::W](W) writer structure
impl crate::Writable for PIO031_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO031 to value 0x0320
