...
///`read()` method returns [pio431::R](R) reader structure
impl crate::Readable for PIO431_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio431::W](W) writer structure
impl crate::Writable for PIO431_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO431 to value 0x0320
