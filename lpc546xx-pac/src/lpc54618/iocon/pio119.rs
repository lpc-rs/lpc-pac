...
///`read()` method returns [pio119::R](R) reader structure
impl crate::Readable for PIO119_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio119::W](W) writer structure
impl crate::Writable for PIO119_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO119 to value 0x0320
