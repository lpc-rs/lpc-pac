...
///`read()` method returns [pio00::R](R) reader structure
impl crate::Readable for PIO00_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio00::W](W) writer structure
impl crate::Writable for PIO00_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO00 to value 0x0320
