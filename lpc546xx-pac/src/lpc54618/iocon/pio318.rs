...
///`read()` method returns [pio318::R](R) reader structure
impl crate::Readable for PIO318_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio318::W](W) writer structure
impl crate::Writable for PIO318_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO318 to value 0x0320
