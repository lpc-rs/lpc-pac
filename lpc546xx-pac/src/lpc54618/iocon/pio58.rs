...
///`read()` method returns [pio58::R](R) reader structure
impl crate::Readable for PIO58_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio58::W](W) writer structure
impl crate::Writable for PIO58_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO58 to value 0x0320
