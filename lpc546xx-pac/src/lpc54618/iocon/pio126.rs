...
///`read()` method returns [pio126::R](R) reader structure
impl crate::Readable for PIO126_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio126::W](W) writer structure
impl crate::Writable for PIO126_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO126 to value 0x0320
