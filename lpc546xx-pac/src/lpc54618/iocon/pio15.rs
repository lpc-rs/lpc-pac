...
///`read()` method returns [pio15::R](R) reader structure
impl crate::Readable for PIO15_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio15::W](W) writer structure
impl crate::Writable for PIO15_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO15 to value 0x0320
