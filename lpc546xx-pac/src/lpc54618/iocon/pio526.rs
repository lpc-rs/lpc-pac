...
///`read()` method returns [pio526::R](R) reader structure
impl crate::Readable for PIO526_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio526::W](W) writer structure
impl crate::Writable for PIO526_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO526 to value 0x0320
