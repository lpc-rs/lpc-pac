...
///Field `CBSR` reader - ControlBulkServiceRatio.
...
///Field `CBSR` writer - ControlBulkServiceRatio.
pub struct CBSR_W<'a> {
    w: &'a mut W,
}
impl<'a> CBSR_W<'a> {
...
///Field `PLE` reader - PeriodicListEnable.
...
///Field `PLE` writer - PeriodicListEnable.
pub struct PLE_W<'a> {
    w: &'a mut W,
}
impl<'a> PLE_W<'a> {
...
///Field `IE` reader - IsochronousEnable.
...
///Field `IE` writer - IsochronousEnable.
pub struct IE_W<'a> {
    w: &'a mut W,
}
impl<'a> IE_W<'a> {
...
///Field `CLE` reader - ControlListEnable.
...
///Field `CLE` writer - ControlListEnable.
pub struct CLE_W<'a> {
    w: &'a mut W,
}
impl<'a> CLE_W<'a> {
...
///Field `BLE` reader - BulkListEnable This bit is set to enable the processing of the Bulk list in the next Frame.
...
///Field `BLE` writer - BulkListEnable This bit is set to enable the processing of the Bulk list in the next Frame.
pub struct BLE_W<'a> {
    w: &'a mut W,
}
impl<'a> BLE_W<'a> {
...
///Field `HCFS` reader - HostControllerFunctionalState for USB 00b: USBRESET 01b: USBRESUME 10b: USBOPERATIONAL 11b: USBSUSPEND A transition to USBOPERATIONAL from another state causes SOFgeneration to begin 1 ms later.
...
///Field `HCFS` writer - HostControllerFunctionalState for USB 00b: USBRESET 01b: USBRESUME 10b: USBOPERATIONAL 11b: USBSUSPEND A transition to USBOPERATIONAL from another state causes SOFgeneration to begin 1 ms later.
pub struct HCFS_W<'a> {
    w: &'a mut W,
}
impl<'a> HCFS_W<'a> {
...
///Field `IR` reader - InterruptRouting This bit determines the routing of interrupts generated by events registered in HcInterruptStatus.
...
///Field `IR` writer - InterruptRouting This bit determines the routing of interrupts generated by events registered in HcInterruptStatus.
pub struct IR_W<'a> {
    w: &'a mut W,
}
impl<'a> IR_W<'a> {
...
///Field `RWC` reader - RemoteWakeupConnected This bit indicates whether HC supports remote wake-up signaling.
...
///Field `RWC` writer - RemoteWakeupConnected This bit indicates whether HC supports remote wake-up signaling.
pub struct RWC_W<'a> {
    w: &'a mut W,
}
impl<'a> RWC_W<'a> {
...
///Field `RWE` reader - RemoteWakeupEnable This bit is used by HCD to enable or disable the remote wake-up feature upon the detection of upstream resume signaling.
...
///Field `RWE` writer - RemoteWakeupEnable This bit is used by HCD to enable or disable the remote wake-up feature upon the detection of upstream resume signaling.
pub struct RWE_W<'a> {
    w: &'a mut W,
}
impl<'a> RWE_W<'a> {
...
///`read()` method returns [hccontrol::R](R) reader structure
impl crate::Readable for HCCONTROL_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [hccontrol::W](W) writer structure
impl crate::Writable for HCCONTROL_SPEC {
    type Writer = W;
}
///`reset()` method sets HCCONTROL to value 0
