...
///Field `CH0_THRSEL` reader - Threshold select for channel 0.
...
///Field `CH0_THRSEL` writer - Threshold select for channel 0.
...
///Field `CH1_THRSEL` reader - Threshold select for channel 1. See description for channel 0.
...
///Field `CH1_THRSEL` writer - Threshold select for channel 1. See description for channel 0.
...
///Field `CH2_THRSEL` reader - Threshold select for channel 2. See description for channel 0.
...
///Field `CH2_THRSEL` writer - Threshold select for channel 2. See description for channel 0.
...
///Field `CH3_THRSEL` reader - Threshold select for channel 3. See description for channel 0.
...
///Field `CH3_THRSEL` writer - Threshold select for channel 3. See description for channel 0.
...
///Field `CH4_THRSEL` reader - Threshold select for channel 4. See description for channel 0.
...
///Field `CH4_THRSEL` writer - Threshold select for channel 4. See description for channel 0.
...
///Field `CH5_THRSEL` reader - Threshold select for channel 5. See description for channel 0.
...
///Field `CH5_THRSEL` writer - Threshold select for channel 5. See description for channel 0.
...
///Field `CH6_THRSEL` reader - Threshold select for channel 6. See description for channel 0.
...
///Field `CH6_THRSEL` writer - Threshold select for channel 6. See description for channel 0.
...
///Field `CH7_THRSEL` reader - Threshold select for channel 7. See description for channel 0.
...
///Field `CH7_THRSEL` writer - Threshold select for channel 7. See description for channel 0.
...
///Field `CH8_THRSEL` reader - Threshold select for channel 8. See description for channel 0.
...
///Field `CH8_THRSEL` writer - Threshold select for channel 8. See description for channel 0.
...
///Field `CH9_THRSEL` reader - Threshold select for channel 9. See description for channel 0.
...
///Field `CH9_THRSEL` writer - Threshold select for channel 9. See description for channel 0.
...
///Field `CH10_THRSEL` reader - Threshold select for channel 10. See description for channel 0.
...
///Field `CH10_THRSEL` writer - Threshold select for channel 10. See description for channel 0.
...
///Field `CH11_THRSEL` reader - Threshold select for channel 11. See description for channel 0.
...
///Field `CH11_THRSEL` writer - Threshold select for channel 11. See description for channel 0.
...
///`read()` method returns [chan_thrsel::R](R) reader structure
impl crate::Readable for CHAN_THRSEL_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [chan_thrsel::W](W) writer structure
impl crate::Writable for CHAN_THRSEL_SPEC {
    type Writer = W;
}
///`reset()` method sets CHAN_THRSEL to value 0
