///Register `CAPLENGTH_CHIPID` reader
...
///Field `CAPLENGTH` reader - Capability Length: This is used as an offset.
...
///Field `CHIPID` reader - Chip identification: indicates major and minor revision of the IP: \[31:24\]
...
impl R {
    ...
    ///Bits 16:31 - Chip identification: indicates major and minor revision of the IP: \[31:24\]
    ///= Major revision \[23:16\]
    ///= Minor revision Major revisions used: 0x01: USB2.
    #[inline(always)]
...
///`read()` method returns [caplength_chipid::R](R) reader structure
impl crate::Readable for CAPLENGTH_CHIPID_SPEC {
    type Reader = R;
}
///`reset()` method sets CAPLENGTH_CHIPID to value 0x0101_0010
