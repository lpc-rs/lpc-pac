...
///Field `FLADJ` reader - Frame Length Timing Value.
...
///Field `FLADJ` writer - Frame Length Timing Value.
...
///Field `FRINDEX` reader - Frame Index: Bits 29 to16 in this register are used for the frame number field in the SOF packet.
...
///Field `FRINDEX` writer - Frame Index: Bits 29 to16 in this register are used for the frame number field in the SOF packet.
...
///`read()` method returns [fladj_frindex::R](R) reader structure
impl crate::Readable for FLADJ_FRINDEX_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [fladj_frindex::W](W) writer structure
impl crate::Writable for FLADJ_FRINDEX_SPEC {
    type Writer = W;
}
///`reset()` method sets FLADJ_FRINDEX to value 0x20
