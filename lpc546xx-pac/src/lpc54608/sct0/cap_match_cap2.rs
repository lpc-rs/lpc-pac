...
///`read()` method returns [cap_match_cap2::R](R) reader structure
impl crate::Readable for CAP_MATCH_CAP2_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [cap_match_cap2::W](W) writer structure
impl crate::Writable for CAP_MATCH_CAP2_SPEC {
    type Writer = W;
}
///`reset()` method sets CAP2 to value 0
