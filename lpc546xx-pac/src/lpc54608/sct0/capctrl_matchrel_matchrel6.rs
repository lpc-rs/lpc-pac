///Register `MATCHREL6` reader
pub struct R(crate::R<CAPCTRL_MATCHREL_MATCHREL6_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CAPCTRL_MATCHREL_MATCHREL6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CAPCTRL_MATCHREL_MATCHREL6_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CAPCTRL_MATCHREL_MATCHREL6_SPEC>) -> Self {
        R(reader)
    }
}
///Register `MATCHREL6` writer
pub struct W(crate::W<CAPCTRL_MATCHREL_MATCHREL6_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CAPCTRL_MATCHREL_MATCHREL6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CAPCTRL_MATCHREL_MATCHREL6_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CAPCTRL_MATCHREL_MATCHREL6_SPEC>) -> Self {
        W(writer)
    }
}
...
///
///For information about available fields see [capctrl_matchrel_matchrel6](index.html) module
pub struct CAPCTRL_MATCHREL_MATCHREL6_SPEC;
impl crate::RegisterSpec for CAPCTRL_MATCHREL_MATCHREL6_SPEC {
    type Ux = u32;
}
///`read()` method returns [capctrl_matchrel_matchrel6::R](R) reader structure
impl crate::Readable for CAPCTRL_MATCHREL_MATCHREL6_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [capctrl_matchrel_matchrel6::W](W) writer structure
impl crate::Writable for CAPCTRL_MATCHREL_MATCHREL6_SPEC {
    type Writer = W;
}
///`reset()` method sets MATCHREL6 to value 0
impl crate::Resettable for CAPCTRL_MATCHREL_MATCHREL6_SPEC {
    #[inline(always)]
