...
///`read()` method returns [capctrl_matchrel_capctrl8::R](R) reader structure
impl crate::Readable for CAPCTRL_MATCHREL_CAPCTRL8_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [capctrl_matchrel_capctrl8::W](W) writer structure
impl crate::Writable for CAPCTRL_MATCHREL_CAPCTRL8_SPEC {
    type Writer = W;
}
///`reset()` method sets CAPCTRL8 to value 0
