...
///Field `WRITE_PROTECT` reader - Write protect.
...
///Field `WRITE_PROTECT` writer - Write protect.
...
///`write(|w| ..)` method takes [wrtprt::W](W) writer structure
