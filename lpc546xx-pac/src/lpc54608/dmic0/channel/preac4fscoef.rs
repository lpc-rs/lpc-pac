...
///Field `COMP` reader - Pre-emphasis filer coefficient for 4 FS mode. 0 = Compensation = 0 1 = Compensation = 16 2 = Compensation = 15 3 = Compensation = 13
...
///Field `COMP` writer - Pre-emphasis filer coefficient for 4 FS mode. 0 = Compensation = 0 1 = Compensation = 16 2 = Compensation = 15 3 = Compensation = 13
pub struct COMP_W<'a> {
    w: &'a mut W,
}
impl<'a> COMP_W<'a> {
...
///`read()` method returns [preac4fscoef::R](R) reader structure
impl crate::Readable for PREAC4FSCOEF_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [preac4fscoef::W](W) writer structure
impl crate::Writable for PREAC4FSCOEF_SPEC {
    type Writer = W;
}
///`reset()` method sets PREAC4FSCOEF to value 0
