...
///`read()` method returns [audpllmdec::R](R) reader structure
impl crate::Readable for AUDPLLMDEC_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [audpllmdec::W](W) writer structure
impl crate::Writable for AUDPLLMDEC_SPEC {
    type Writer = W;
}
///`reset()` method sets AUDPLLMDEC to value 0
