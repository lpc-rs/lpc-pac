...
///Field `DEV_NEED_CLKST` reader - USB1 Device USB1_NEEDCLK signal status.
...
///Field `DEV_NEED_CLKST` writer - USB1 Device USB1_NEEDCLK signal status.
...
///Field `HOST_NEED_CLKST` reader - USB1 Device host USB1_NEEDCLK signal status.
...
///Field `HOST_NEED_CLKST` writer - USB1 Device host USB1_NEEDCLK signal status.
...
///`read()` method returns [usb1clkstat::R](R) reader structure
impl crate::Readable for USB1CLKSTAT_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [usb1clkstat::W](W) writer structure
impl crate::Writable for USB1CLKSTAT_SPEC {
    type Writer = W;
}
///`reset()` method sets USB1CLKSTAT to value 0
