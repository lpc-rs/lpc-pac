...
impl From<crate::R<AUDPLLNDEC_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<AUDPLLNDEC_SPEC>) -> Self {
        R(reader)
    }
}
///Register `AUDPLLNDEC` writer
...
impl From<crate::W<AUDPLLNDEC_SPEC>> for W {
    #[inline(always)]
...
///`read()` method returns [audpllndec::R](R) reader structure
impl crate::Readable for AUDPLLNDEC_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [audpllndec::W](W) writer structure
impl crate::Writable for AUDPLLNDEC_SPEC {
    type Writer = W;
}
///`reset()` method sets AUDPLLNDEC to value 0
