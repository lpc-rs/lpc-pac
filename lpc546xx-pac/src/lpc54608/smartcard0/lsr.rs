...
///Field `RDR` reader - Receiver Data Ready.
...
///Field `THRE` reader - Transmitter Holding Register Empty.
...
///Field `TEMT` reader - Transmitter Empty.
...
///Field `RXFE` reader - Error in RX FIFO.
