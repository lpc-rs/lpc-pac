...
///`read()` method returns [pio16::R](R) reader structure
impl crate::Readable for PIO16_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio16::W](W) writer structure
impl crate::Writable for PIO16_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO16 to value 0x0320
