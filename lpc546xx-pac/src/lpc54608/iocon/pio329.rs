...
///`read()` method returns [pio329::R](R) reader structure
impl crate::Readable for PIO329_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio329::W](W) writer structure
impl crate::Writable for PIO329_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO329 to value 0x0320
