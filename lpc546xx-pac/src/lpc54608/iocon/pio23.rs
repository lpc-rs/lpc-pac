...
///`read()` method returns [pio23::R](R) reader structure
impl crate::Readable for PIO23_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio23::W](W) writer structure
impl crate::Writable for PIO23_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO23 to value 0x0320
