...
///`read()` method returns [pio36::R](R) reader structure
impl crate::Readable for PIO36_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio36::W](W) writer structure
impl crate::Writable for PIO36_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO36 to value 0x0320
