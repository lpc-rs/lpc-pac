...
///`read()` method returns [pio26::R](R) reader structure
impl crate::Readable for PIO26_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio26::W](W) writer structure
impl crate::Writable for PIO26_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO26 to value 0x0320
