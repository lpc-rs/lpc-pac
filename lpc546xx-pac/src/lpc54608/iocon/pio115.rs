...
///`read()` method returns [pio115::R](R) reader structure
impl crate::Readable for PIO115_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio115::W](W) writer structure
impl crate::Writable for PIO115_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO115 to value 0x0320
