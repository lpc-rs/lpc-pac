...
///`read()` method returns [pio38::R](R) reader structure
impl crate::Readable for PIO38_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio38::W](W) writer structure
impl crate::Writable for PIO38_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO38 to value 0x0320
