...
///`read()` method returns [pio221::R](R) reader structure
impl crate::Readable for PIO221_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio221::W](W) writer structure
impl crate::Writable for PIO221_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO221 to value 0x0320
