...
///`read()` method returns [pio423::R](R) reader structure
impl crate::Readable for PIO423_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio423::W](W) writer structure
impl crate::Writable for PIO423_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO423 to value 0x0320
