...
///`read()` method returns [pio011::R](R) reader structure
impl crate::Readable for PIO011_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio011::W](W) writer structure
impl crate::Writable for PIO011_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO011 to value 0x0326
