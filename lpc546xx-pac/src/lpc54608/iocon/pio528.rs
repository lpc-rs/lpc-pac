...
///`read()` method returns [pio528::R](R) reader structure
impl crate::Readable for PIO528_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio528::W](W) writer structure
impl crate::Writable for PIO528_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO528 to value 0x0320
