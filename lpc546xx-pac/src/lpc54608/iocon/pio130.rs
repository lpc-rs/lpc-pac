...
///`read()` method returns [pio130::R](R) reader structure
impl crate::Readable for PIO130_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio130::W](W) writer structure
impl crate::Writable for PIO130_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO130 to value 0x0320
