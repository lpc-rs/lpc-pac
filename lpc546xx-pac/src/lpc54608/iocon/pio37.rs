...
///`read()` method returns [pio37::R](R) reader structure
impl crate::Readable for PIO37_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio37::W](W) writer structure
impl crate::Writable for PIO37_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO37 to value 0x0320
