...
///`read()` method returns [pio227::R](R) reader structure
impl crate::Readable for PIO227_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio227::W](W) writer structure
impl crate::Writable for PIO227_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO227 to value 0x0320
