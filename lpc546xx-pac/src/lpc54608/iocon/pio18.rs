...
///`read()` method returns [pio18::R](R) reader structure
impl crate::Readable for PIO18_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio18::W](W) writer structure
impl crate::Writable for PIO18_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO18 to value 0x0320
