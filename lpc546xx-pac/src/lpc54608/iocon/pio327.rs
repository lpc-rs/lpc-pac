...
///`read()` method returns [pio327::R](R) reader structure
impl crate::Readable for PIO327_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio327::W](W) writer structure
impl crate::Writable for PIO327_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO327 to value 0x0320
