...
///`read()` method returns [pio11::R](R) reader structure
impl crate::Readable for PIO11_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio11::W](W) writer structure
impl crate::Writable for PIO11_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO11 to value 0x0320
