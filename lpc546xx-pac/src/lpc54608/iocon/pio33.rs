...
///`read()` method returns [pio33::R](R) reader structure
impl crate::Readable for PIO33_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio33::W](W) writer structure
impl crate::Writable for PIO33_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO33 to value 0x0320
