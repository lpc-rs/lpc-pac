...
///`read()` method returns [pio228::R](R) reader structure
impl crate::Readable for PIO228_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio228::W](W) writer structure
impl crate::Writable for PIO228_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO228 to value 0x0320
