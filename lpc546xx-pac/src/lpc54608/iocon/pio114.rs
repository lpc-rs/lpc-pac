...
///`read()` method returns [pio114::R](R) reader structure
impl crate::Readable for PIO114_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio114::W](W) writer structure
impl crate::Writable for PIO114_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO114 to value 0x0320
