...
///`read()` method returns [pio322::R](R) reader structure
impl crate::Readable for PIO322_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio322::W](W) writer structure
impl crate::Writable for PIO322_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO322 to value 0x0320
