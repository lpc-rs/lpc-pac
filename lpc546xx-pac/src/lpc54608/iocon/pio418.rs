...
///`read()` method returns [pio418::R](R) reader structure
impl crate::Readable for PIO418_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio418::W](W) writer structure
impl crate::Writable for PIO418_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO418 to value 0x0320
