...
///`read()` method returns [pio314::R](R) reader structure
impl crate::Readable for PIO314_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio314::W](W) writer structure
impl crate::Writable for PIO314_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO314 to value 0x0320
