...
///`read()` method returns [pio512::R](R) reader structure
impl crate::Readable for PIO512_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio512::W](W) writer structure
impl crate::Writable for PIO512_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO512 to value 0x0320
