...
///`read()` method returns [pio08::R](R) reader structure
impl crate::Readable for PIO08_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio08::W](W) writer structure
impl crate::Writable for PIO08_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO08 to value 0x0320
