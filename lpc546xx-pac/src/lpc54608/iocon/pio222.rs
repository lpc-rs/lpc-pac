...
///`read()` method returns [pio222::R](R) reader structure
impl crate::Readable for PIO222_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio222::W](W) writer structure
impl crate::Writable for PIO222_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO222 to value 0x0320
