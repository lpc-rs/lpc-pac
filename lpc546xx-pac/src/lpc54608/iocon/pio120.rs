...
///`read()` method returns [pio120::R](R) reader structure
impl crate::Readable for PIO120_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio120::W](W) writer structure
impl crate::Writable for PIO120_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO120 to value 0x0320
