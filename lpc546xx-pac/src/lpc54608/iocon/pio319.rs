...
///`read()` method returns [pio319::R](R) reader structure
impl crate::Readable for PIO319_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio319::W](W) writer structure
impl crate::Writable for PIO319_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO319 to value 0x0320
