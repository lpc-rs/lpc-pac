...
///`read()` method returns [pio417::R](R) reader structure
impl crate::Readable for PIO417_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio417::W](W) writer structure
impl crate::Writable for PIO417_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO417 to value 0x0320
