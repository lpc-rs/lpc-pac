...
///Field `SRC0` reader - Selects the input source for bit slice 0
...
#[repr(u8)]
pub enum SRC1_A {
    ///0: Input 0. Selects the pin selected in the PINTSEL0 register as the source to bit slice 1.
    INPUT0 = 0,
    ///1: Input 1. Selects the pin selected in the PINTSEL1 register as the source to bit slice 1.
    INPUT1 = 1,
    ///2: Input 2. Selects the pin selected in the PINTSEL2 register as the source to bit slice 1.
    INPUT2 = 2,
    ///3: Input 3. Selects the pin selected in the PINTSEL3 register as the source to bit slice 1.
    INPUT3 = 3,
    ///4: Input 4. Selects the pin selected in the PINTSEL4 register as the source to bit slice 1.
    INPUT4 = 4,
    ///5: Input 5. Selects the pin selected in the PINTSEL5 register as the source to bit slice 1.
    INPUT5 = 5,
    ///6: Input 6. Selects the pin selected in the PINTSEL6 register as the source to bit slice 1.
    INPUT6 = 6,
    ///7: Input 7. Selects the pin selected in the PINTSEL7 register as the source to bit slice 1.
    INPUT7 = 7,
}
...
///Field `SRC1` reader - Selects the input source for bit slice 1
...
///Field `SRC1` writer - Selects the input source for bit slice 1
pub struct SRC1_W<'a> {
    w: &'a mut W,
}
impl<'a> SRC1_W<'a> {
...
#[repr(u8)]
pub enum SRC2_A {
    ///0: Input 0. Selects the pin selected in the PINTSEL0 register as the source to bit slice 2.
    INPUT0 = 0,
    ///1: Input 1. Selects the pin selected in the PINTSEL1 register as the source to bit slice 2.
    INPUT1 = 1,
    ///2: Input 2. Selects the pin selected in the PINTSEL2 register as the source to bit slice 2.
    INPUT2 = 2,
    ///3: Input 3. Selects the pin selected in the PINTSEL3 register as the source to bit slice 2.
    INPUT3 = 3,
    ///4: Input 4. Selects the pin selected in the PINTSEL4 register as the source to bit slice 2.
    INPUT4 = 4,
    ///5: Input 5. Selects the pin selected in the PINTSEL5 register as the source to bit slice 2.
    INPUT5 = 5,
    ///6: Input 6. Selects the pin selected in the PINTSEL6 register as the source to bit slice 2.
    INPUT6 = 6,
    ///7: Input 7. Selects the pin selected in the PINTSEL7 register as the source to bit slice 2.
    INPUT7 = 7,
}
...
///Field `SRC2` reader - Selects the input source for bit slice 2
...
///Field `SRC2` writer - Selects the input source for bit slice 2
pub struct SRC2_W<'a> {
    w: &'a mut W,
}
impl<'a> SRC2_W<'a> {
...
#[repr(u8)]
pub enum SRC3_A {
    ///0: Input 0. Selects the pin selected in the PINTSEL0 register as the source to bit slice 3.
    INPUT0 = 0,
    ///1: Input 1. Selects the pin selected in the PINTSEL1 register as the source to bit slice 3.
    INPUT1 = 1,
    ///2: Input 2. Selects the pin selected in the PINTSEL2 register as the source to bit slice 3.
    INPUT2 = 2,
    ///3: Input 3. Selects the pin selected in the PINTSEL3 register as the source to bit slice 3.
    INPUT3 = 3,
    ///4: Input 4. Selects the pin selected in the PINTSEL4 register as the source to bit slice 3.
    INPUT4 = 4,
    ///5: Input 5. Selects the pin selected in the PINTSEL5 register as the source to bit slice 3.
    INPUT5 = 5,
    ///6: Input 6. Selects the pin selected in the PINTSEL6 register as the source to bit slice 3.
    INPUT6 = 6,
    ///7: Input 7. Selects the pin selected in the PINTSEL7 register as the source to bit slice 3.
    INPUT7 = 7,
}
...
///Field `SRC3` reader - Selects the input source for bit slice 3
...
#[repr(u8)]
pub enum SRC4_A {
    ///0: Input 0. Selects the pin selected in the PINTSEL0 register as the source to bit slice 4.
    INPUT0 = 0,
    ///1: Input 1. Selects the pin selected in the PINTSEL1 register as the source to bit slice 4.
    INPUT1 = 1,
    ///2: Input 2. Selects the pin selected in the PINTSEL2 register as the source to bit slice 4.
    INPUT2 = 2,
    ///3: Input 3. Selects the pin selected in the PINTSEL3 register as the source to bit slice 4.
    INPUT3 = 3,
    ///4: Input 4. Selects the pin selected in the PINTSEL4 register as the source to bit slice 4.
    INPUT4 = 4,
    ///5: Input 5. Selects the pin selected in the PINTSEL5 register as the source to bit slice 4.
    INPUT5 = 5,
    ///6: Input 6. Selects the pin selected in the PINTSEL6 register as the source to bit slice 4.
    INPUT6 = 6,
    ///7: Input 7. Selects the pin selected in the PINTSEL7 register as the source to bit slice 4.
    INPUT7 = 7,
}
...
///Field `SRC4` reader - Selects the input source for bit slice 4
...
///Field `SRC4` writer - Selects the input source for bit slice 4
pub struct SRC4_W<'a> {
    w: &'a mut W,
}
impl<'a> SRC4_W<'a> {
...
#[repr(u8)]
pub enum SRC5_A {
    ///0: Input 0. Selects the pin selected in the PINTSEL0 register as the source to bit slice 5.
    INPUT0 = 0,
    ///1: Input 1. Selects the pin selected in the PINTSEL1 register as the source to bit slice 5.
    INPUT1 = 1,
    ///2: Input 2. Selects the pin selected in the PINTSEL2 register as the source to bit slice 5.
    INPUT2 = 2,
    ///3: Input 3. Selects the pin selected in the PINTSEL3 register as the source to bit slice 5.
    INPUT3 = 3,
    ///4: Input 4. Selects the pin selected in the PINTSEL4 register as the source to bit slice 5.
    INPUT4 = 4,
    ///5: Input 5. Selects the pin selected in the PINTSEL5 register as the source to bit slice 5.
    INPUT5 = 5,
    ///6: Input 6. Selects the pin selected in the PINTSEL6 register as the source to bit slice 5.
    INPUT6 = 6,
    ///7: Input 7. Selects the pin selected in the PINTSEL7 register as the source to bit slice 5.
    INPUT7 = 7,
}
...
///Field `SRC5` reader - Selects the input source for bit slice 5
...
///Field `SRC5` writer - Selects the input source for bit slice 5
pub struct SRC5_W<'a> {
    w: &'a mut W,
}
impl<'a> SRC5_W<'a> {
...
#[repr(u8)]
pub enum SRC6_A {
    ///0: Input 0. Selects the pin selected in the PINTSEL0 register as the source to bit slice 6.
    INPUT0 = 0,
    ///1: Input 1. Selects the pin selected in the PINTSEL1 register as the source to bit slice 6.
    INPUT1 = 1,
    ///2: Input 2. Selects the pin selected in the PINTSEL2 register as the source to bit slice 6.
    INPUT2 = 2,
    ///3: Input 3. Selects the pin selected in the PINTSEL3 register as the source to bit slice 6.
    INPUT3 = 3,
    ///4: Input 4. Selects the pin selected in the PINTSEL4 register as the source to bit slice 6.
    INPUT4 = 4,
    ///5: Input 5. Selects the pin selected in the PINTSEL5 register as the source to bit slice 6.
    INPUT5 = 5,
    ///6: Input 6. Selects the pin selected in the PINTSEL6 register as the source to bit slice 6.
    INPUT6 = 6,
    ///7: Input 7. Selects the pin selected in the PINTSEL7 register as the source to bit slice 6.
    INPUT7 = 7,
}
...
///Field `SRC6` reader - Selects the input source for bit slice 6
...
///Field `SRC6` writer - Selects the input source for bit slice 6
pub struct SRC6_W<'a> {
    w: &'a mut W,
}
impl<'a> SRC6_W<'a> {
...
///Field `SRC7` reader - Selects the input source for bit slice 7
...
///Field `SRC7` writer - Selects the input source for bit slice 7
pub struct SRC7_W<'a> {
    w: &'a mut W,
}
impl<'a> SRC7_W<'a> {
...
///`read()` method returns [pmsrc::R](R) reader structure
impl crate::Readable for PMSRC_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pmsrc::W](W) writer structure
impl crate::Writable for PMSRC_SPEC {
    type Writer = W;
}
///`reset()` method sets PMSRC to value 0
