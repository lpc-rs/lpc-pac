...
pub mod txefa;
#[doc = "MRBA register accessor: an alias for `Reg<MRBA_SPEC>`"]
pub type MRBA = crate::Reg<mrba::MRBA_SPEC>;
#[doc = "CAN Message RAM Base Address"]
pub mod mrba;
#[doc = "ETSCC register accessor: an alias for `Reg<ETSCC_SPEC>`"]
pub type ETSCC = crate::Reg<etscc::ETSCC_SPEC>;
#[doc = "External Timestamp Counter Configuration"]
pub mod etscc;
#[doc = "ETSCV register accessor: an alias for `Reg<ETSCV_SPEC>`"]
