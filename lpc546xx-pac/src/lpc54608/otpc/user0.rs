...
///Field `USER0` reader - User application specific option.
...
///`read()` method returns [user0::R](R) reader structure
impl crate::Readable for USER0_SPEC {
    type Reader = R;
}
///`reset()` method sets USER0 to value 0
