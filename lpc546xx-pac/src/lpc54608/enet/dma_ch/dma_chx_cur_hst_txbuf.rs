///Register `DMA_CHx_CUR_HST_TXBUF` reader
...
///Field `HTB` reader - Host Transmit Buffer Address Pointer Cleared on Reset.
...
///`read()` method returns [dma_chx_cur_hst_txbuf::R](R) reader structure
impl crate::Readable for DMA_CHX_CUR_HST_TXBUF_SPEC {
    type Reader = R;
}
///`reset()` method sets DMA_CHx_CUR_HST_TXBUF to value 0
