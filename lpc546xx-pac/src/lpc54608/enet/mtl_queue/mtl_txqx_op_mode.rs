///Register `MTL_TXQx_OP_MODE` reader
...
///Register `MTL_TXQx_OP_MODE` writer
...
///Field `FTQ` reader - Flush Transmit Queue When this bit is set, the Tx queue controller logic is reset to its default values.
...
///Field `FTQ` writer - Flush Transmit Queue When this bit is set, the Tx queue controller logic is reset to its default values.
pub struct FTQ_W<'a> {
    w: &'a mut W,
}
impl<'a> FTQ_W<'a> {
...
///Field `TSF` reader - Transmit Store and Forward When this bit is set, the transmission starts when a full packet resides in the MTL Tx queue.
...
///Field `TSF` writer - Transmit Store and Forward When this bit is set, the transmission starts when a full packet resides in the MTL Tx queue.
pub struct TSF_W<'a> {
    w: &'a mut W,
}
impl<'a> TSF_W<'a> {
...
///Field `TXQEN` reader - Transmit Queue Enable This field is used to enable/disable the transmit queue 0.
...
///Field `TXQEN` writer - Transmit Queue Enable This field is used to enable/disable the transmit queue 0.
...
///Field `TTC` reader - Transmit Threshold Control These bits control the threshold level of the MTL Tx Queue.
...
///Field `TTC` writer - Transmit Threshold Control These bits control the threshold level of the MTL Tx Queue.
pub struct TTC_W<'a> {
    w: &'a mut W,
}
impl<'a> TTC_W<'a> {
...
///Field `TQS` reader - Transmit Queue Size This field indicates the size of the allocated Transmit queues in blocks of 256 bytes.
...
///Field `TQS` writer - Transmit Queue Size This field indicates the size of the allocated Transmit queues in blocks of 256 bytes.
pub struct TQS_W<'a> {
    w: &'a mut W,
}
impl<'a> TQS_W<'a> {
...
///`read()` method returns [mtl_txqx_op_mode::R](R) reader structure
impl crate::Readable for MTL_TXQX_OP_MODE_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [mtl_txqx_op_mode::W](W) writer structure
impl crate::Writable for MTL_TXQX_OP_MODE_SPEC {
    type Writer = W;
}
///`reset()` method sets MTL_TXQx_OP_MODE to value 0
