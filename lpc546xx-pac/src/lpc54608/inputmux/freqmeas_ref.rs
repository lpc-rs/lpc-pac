...
impl From<crate::R<FREQMEAS_REF_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<FREQMEAS_REF_SPEC>) -> Self {
        R(reader)
    }
}
///Register `FREQMEAS_REF` writer
...
impl From<crate::W<FREQMEAS_REF_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<FREQMEAS_REF_SPEC>) -> Self {
        W(writer)
    }
}
///Field `CLKIN` reader - Clock source number (decimal value) for frequency measure function target clock: 0 = CLK_IN 1 = FRO 12 MHz oscillator 2 = Watchdog oscillator 3 = 32 kHz RTC oscillator 4 = Main clock (see Section 4.5.23) 5 = PIO0_4 6 = PIO0_20 7 = PIO0_24 8 = PIO1_4
...
///Field `CLKIN` writer - Clock source number (decimal value) for frequency measure function target clock: 0 = CLK_IN 1 = FRO 12 MHz oscillator 2 = Watchdog oscillator 3 = 32 kHz RTC oscillator 4 = Main clock (see Section 4.5.23) 5 = PIO0_4 6 = PIO0_20 7 = PIO0_24 8 = PIO1_4
...
///`read()` method returns [freqmeas_ref::R](R) reader structure
impl crate::Readable for FREQMEAS_REF_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [freqmeas_ref::W](W) writer structure
impl crate::Writable for FREQMEAS_REF_SPEC {
    type Writer = W;
}
///`reset()` method sets FREQMEAS_REF to value 0x1f
