///Register `FREQMEAS_TARGET` reader
...
///Register `FREQMEAS_TARGET` writer
...
///`read()` method returns [freqmeas_target::R](R) reader structure
impl crate::Readable for FREQMEAS_TARGET_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [freqmeas_target::W](W) writer structure
impl crate::Writable for FREQMEAS_TARGET_SPEC {
    type Writer = W;
}
///`reset()` method sets FREQMEAS_TARGET to value 0x1f
