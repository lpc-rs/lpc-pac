...
///Field `TSREX` reader - Self-refresh exit time.
...
///Field `TSREX` writer - Self-refresh exit time.
...
///`read()` method returns [dynamicsrex::R](R) reader structure
impl crate::Readable for DYNAMICSREX_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [dynamicsrex::W](W) writer structure
impl crate::Writable for DYNAMICSREX_SPEC {
    type Writer = W;
}
///`reset()` method sets DYNAMICSREX to value 0x0f
