///Register `DYNAMICREFRESH` reader
...
///Register `DYNAMICREFRESH` writer
...
///Field `REFRESH` reader - Refresh timer.
...
///Field `REFRESH` writer - Refresh timer.
...
///`read()` method returns [dynamicrefresh::R](R) reader structure
impl crate::Readable for DYNAMICREFRESH_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [dynamicrefresh::W](W) writer structure
impl crate::Writable for DYNAMICREFRESH_SPEC {
    type Writer = W;
}
///`reset()` method sets DYNAMICREFRESH to value 0
