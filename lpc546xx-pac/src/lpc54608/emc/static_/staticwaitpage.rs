///Register `STATICWAITPAGE` reader
...
///Register `STATICWAITPAGE` writer
...
///Field `WAITPAGE` reader - Asynchronous page mode read after the first read wait states.
...
///Field `WAITPAGE` writer - Asynchronous page mode read after the first read wait states.
...
///`read()` method returns [staticwaitpage::R](R) reader structure
impl crate::Readable for STATICWAITPAGE_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [staticwaitpage::W](W) writer structure
impl crate::Writable for STATICWAITPAGE_SPEC {
    type Writer = W;
}
///`reset()` method sets STATICWAITPAGE to value 0x1f
