///Register `MTL_TXQx_ETS_CTRL` reader
...
///Register `MTL_TXQx_ETS_CTRL` writer
...
///Field `SLC` reader - Credit Control.
...
///`read()` method returns [mtl_txqx_ets_ctrl::R](R) reader structure
impl crate::Readable for MTL_TXQX_ETS_CTRL_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [mtl_txqx_ets_ctrl::W](W) writer structure
impl crate::Writable for MTL_TXQX_ETS_CTRL_SPEC {
    type Writer = W;
}
///`reset()` method sets MTL_TXQx_ETS_CTRL to value 0
