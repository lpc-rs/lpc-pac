///Register `MAC_SUB_SCND_INCR` reader
...
///Register `MAC_SUB_SCND_INCR` writer
...
///`read()` method returns [mac_sub_scnd_incr::R](R) reader structure
impl crate::Readable for MAC_SUB_SCND_INCR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [mac_sub_scnd_incr::W](W) writer structure
impl crate::Writable for MAC_SUB_SCND_INCR_SPEC {
    type Writer = W;
}
///`reset()` method sets MAC_SUB_SCND_INCR to value 0
