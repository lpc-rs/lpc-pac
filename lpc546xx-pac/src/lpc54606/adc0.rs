...
pub struct RegisterBlock {
    ...
    pub insel: crate::Reg<insel::INSEL_SPEC>,
    ...
    _reserved6: [u8; 0x08],
    ///0x20..0x50 - ADC Channel 0 Data register. This register contains the result of the most recent conversion completed on channel 0.
...
pub mod ctrl;
///INSEL register accessor: an alias for `Reg<INSEL_SPEC>`
