...
impl From<crate::R<CAP_MATCH_MATCH7_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CAP_MATCH_MATCH7_SPEC>) -> Self {
        R(reader)
    }
}
///Register `MATCH7` writer
...
impl From<crate::W<CAP_MATCH_MATCH7_SPEC>> for W {
    #[inline(always)]
...
///`read()` method returns [cap_match_match7::R](R) reader structure
impl crate::Readable for CAP_MATCH_MATCH7_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [cap_match_match7::W](W) writer structure
impl crate::Writable for CAP_MATCH_MATCH7_SPEC {
    type Writer = W;
}
///`reset()` method sets MATCH7 to value 0
