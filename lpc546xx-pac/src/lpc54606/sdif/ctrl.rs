...
///Field `CONTROLLER_RESET` reader - Controller reset.
...
///Field `CONTROLLER_RESET` writer - Controller reset.
...
///Field `FIFO_RESET` reader - Fifo reset.
...
///Field `FIFO_RESET` writer - Fifo reset.
...
///Field `DMA_RESET` reader - DMA reset.
...
///Field `DMA_RESET` writer - DMA reset.
...
///Field `INT_ENABLE` reader - Global interrupt enable/disable bit.
...
///Field `INT_ENABLE` writer - Global interrupt enable/disable bit.
...
///Field `READ_WAIT` reader - Read/wait.
...
///Field `READ_WAIT` writer - Read/wait.
...
///Field `SEND_IRQ_RESPONSE` reader - Send irq response.
...
///Field `SEND_IRQ_RESPONSE` writer - Send irq response.
...
///Field `ABORT_READ_DATA` reader - Abort read data.
...
///Field `ABORT_READ_DATA` writer - Abort read data.
...
///Field `SEND_CCSD` reader - Send ccsd.
...
///Field `SEND_CCSD` writer - Send ccsd.
...
///Field `SEND_AUTO_STOP_CCSD` reader - Send auto stop ccsd.
...
///Field `SEND_AUTO_STOP_CCSD` writer - Send auto stop ccsd.
...
///Field `CEATA_DEVICE_INTERRUPT_STATUS` reader - CEATA device interrupt status.
...
///Field `CEATA_DEVICE_INTERRUPT_STATUS` writer - CEATA device interrupt status.
...
///Field `CARD_VOLTAGE_A0` reader - Controls the state of the SD_VOLT0 pin.
...
///Field `CARD_VOLTAGE_A0` writer - Controls the state of the SD_VOLT0 pin.
...
///Field `CARD_VOLTAGE_A1` reader - Controls the state of the SD_VOLT1 pin.
...
///Field `CARD_VOLTAGE_A1` writer - Controls the state of the SD_VOLT1 pin.
...
///Field `CARD_VOLTAGE_A2` reader - Controls the state of the SD_VOLT2 pin.
...
///Field `CARD_VOLTAGE_A2` writer - Controls the state of the SD_VOLT2 pin.
...
///Field `USE_INTERNAL_DMAC` reader - SD/MMC DMA use.
...
///Field `USE_INTERNAL_DMAC` writer - SD/MMC DMA use.
