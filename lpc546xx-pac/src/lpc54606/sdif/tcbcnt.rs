...
///Field `TRANS_CARD_BYTE_COUNT` reader - Number of bytes transferred by CIU unit to card.
...
///Field `TRANS_CARD_BYTE_COUNT` writer - Number of bytes transferred by CIU unit to card.
...
///`write(|w| ..)` method takes [tcbcnt::W](W) writer structure
