...
///Field `PRI_15` reader - Priority of system handler 15, SysTick exception
...
///Field `PRI_15` writer - Priority of system handler 15, SysTick exception
...
///`read()` method returns [shpr3::R](R) reader structure
impl crate::Readable for SHPR3_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [shpr3::W](W) writer structure
