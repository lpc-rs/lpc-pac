...
///Field `PRI_4` reader - Priority of system handler 4, MemManage
...
///Field `PRI_4` writer - Priority of system handler 4, MemManage
...
///Field `PRI_5` reader - Priority of system handler 5, BusFault
...
///Field `PRI_5` writer - Priority of system handler 5, BusFault
...
///Field `PRI_6` reader - Priority of system handler 6, UsageFault
...
///Field `PRI_6` writer - Priority of system handler 6, UsageFault
...
///`read()` method returns [shpr1::R](R) reader structure
impl crate::Readable for SHPR1_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [shpr1::W](W) writer structure
