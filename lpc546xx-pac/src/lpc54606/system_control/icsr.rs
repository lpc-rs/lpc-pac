...
///Field `RETTOBASE` reader - no description available
...
///Field `ISRPENDING` reader - no description available
...
///Field `ISRPREEMPT` reader - no description available
...
///Field `PENDSTCLR` writer - no description available
...
///Field `PENDSTSET` reader - no description available
...
///Field `PENDSTSET` writer - no description available
...
///Field `PENDSVCLR` writer - no description available
...
///Field `PENDSVSET` reader - no description available
...
///Field `PENDSVSET` writer - no description available
...
///Field `NMIPENDSET` reader - no description available
...
///Field `NMIPENDSET` writer - no description available
