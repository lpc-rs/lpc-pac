...
///Field `RBRIE` reader - RBR Interrupt Enable.
...
///Field `RBRIE` writer - RBR Interrupt Enable.
...
///Field `THREIE` reader - THRE Interrupt Enable.
...
///Field `THREIE` writer - THRE Interrupt Enable.
...
///Field `RXIE` reader - RX Line Status Interrupt Enable.
...
///Field `RXIE` writer - RX Line Status Interrupt Enable.
pub struct RXIE_W<'a> {
    w: &'a mut W,
}
impl<'a> RXIE_W<'a> {
...
///`read()` method returns [dlm_ier_ier::R](R) reader structure
impl crate::Readable for DLM_IER_IER_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [dlm_ier_ier::W](W) writer structure
