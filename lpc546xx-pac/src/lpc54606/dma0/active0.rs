...
///Field `ACT` reader - Active flag for DMA channel n. Bit n corresponds to DMA channel n. The number of bits = number of DMA channels in this device. Other bits are reserved. 0 = not active. 1 = active.
...
///`read()` method returns [active0::R](R) reader structure
impl crate::Readable for ACTIVE0_SPEC {
    type Reader = R;
}
///`reset()` method sets ACTIVE0 to value 0
