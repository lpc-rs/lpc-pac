...
///Field `BSY` reader - Busy flag for DMA channel n. Bit n corresponds to DMA channel n. The number of bits = number of DMA channels in this device. Other bits are reserved. 0 = not busy. 1 = busy.
...
///`read()` method returns [busy0::R](R) reader structure
impl crate::Readable for BUSY0_SPEC {
    type Reader = R;
}
///`reset()` method sets BUSY0 to value 0
