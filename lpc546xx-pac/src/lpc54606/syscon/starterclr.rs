...
///Field `START_CLR` writer - Writing ones to this register clears the corresponding bit or bits in the STARTER0 register, if they are implemented.
...
///`write(|w| ..)` method takes [starterclr::W](W) writer structure
impl crate::Writable for STARTERCLR_SPEC {
    type Writer = W;
}
///`reset()` method sets STARTERCLR[%s]
///to value 0
