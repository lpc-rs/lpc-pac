...
///`read()` method returns [syspllpdec::R](R) reader structure
impl crate::Readable for SYSPLLPDEC_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [syspllpdec::W](W) writer structure
impl crate::Writable for SYSPLLPDEC_SPEC {
    type Writer = W;
}
///`reset()` method sets SYSPLLPDEC to value 0
