///Register `ARMTRACECLKDIV` reader
pub struct R(crate::R<ARMTRACECLKDIV_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ARMTRACECLKDIV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ARMTRACECLKDIV_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ARMTRACECLKDIV_SPEC>) -> Self {
        R(reader)
    }
}
///Register `ARMTRACECLKDIV` writer
pub struct W(crate::W<ARMTRACECLKDIV_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ARMTRACECLKDIV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ARMTRACECLKDIV_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ARMTRACECLKDIV_SPEC>) -> Self {
        W(writer)
    }
}
///Field `DIV` reader - Clock divider value.
...
///Field `DIV` writer - Clock divider value.
pub struct DIV_W<'a> {
    w: &'a mut W,
}
impl<'a> DIV_W<'a> {
...
///
///For information about available fields see [armtraceclkdiv](index.html) module
pub struct ARMTRACECLKDIV_SPEC;
impl crate::RegisterSpec for ARMTRACECLKDIV_SPEC {
    type Ux = u32;
}
///`read()` method returns [armtraceclkdiv::R](R) reader structure
impl crate::Readable for ARMTRACECLKDIV_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [armtraceclkdiv::W](W) writer structure
impl crate::Writable for ARMTRACECLKDIV_SPEC {
    type Writer = W;
}
///`reset()` method sets ARMTRACECLKDIV to value 0x4000_0000
impl crate::Resettable for ARMTRACECLKDIV_SPEC {
    #[inline(always)]
