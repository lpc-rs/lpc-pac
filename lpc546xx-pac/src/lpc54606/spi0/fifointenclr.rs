...
///Field `TXERR` reader - Writing one clears the corresponding bits in the FIFOINTENSET register.
...
///Field `TXERR` writer - Writing one clears the corresponding bits in the FIFOINTENSET register.
...
///Field `RXERR` reader - Writing one clears the corresponding bits in the FIFOINTENSET register.
...
///Field `RXERR` writer - Writing one clears the corresponding bits in the FIFOINTENSET register.
...
///Field `TXLVL` reader - Writing one clears the corresponding bits in the FIFOINTENSET register.
...
///Field `TXLVL` writer - Writing one clears the corresponding bits in the FIFOINTENSET register.
...
///Field `RXLVL` reader - Writing one clears the corresponding bits in the FIFOINTENSET register.
...
///Field `RXLVL` writer - Writing one clears the corresponding bits in the FIFOINTENSET register.
...
///`read()` method returns [fifointenclr::R](R) reader structure
impl crate::Readable for FIFOINTENCLR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [fifointenclr::W](W) writer structure
impl crate::Writable for FIFOINTENCLR_SPEC {
    type Writer = W;
}
///`reset()` method sets FIFOINTENCLR to value 0
