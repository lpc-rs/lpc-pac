...
///Field `TraceControlEnable` reader - Trace start/stop enable. The trace start/stop resource, resource 0x5F, is unaffected by the value of this bit.
...
///Field `TraceControlEnable` writer - Trace start/stop enable. The trace start/stop resource, resource 0x5F, is unaffected by the value of this bit.
...
///`read()` method returns [tecr1::R](R) reader structure
impl crate::Readable for TECR1_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [tecr1::W](W) writer structure
