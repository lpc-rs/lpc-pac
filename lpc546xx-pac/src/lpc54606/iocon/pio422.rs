...
///`read()` method returns [pio422::R](R) reader structure
impl crate::Readable for PIO422_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio422::W](W) writer structure
impl crate::Writable for PIO422_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO422 to value 0x0320
