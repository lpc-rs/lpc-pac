...
///`read()` method returns [pio030::R](R) reader structure
impl crate::Readable for PIO030_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio030::W](W) writer structure
impl crate::Writable for PIO030_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO030 to value 0x0320
