...
///`read()` method returns [pio49::R](R) reader structure
impl crate::Readable for PIO49_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio49::W](W) writer structure
impl crate::Writable for PIO49_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO49 to value 0x0320
