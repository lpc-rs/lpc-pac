...
///`read()` method returns [pio527::R](R) reader structure
impl crate::Readable for PIO527_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio527::W](W) writer structure
impl crate::Writable for PIO527_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO527 to value 0x0320
