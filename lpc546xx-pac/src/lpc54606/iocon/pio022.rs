...
///`read()` method returns [pio022::R](R) reader structure
impl crate::Readable for PIO022_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio022::W](W) writer structure
impl crate::Writable for PIO022_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO022 to value 0x0320
