...
///`read()` method returns [pio57::R](R) reader structure
impl crate::Readable for PIO57_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio57::W](W) writer structure
impl crate::Writable for PIO57_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO57 to value 0x0320
