...
///`read()` method returns [pio325::R](R) reader structure
impl crate::Readable for PIO325_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio325::W](W) writer structure
impl crate::Writable for PIO325_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO325 to value 0x0320
