...
///`read()` method returns [pio224::R](R) reader structure
impl crate::Readable for PIO224_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio224::W](W) writer structure
impl crate::Writable for PIO224_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO224 to value 0x0320
