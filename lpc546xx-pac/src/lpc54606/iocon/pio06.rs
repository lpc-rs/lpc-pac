...
///`read()` method returns [pio06::R](R) reader structure
impl crate::Readable for PIO06_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio06::W](W) writer structure
impl crate::Writable for PIO06_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO06 to value 0x0320
