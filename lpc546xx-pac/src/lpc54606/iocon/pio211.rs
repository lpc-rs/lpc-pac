...
///`read()` method returns [pio211::R](R) reader structure
impl crate::Readable for PIO211_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio211::W](W) writer structure
impl crate::Writable for PIO211_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO211 to value 0x0320
