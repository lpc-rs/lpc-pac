...
///`read()` method returns [pio20::R](R) reader structure
impl crate::Readable for PIO20_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio20::W](W) writer structure
impl crate::Writable for PIO20_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO20 to value 0x0320
