...
///`read()` method returns [pio125::R](R) reader structure
impl crate::Readable for PIO125_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio125::W](W) writer structure
impl crate::Writable for PIO125_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO125 to value 0x0320
