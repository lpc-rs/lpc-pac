...
///`read()` method returns [pio330::R](R) reader structure
impl crate::Readable for PIO330_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio330::W](W) writer structure
impl crate::Writable for PIO330_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO330 to value 0x0320
