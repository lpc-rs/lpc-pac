...
///`read()` method returns [pio220::R](R) reader structure
impl crate::Readable for PIO220_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio220::W](W) writer structure
impl crate::Writable for PIO220_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO220 to value 0x0320
