...
///`read()` method returns [pio312::R](R) reader structure
impl crate::Readable for PIO312_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio312::W](W) writer structure
impl crate::Writable for PIO312_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO312 to value 0x0320
