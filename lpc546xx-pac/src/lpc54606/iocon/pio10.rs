...
///`read()` method returns [pio10::R](R) reader structure
impl crate::Readable for PIO10_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio10::W](W) writer structure
impl crate::Writable for PIO10_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO10 to value 0x0320
