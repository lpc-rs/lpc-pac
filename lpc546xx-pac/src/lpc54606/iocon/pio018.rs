...
///`read()` method returns [pio018::R](R) reader structure
impl crate::Readable for PIO018_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio018::W](W) writer structure
impl crate::Writable for PIO018_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO018 to value 0x0320
