...
///Field `SIG_DONE` reader - When 1, a previously started signature generation has completed.
...
///`read()` method returns [fmstat::R](R) reader structure
impl crate::Readable for FMSTAT_SPEC {
    type Reader = R;
}
///`reset()` method sets FMSTAT to value 0
