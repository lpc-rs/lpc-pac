...
///`read()` method returns [pio28::R](R) reader structure
impl crate::Readable for PIO28_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio28::W](W) writer structure
impl crate::Writable for PIO28_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO28 to value 0x0320
