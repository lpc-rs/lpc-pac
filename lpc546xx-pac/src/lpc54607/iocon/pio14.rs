...
///`read()` method returns [pio14::R](R) reader structure
impl crate::Readable for PIO14_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio14::W](W) writer structure
impl crate::Writable for PIO14_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO14 to value 0x0320
