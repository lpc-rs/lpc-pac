...
///`read()` method returns [pio516::R](R) reader structure
impl crate::Readable for PIO516_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio516::W](W) writer structure
impl crate::Writable for PIO516_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO516 to value 0x0320
