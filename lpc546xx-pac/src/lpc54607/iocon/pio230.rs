...
///`read()` method returns [pio230::R](R) reader structure
impl crate::Readable for PIO230_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio230::W](W) writer structure
impl crate::Writable for PIO230_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO230 to value 0x0320
