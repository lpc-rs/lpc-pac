...
///`read()` method returns [pio116::R](R) reader structure
impl crate::Readable for PIO116_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio116::W](W) writer structure
impl crate::Writable for PIO116_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO116 to value 0x0320
