...
///`read()` method returns [pio428::R](R) reader structure
impl crate::Readable for PIO428_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio428::W](W) writer structure
impl crate::Writable for PIO428_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO428 to value 0x0320
