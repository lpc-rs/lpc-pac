...
///`read()` method returns [pio412::R](R) reader structure
impl crate::Readable for PIO412_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio412::W](W) writer structure
impl crate::Writable for PIO412_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO412 to value 0x0320
