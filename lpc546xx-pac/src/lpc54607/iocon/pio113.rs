...
///`read()` method returns [pio113::R](R) reader structure
impl crate::Readable for PIO113_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio113::W](W) writer structure
impl crate::Writable for PIO113_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO113 to value 0x0320
