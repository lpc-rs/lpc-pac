...
///`read()` method returns [pio015::R](R) reader structure
impl crate::Readable for PIO015_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio015::W](W) writer structure
impl crate::Writable for PIO015_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO015 to value 0x0320
