...
///`read()` method returns [pio210::R](R) reader structure
impl crate::Readable for PIO210_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio210::W](W) writer structure
impl crate::Writable for PIO210_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO210 to value 0x0320
