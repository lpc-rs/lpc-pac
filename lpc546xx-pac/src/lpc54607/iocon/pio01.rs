...
///`read()` method returns [pio01::R](R) reader structure
impl crate::Readable for PIO01_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio01::W](W) writer structure
impl crate::Writable for PIO01_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO01 to value 0x0320
