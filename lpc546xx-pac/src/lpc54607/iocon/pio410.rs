...
///`read()` method returns [pio410::R](R) reader structure
impl crate::Readable for PIO410_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio410::W](W) writer structure
impl crate::Writable for PIO410_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO410 to value 0x0320
