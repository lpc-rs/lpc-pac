...
///`read()` method returns [pio118::R](R) reader structure
impl crate::Readable for PIO118_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio118::W](W) writer structure
impl crate::Writable for PIO118_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO118 to value 0x0320
