...
///`read()` method returns [pio320::R](R) reader structure
impl crate::Readable for PIO320_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio320::W](W) writer structure
impl crate::Writable for PIO320_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO320 to value 0x0320
