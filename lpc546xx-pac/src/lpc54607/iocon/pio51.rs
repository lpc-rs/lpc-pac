...
///`read()` method returns [pio51::R](R) reader structure
impl crate::Readable for PIO51_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio51::W](W) writer structure
impl crate::Writable for PIO51_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO51 to value 0x0320
