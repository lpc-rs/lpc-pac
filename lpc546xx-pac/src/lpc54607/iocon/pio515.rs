...
///`read()` method returns [pio515::R](R) reader structure
impl crate::Readable for PIO515_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio515::W](W) writer structure
impl crate::Writable for PIO515_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO515 to value 0x0320
