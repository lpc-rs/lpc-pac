...
///`read()` method returns [pio25::R](R) reader structure
impl crate::Readable for PIO25_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio25::W](W) writer structure
impl crate::Writable for PIO25_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO25 to value 0x0320
