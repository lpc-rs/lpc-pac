...
///`read()` method returns [pio316::R](R) reader structure
impl crate::Readable for PIO316_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio316::W](W) writer structure
impl crate::Writable for PIO316_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO316 to value 0x0320
