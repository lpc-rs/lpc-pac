...
///`read()` method returns [pio41::R](R) reader structure
impl crate::Readable for PIO41_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio41::W](W) writer structure
impl crate::Writable for PIO41_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO41 to value 0x0320
