...
///`read()` method returns [pio020::R](R) reader structure
impl crate::Readable for PIO020_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio020::W](W) writer structure
impl crate::Writable for PIO020_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO020 to value 0x0320
