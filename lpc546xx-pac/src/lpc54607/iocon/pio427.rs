...
///`read()` method returns [pio427::R](R) reader structure
impl crate::Readable for PIO427_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio427::W](W) writer structure
impl crate::Writable for PIO427_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO427 to value 0x0320
