...
///`read()` method returns [capctrl_matchrel_matchrel8::R](R) reader structure
impl crate::Readable for CAPCTRL_MATCHREL_MATCHREL8_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [capctrl_matchrel_matchrel8::W](W) writer structure
impl crate::Writable for CAPCTRL_MATCHREL_MATCHREL8_SPEC {
    type Writer = W;
}
///`reset()` method sets MATCHREL8 to value 0
