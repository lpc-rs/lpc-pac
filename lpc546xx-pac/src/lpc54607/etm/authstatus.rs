...
///Field `NSID` reader - Reads as b00, Non-secure invasive debug not supported by the ETM.
...
#[repr(u8)]
pub enum NSNID_A {
    ///2: Non-secure non-invasive debug disabled
    NSNID_2 = 2,
    ///3: Non-secure non-invasive debug enabled
    NSNID_3 = 3,
}
...
///Field `NSNID` reader - Permission for Non-secure non-invasive debug.
...
///Field `SID` reader - Reads as b00, Secure invasive debug not supported by the ETM.
...
///Field `SNID` reader - Permission for Secure non-invasive debug.
...
///`read()` method returns [authstatus::R](R) reader structure
