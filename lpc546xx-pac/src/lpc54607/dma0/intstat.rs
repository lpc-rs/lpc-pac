...
///Field `ACTIVEINT` reader - Summarizes whether any enabled interrupts (other than error interrupts) are pending.
...
///Field `ACTIVEERRINT` reader - Summarizes whether any error interrupts are pending.
