...
///Field `FUFIC` writer - FIFO underflow interrupt clear.
...
///Field `LNBUIC` writer - LCD next address base update interrupt clear.
...
///Field `VCOMPIC` writer - Vertical compare interrupt clear.
...
///Field `BERIC` reader - AHB master error interrupt clear.
...
///Field `BERIC` writer - AHB master error interrupt clear.
...
impl R {
    ///Bit 4 - AHB master error interrupt clear.
    #[inline(always)]
...
impl W {
    ///Bit 1 - FIFO underflow interrupt clear.
    #[inline(always)]
    pub fn fufic(&mut self) -> FUFIC_W {
        FUFIC_W { w: self }
    }
    ///Bit 2 - LCD next address base update interrupt clear.
    #[inline(always)]
    pub fn lnbuic(&mut self) -> LNBUIC_W {
        LNBUIC_W { w: self }
    }
    ///Bit 3 - Vertical compare interrupt clear.
    #[inline(always)]
...
///`read()` method returns [intclr::R](R) reader structure
