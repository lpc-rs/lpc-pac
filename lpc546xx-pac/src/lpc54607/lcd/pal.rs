...
///Field `R04_0` reader - Red palette data.
...
///Field `R04_0` writer - Red palette data.
...
///Field `G04_0` reader - Green palette data.
...
///Field `G04_0` writer - Green palette data.
...
///Field `B04_0` reader - Blue palette data.
...
///Field `B04_0` writer - Blue palette data.
...
///Field `I0` reader - Intensity / unused bit.
...
///Field `I0` writer - Intensity / unused bit.
pub struct I0_W<'a> {
    w: &'a mut W,
}
impl<'a> I0_W<'a> {
...
///Field `R14_0` reader - Red palette data.
...
///Field `R14_0` writer - Red palette data.
...
///Field `G14_0` reader - Green palette data.
...
///Field `G14_0` writer - Green palette data.
...
///Field `B14_0` reader - Blue palette data.
...
///Field `B14_0` writer - Blue palette data.
...
///Field `I1` reader - Intensity / unused bit.
...
///Field `I1` writer - Intensity / unused bit.
pub struct I1_W<'a> {
    w: &'a mut W,
}
impl<'a> I1_W<'a> {
...
///`read()` method returns [pal::R](R) reader structure
impl crate::Readable for PAL_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pal::W](W) writer structure
impl crate::Writable for PAL_SPEC {
    type Writer = W;
}
///`reset()` method sets PAL[%s]
///to value 0
