///Register `DMICCLKDIV` reader
pub struct R(crate::R<DMICCLKDIV_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DMICCLKDIV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DMICCLKDIV_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DMICCLKDIV_SPEC>) -> Self {
        R(reader)
    }
}
///Register `DMICCLKDIV` writer
pub struct W(crate::W<DMICCLKDIV_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DMICCLKDIV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DMICCLKDIV_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DMICCLKDIV_SPEC>) -> Self {
        W(writer)
    }
}
...
///Field `HALT` reader - Halts the divider counter. The intent is to allow the divider clock source to be changed without the risk of a glitch at the output.
...
///Field `HALT` writer - Halts the divider counter. The intent is to allow the divider clock source to be changed without the risk of a glitch at the output.
pub struct HALT_W<'a> {
    w: &'a mut W,
}
impl<'a> HALT_W<'a> {
...
///
///For information about available fields see [dmicclkdiv](index.html) module
pub struct DMICCLKDIV_SPEC;
impl crate::RegisterSpec for DMICCLKDIV_SPEC {
    type Ux = u32;
}
///`read()` method returns [dmicclkdiv::R](R) reader structure
impl crate::Readable for DMICCLKDIV_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [dmicclkdiv::W](W) writer structure
impl crate::Writable for DMICCLKDIV_SPEC {
    type Writer = W;
}
///`reset()` method sets DMICCLKDIV to value 0x4000_0000
impl crate::Resettable for DMICCLKDIV_SPEC {
    #[inline(always)]
