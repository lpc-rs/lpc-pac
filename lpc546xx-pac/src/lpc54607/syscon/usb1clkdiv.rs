...
///`read()` method returns [usb1clkdiv::R](R) reader structure
impl crate::Readable for USB1CLKDIV_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [usb1clkdiv::W](W) writer structure
impl crate::Writable for USB1CLKDIV_SPEC {
    type Writer = W;
}
///`reset()` method sets USB1CLKDIV to value 0x4000_0000
