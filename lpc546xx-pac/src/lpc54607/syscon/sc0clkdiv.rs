///Register `SC0CLKDIV` reader
pub struct R(crate::R<SC0CLKDIV_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SC0CLKDIV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SC0CLKDIV_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SC0CLKDIV_SPEC>) -> Self {
        R(reader)
    }
}
///Register `SC0CLKDIV` writer
pub struct W(crate::W<SC0CLKDIV_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SC0CLKDIV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SC0CLKDIV_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SC0CLKDIV_SPEC>) -> Self {
        W(writer)
    }
}
...
///
///For information about available fields see [sc0clkdiv](index.html) module
pub struct SC0CLKDIV_SPEC;
impl crate::RegisterSpec for SC0CLKDIV_SPEC {
    type Ux = u32;
}
///`read()` method returns [sc0clkdiv::R](R) reader structure
impl crate::Readable for SC0CLKDIV_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [sc0clkdiv::W](W) writer structure
impl crate::Writable for SC0CLKDIV_SPEC {
    type Writer = W;
}
///`reset()` method sets SC0CLKDIV to value 0x4000_0000
impl crate::Resettable for SC0CLKDIV_SPEC {
    #[inline(always)]
