...
///Field `PRI_ICODE` reader - I-Code bus priority.
...
///Field `PRI_ICODE` writer - I-Code bus priority.
...
///Field `PRI_DCODE` reader - D-Code bus priority.
...
///Field `PRI_DCODE` writer - D-Code bus priority.
...
///Field `PRI_SYS` reader - System bus priority.
...
///Field `PRI_SYS` writer - System bus priority.
...
///Field `PRI_DMA` reader - DMA controller priority.
...
///Field `PRI_DMA` writer - DMA controller priority.
...
///Field `PRI_ETH` reader - Ethernet DMA priority.
...
///Field `PRI_ETH` writer - Ethernet DMA priority.
...
///Field `PRI_LCD` reader - LCD DMA priority.
...
///Field `PRI_LCD` writer - LCD DMA priority.
...
///Field `PRI_USB0` reader - USB0 DMA priority.
...
///Field `PRI_USB0` writer - USB0 DMA priority.
...
///Field `PRI_USB1` reader - USB1 DMA priority.
...
///Field `PRI_USB1` writer - USB1 DMA priority.
...
///Field `PRI_SDIO` reader - SDIO priority.
...
///Field `PRI_SDIO` writer - SDIO priority.
...
///Field `PRI_MCAN1` reader - MCAN1 priority.
...
///Field `PRI_MCAN1` writer - MCAN1 priority.
...
///Field `PRI_MCAN2` reader - MCAN2 priority.
...
///Field `PRI_MCAN2` writer - MCAN2 priority.
...
///Field `PRI_SHA` reader - SHA priority.
...
///Field `PRI_SHA` writer - SHA priority.
...
///`read()` method returns [ahbmatprio::R](R) reader structure
impl crate::Readable for AHBMATPRIO_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [ahbmatprio::W](W) writer structure
impl crate::Writable for AHBMATPRIO_SPEC {
    type Writer = W;
}
///`reset()` method sets AHBMATPRIO to value 0
