///Register `CAN0CLKDIV` reader
pub struct R(crate::R<CAN0CLKDIV_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CAN0CLKDIV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CAN0CLKDIV_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CAN0CLKDIV_SPEC>) -> Self {
        R(reader)
    }
}
///Register `CAN0CLKDIV` writer
pub struct W(crate::W<CAN0CLKDIV_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CAN0CLKDIV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CAN0CLKDIV_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CAN0CLKDIV_SPEC>) -> Self {
        W(writer)
    }
}
...
///
///For information about available fields see [can0clkdiv](index.html) module
pub struct CAN0CLKDIV_SPEC;
impl crate::RegisterSpec for CAN0CLKDIV_SPEC {
    type Ux = u32;
}
///`read()` method returns [can0clkdiv::R](R) reader structure
impl crate::Readable for CAN0CLKDIV_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [can0clkdiv::W](W) writer structure
impl crate::Writable for CAN0CLKDIV_SPEC {
    type Writer = W;
}
///`reset()` method sets CAN0CLKDIV to value 0x4000_0000
impl crate::Resettable for CAN0CLKDIV_SPEC {
    #[inline(always)]
