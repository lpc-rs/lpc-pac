...
///Field `DIRECTI` reader - PLL direct input enable.
...
///Field `DIRECTI` writer - PLL direct input enable.
...
///Field `DIRECTO` reader - PLL direct output enable
...
///Field `DIRECTO` writer - PLL direct output enable
...
///`read()` method returns [audpllctrl::R](R) reader structure
impl crate::Readable for AUDPLLCTRL_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [audpllctrl::W](W) writer structure
impl crate::Writable for AUDPLLCTRL_SPEC {
    type Writer = W;
}
///`reset()` method sets AUDPLLCTRL to value 0
