...
///`read()` method returns [systickclkdiv::R](R) reader structure
impl crate::Readable for SYSTICKCLKDIV_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [systickclkdiv::W](W) writer structure
impl crate::Writable for SYSTICKCLKDIV_SPEC {
    type Writer = W;
}
///`reset()` method sets SYSTICKCLKDIV to value 0x4000_0000
