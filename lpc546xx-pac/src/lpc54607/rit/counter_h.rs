...
///Field `RICOUNTER` reader - 16 LSBs of the up counter.
...
///Field `RICOUNTER` writer - 16 LSBs of the up counter.
...
///`read()` method returns [counter_h::R](R) reader structure
impl crate::Readable for COUNTER_H_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [counter_h::W](W) writer structure
impl crate::Writable for COUNTER_H_SPEC {
    type Writer = W;
}
///`reset()` method sets COUNTER_H to value 0
