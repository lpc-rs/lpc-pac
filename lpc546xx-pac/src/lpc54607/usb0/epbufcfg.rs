...
///Field `BUF_SB` reader - Buffer usage: This register has one bit per physical endpoint. 0: Single-buffer. 1: Double-buffer. If the bit is set to single-buffer (0), it will not toggle the corresponding EPINUSE bit when it clears the active bit. If the bit is set to double-buffer (1), HW will toggle the EPINUSE bit when it clears the Active bit for the buffer.
...
///Field `BUF_SB` writer - Buffer usage: This register has one bit per physical endpoint. 0: Single-buffer. 1: Double-buffer. If the bit is set to single-buffer (0), it will not toggle the corresponding EPINUSE bit when it clears the active bit. If the bit is set to double-buffer (1), HW will toggle the EPINUSE bit when it clears the Active bit for the buffer.
...
///`read()` method returns [epbufcfg::R](R) reader structure
impl crate::Readable for EPBUFCFG_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [epbufcfg::W](W) writer structure
impl crate::Writable for EPBUFCFG_SPEC {
    type Writer = W;
}
///`reset()` method sets EPBUFCFG to value 0
