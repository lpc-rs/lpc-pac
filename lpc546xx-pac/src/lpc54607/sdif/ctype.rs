...
///Field `CARD_WIDTH0` reader - Indicates if card is 1-bit or 4-bit: 0 - 1-bit mode 1 - 4-bit mode 1 and 4-bit modes only work when 8-bit mode in CARD_WIDTH1 is not enabled (bit 16 in this register is set to 0).
...
///Field `CARD_WIDTH0` writer - Indicates if card is 1-bit or 4-bit: 0 - 1-bit mode 1 - 4-bit mode 1 and 4-bit modes only work when 8-bit mode in CARD_WIDTH1 is not enabled (bit 16 in this register is set to 0).
...
///Field `CARD_WIDTH1` reader - Indicates if card is 8-bit: 0 - Non 8-bit mode 1 - 8-bit mode.
...
///Field `CARD_WIDTH1` writer - Indicates if card is 8-bit: 0 - Non 8-bit mode 1 - 8-bit mode.
