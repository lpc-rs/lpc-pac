///Register `ISO_PTD_DONE_MAP` reader
...
///Register `ISO_PTD_DONE_MAP` writer
...
///Field `ISO_DONE` reader - The bit corresponding to a certain PTD will be set to logic 1 as soon as that PTD execution is completed.
...
///Field `ISO_DONE` writer - The bit corresponding to a certain PTD will be set to logic 1 as soon as that PTD execution is completed.
...
///`read()` method returns [iso_ptd_done_map::R](R) reader structure
impl crate::Readable for ISO_PTD_DONE_MAP_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [iso_ptd_done_map::W](W) writer structure
impl crate::Writable for ISO_PTD_DONE_MAP_SPEC {
    type Writer = W;
}
///`reset()` method sets ISO_PTD_DONE_MAP to value 0
