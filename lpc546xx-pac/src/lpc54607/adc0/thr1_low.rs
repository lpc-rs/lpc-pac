...
///`read()` method returns [thr1_low::R](R) reader structure
impl crate::Readable for THR1_LOW_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [thr1_low::W](W) writer structure
impl crate::Writable for THR1_LOW_SPEC {
    type Writer = W;
}
///`reset()` method sets THR1_LOW to value 0
