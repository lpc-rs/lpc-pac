...
///Field `LOWZ` reader - Noise envelope estimator value.
...
///`read()` method returns [hwvadlowz::R](R) reader structure
impl crate::Readable for HWVADLOWZ_SPEC {
    type Reader = R;
}
///`reset()` method sets HWVADLOWZ to value 0
