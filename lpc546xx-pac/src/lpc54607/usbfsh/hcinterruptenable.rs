///Register `HCINTERRUPTENABLE` reader
...
///Register `HCINTERRUPTENABLE` writer
...
///Field `MIE` reader - Master Interrupt Enable.
...
///Field `MIE` writer - Master Interrupt Enable.
pub struct MIE_W<'a> {
    w: &'a mut W,
}
impl<'a> MIE_W<'a> {
...
///`read()` method returns [hcinterruptenable::R](R) reader structure
impl crate::Readable for HCINTERRUPTENABLE_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [hcinterruptenable::W](W) writer structure
impl crate::Writable for HCINTERRUPTENABLE_SPEC {
    type Writer = W;
}
///`reset()` method sets HCINTERRUPTENABLE to value 0
