...
///Field `INP_N` reader - Input number to SCT0 inputs 0 to 6..
...
///Field `INP_N` writer - Input number to SCT0 inputs 0 to 6..
...
///`read()` method returns [sct0_inmux::R](R) reader structure
impl crate::Readable for SCT0_INMUX_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [sct0_inmux::W](W) writer structure
impl crate::Writable for SCT0_INMUX_SPEC {
    type Writer = W;
}
///`reset()` method sets SCT0_INMUX[%s]
///to value 0x1f
