...
///Field `DLMSB` reader - The SCIn Divisor Latch MSB Register, along with the DLL register, determines the baud rate of the SCIn.
...
///Field `DLMSB` writer - The SCIn Divisor Latch MSB Register, along with the DLL register, determines the baud rate of the SCIn.
...
///`read()` method returns [dlm_ier_dlm::R](R) reader structure
impl crate::Readable for DLM_IER_DLM_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [dlm_ier_dlm::W](W) writer structure
