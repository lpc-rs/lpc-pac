...
///Field `SCIEN` reader - Smart Card Interface Enable.
...
///Field `SCIEN` writer - Smart Card Interface Enable.
...
///Field `NACKDIS` reader - NACK response disable.
...
///Field `NACKDIS` writer - NACK response disable.
...
///Field `PROTSEL` reader - Protocol selection as defined in the ISO7816-3 standard.
...
///Field `PROTSEL` writer - Protocol selection as defined in the ISO7816-3 standard.
...
///Field `TXRETRY` reader - Maximum number of retransmissions in case of a negative acknowledge (protocol T=0).
...
///Field `TXRETRY` writer - Maximum number of retransmissions in case of a negative acknowledge (protocol T=0).
...
///Field `GUARDTIME` reader - Extra guard time.
...
///Field `GUARDTIME` writer - Extra guard time.
...
///`read()` method returns [scictrl::R](R) reader structure
impl crate::Readable for SCICTRL_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [scictrl::W](W) writer structure
impl crate::Writable for SCICTRL_SPEC {
    type Writer = W;
}
///`reset()` method sets SCICTRL to value 0
