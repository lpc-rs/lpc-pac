...
///Field `TI` reader - Transmit Interrupt Enable.
...
///Field `TI` writer - Transmit Interrupt Enable.
pub struct TI_W<'a> {
    w: &'a mut W,
}
impl<'a> TI_W<'a> {
...
///Field `RI` reader - Receive Interrupt Enable.
...
///Field `RI` writer - Receive Interrupt Enable.
pub struct RI_W<'a> {
    w: &'a mut W,
}
impl<'a> RI_W<'a> {
...
///Field `FBE` reader - Fatal Bus Error Enable.
...
///Field `FBE` writer - Fatal Bus Error Enable.
pub struct FBE_W<'a> {
    w: &'a mut W,
}
impl<'a> FBE_W<'a> {
...
///Field `DU` reader - Descriptor Unavailable Interrupt.
...
///Field `DU` writer - Descriptor Unavailable Interrupt.
pub struct DU_W<'a> {
    w: &'a mut W,
}
impl<'a> DU_W<'a> {
...
///Field `CES` reader - Card Error summary Interrupt Enable.
...
///Field `CES` writer - Card Error summary Interrupt Enable.
pub struct CES_W<'a> {
    w: &'a mut W,
}
impl<'a> CES_W<'a> {
...
///Field `NIS` reader - Normal Interrupt Summary Enable.
...
///Field `NIS` writer - Normal Interrupt Summary Enable.
pub struct NIS_W<'a> {
    w: &'a mut W,
}
impl<'a> NIS_W<'a> {
...
///Field `AIS` reader - Abnormal Interrupt Summary Enable.
...
///Field `AIS` writer - Abnormal Interrupt Summary Enable.
pub struct AIS_W<'a> {
    w: &'a mut W,
}
impl<'a> AIS_W<'a> {
