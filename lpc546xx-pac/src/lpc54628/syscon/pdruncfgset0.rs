...
///`read()` method returns [pdruncfgset0::R](R) reader structure
impl crate::Readable for PDRUNCFGSET0_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pdruncfgset0::W](W) writer structure
impl crate::Writable for PDRUNCFGSET0_SPEC {
    type Writer = W;
}
///`reset()` method sets PDRUNCFGSET0 to value 0
