...
///Field `LCD` reader - Enables the clock for the LCD interface.
...
///Field `LCD` writer - Enables the clock for the LCD interface.
pub struct LCD_W<'a> {
    w: &'a mut W,
}
impl<'a> LCD_W<'a> {
...
///Field `SDIO` reader - Enables the clock for the SDIO interface.
...
///Field `SDIO` writer - Enables the clock for the SDIO interface.
pub struct SDIO_W<'a> {
    w: &'a mut W,
}
impl<'a> SDIO_W<'a> {
...
///Field `USB1H` reader - Enables the clock for the USB1 host interface.
...
///Field `USB1H` writer - Enables the clock for the USB1 host interface.
...
///Field `USB1D` reader - Enables the clock for the USB1 device interface.
...
///Field `USB1D` writer - Enables the clock for the USB1 device interface.
...
///Field `USB1RAM` reader - Enables the clock for the USB1 RAM interface.
...
///Field `USB1RAM` writer - Enables the clock for the USB1 RAM interface.
...
///Field `EMC` reader - Enables the clock for the EMC interface.
...
///Field `EMC` writer - Enables the clock for the EMC interface.
pub struct EMC_W<'a> {
    w: &'a mut W,
}
impl<'a> EMC_W<'a> {
...
///Field `ETH` reader - Enables the clock for the ethernet interface.
...
///Field `ETH` writer - Enables the clock for the ethernet interface.
pub struct ETH_W<'a> {
    w: &'a mut W,
}
impl<'a> ETH_W<'a> {
...
///Field `GPIO4` reader - Enables the clock for the GPIO4 interface.
...
///Field `GPIO4` writer - Enables the clock for the GPIO4 interface.
...
///Field `GPIO5` reader - Enables the clock for the GPIO5 interface.
...
///Field `GPIO5` writer - Enables the clock for the GPIO5 interface.
...
///Field `AES` reader - Enables the clock for the AES interface.
...
///Field `AES` writer - Enables the clock for the AES interface.
pub struct AES_W<'a> {
    w: &'a mut W,
}
impl<'a> AES_W<'a> {
...
///Field `OTP` reader - Enables the clock for the OTP interface.
...
///Field `OTP` writer - Enables the clock for the OTP interface.
pub struct OTP_W<'a> {
    w: &'a mut W,
}
impl<'a> OTP_W<'a> {
...
///Field `RNG` reader - Enables the clock for the RNG interface.
...
///Field `RNG` writer - Enables the clock for the RNG interface.
pub struct RNG_W<'a> {
    w: &'a mut W,
}
impl<'a> RNG_W<'a> {
...
///Field `FLEXCOMM8` reader - Enables the clock for the Flexcomm8 interface.
...
///Field `FLEXCOMM8` writer - Enables the clock for the Flexcomm8 interface.
...
///Field `FLEXCOMM9` reader - Enables the clock for the Flexcomm9 interface.
...
///Field `FLEXCOMM9` writer - Enables the clock for the Flexcomm9 interface.
...
///Field `USB0HMR` reader - Enables the clock for the USB host master interface.
...
///Field `USB0HMR` writer - Enables the clock for the USB host master interface.
...
///Field `USB0HSL` reader - Enables the clock for the USB host slave interface.
...
///Field `USB0HSL` writer - Enables the clock for the USB host slave interface.
...
///Field `SHA0` reader - Enables the clock for the SHA interface.
...
///Field `SHA0` writer - Enables the clock for the SHA interface.
pub struct SHA0_W<'a> {
    w: &'a mut W,
}
impl<'a> SHA0_W<'a> {
...
///Field `SC0` reader - Enables the clock for the Smart card0 interface.
...
///Field `SC0` writer - Enables the clock for the Smart card0 interface.
pub struct SC0_W<'a> {
    w: &'a mut W,
}
impl<'a> SC0_W<'a> {
...
///Field `SC1` reader - Enables the clock for the Smart card1 interface.
...
///Field `SC1` writer - Enables the clock for the Smart card1 interface.
pub struct SC1_W<'a> {
    w: &'a mut W,
}
impl<'a> SC1_W<'a> {
...
///`read()` method returns [ahbclkctrl2::R](R) reader structure
impl crate::Readable for AHBCLKCTRL2_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [ahbclkctrl2::W](W) writer structure
impl crate::Writable for AHBCLKCTRL2_SPEC {
    type Writer = W;
}
///`reset()` method sets AHBCLKCTRL2 to value 0
