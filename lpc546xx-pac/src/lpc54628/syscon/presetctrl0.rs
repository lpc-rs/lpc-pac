...
///Field `FLASH_RST` reader - Flash controller reset control. 0 = Clear reset to this function. 1 = Assert reset to this function.
...
///Field `FLASH_RST` writer - Flash controller reset control. 0 = Clear reset to this function. 1 = Assert reset to this function.
...
///Field `FMC_RST` reader - Flash accelerator reset control. Note that the FMC must not be reset while executing from flash, and must be reconfigured after reset. 0 = Clear reset to this function. 1 = Assert reset to this function.
...
///Field `FMC_RST` writer - Flash accelerator reset control. Note that the FMC must not be reset while executing from flash, and must be reconfigured after reset. 0 = Clear reset to this function. 1 = Assert reset to this function.
...
///Field `EEPROM_RST` reader - EEPROM reset control.
...
///Field `EEPROM_RST` writer - EEPROM reset control.
...
///Field `SPIFI_RST` reader - SPIFI reset control.
...
///Field `SPIFI_RST` writer - SPIFI reset control.
...
///Field `MUX_RST` reader - Input mux reset control. 0 = Clear reset to this function. 1 = Assert reset to this function.
...
///Field `MUX_RST` writer - Input mux reset control. 0 = Clear reset to this function. 1 = Assert reset to this function.
...
///Field `IOCON_RST` reader - IOCON reset control. 0 = Clear reset to this function. 1 = Assert reset to this function.
...
///Field `IOCON_RST` writer - IOCON reset control. 0 = Clear reset to this function. 1 = Assert reset to this function.
...
///Field `GPIO0_RST` reader - GPIO0 reset control. 0 = Clear reset to this function. 1 = Assert reset to this function.
...
///Field `GPIO0_RST` writer - GPIO0 reset control. 0 = Clear reset to this function. 1 = Assert reset to this function.
...
///Field `GPIO1_RST` reader - GPIO1 reset control. 0 = Clear reset to this function. 1 = Assert reset to this function.
...
///Field `GPIO1_RST` writer - GPIO1 reset control. 0 = Clear reset to this function. 1 = Assert reset to this function.
...
///Field `GPIO2_RST` reader - GPIO2 reset control.
...
///Field `GPIO2_RST` writer - GPIO2 reset control.
...
///Field `GPIO3_RST` reader - GPIO3 reset control.
...
///Field `GPIO3_RST` writer - GPIO3 reset control.
...
///Field `PINT_RST` reader - Pin interrupt (PINT) reset control. 0 = Clear reset to this function. 1 = Assert reset to this function.
...
///Field `PINT_RST` writer - Pin interrupt (PINT) reset control. 0 = Clear reset to this function. 1 = Assert reset to this function.
...
///Field `GINT_RST` reader - Grouped interrupt (GINT) reset control. 0 = Clear reset to this function. 1 = Assert reset to this function.
...
///Field `GINT_RST` writer - Grouped interrupt (GINT) reset control. 0 = Clear reset to this function. 1 = Assert reset to this function.
...
///Field `DMA0_RST` reader - DMA0 reset control. 0 = Clear reset to this function. 1 = Assert reset to this function.
...
///Field `DMA0_RST` writer - DMA0 reset control. 0 = Clear reset to this function. 1 = Assert reset to this function.
...
///Field `CRC_RST` reader - CRC generator reset control. 0 = Clear reset to this function. 1 = Assert reset to this function.
...
///Field `CRC_RST` writer - CRC generator reset control. 0 = Clear reset to this function. 1 = Assert reset to this function.
...
///Field `WWDT_RST` reader - Watchdog timer reset control. 0 = Clear reset to this function. 1 = Assert reset to this function.
...
///Field `WWDT_RST` writer - Watchdog timer reset control. 0 = Clear reset to this function. 1 = Assert reset to this function.
...
///Field `ADC0_RST` reader - ADC0 reset control. 0 = Clear reset to this function. 1 = Assert reset to this function.
...
///Field `ADC0_RST` writer - ADC0 reset control. 0 = Clear reset to this function. 1 = Assert reset to this function.
...
///`read()` method returns [presetctrl0::R](R) reader structure
impl crate::Readable for PRESETCTRL0_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [presetctrl0::W](W) writer structure
impl crate::Writable for PRESETCTRL0_SPEC {
    type Writer = W;
}
///`reset()` method sets PRESETCTRL0 to value 0
