///Register `LCDCLKDIV` reader
pub struct R(crate::R<LCDCLKDIV_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<LCDCLKDIV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<LCDCLKDIV_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<LCDCLKDIV_SPEC>) -> Self {
        R(reader)
    }
}
///Register `LCDCLKDIV` writer
pub struct W(crate::W<LCDCLKDIV_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<LCDCLKDIV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<LCDCLKDIV_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<LCDCLKDIV_SPEC>) -> Self {
        W(writer)
    }
}
...
///
///For information about available fields see [lcdclkdiv](index.html) module
pub struct LCDCLKDIV_SPEC;
impl crate::RegisterSpec for LCDCLKDIV_SPEC {
    type Ux = u32;
}
///`read()` method returns [lcdclkdiv::R](R) reader structure
impl crate::Readable for LCDCLKDIV_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [lcdclkdiv::W](W) writer structure
impl crate::Writable for LCDCLKDIV_SPEC {
    type Writer = W;
}
///`reset()` method sets LCDCLKDIV to value 0x4000_0000
impl crate::Resettable for LCDCLKDIV_SPEC {
    #[inline(always)]
