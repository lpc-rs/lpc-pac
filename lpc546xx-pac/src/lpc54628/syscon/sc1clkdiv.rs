///Register `SC1CLKDIV` reader
pub struct R(crate::R<SC1CLKDIV_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SC1CLKDIV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SC1CLKDIV_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SC1CLKDIV_SPEC>) -> Self {
        R(reader)
    }
}
///Register `SC1CLKDIV` writer
pub struct W(crate::W<SC1CLKDIV_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SC1CLKDIV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SC1CLKDIV_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SC1CLKDIV_SPEC>) -> Self {
        W(writer)
    }
}
...
///
///For information about available fields see [sc1clkdiv](index.html) module
pub struct SC1CLKDIV_SPEC;
impl crate::RegisterSpec for SC1CLKDIV_SPEC {
    type Ux = u32;
}
///`read()` method returns [sc1clkdiv::R](R) reader structure
impl crate::Readable for SC1CLKDIV_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [sc1clkdiv::W](W) writer structure
impl crate::Writable for SC1CLKDIV_SPEC {
    type Writer = W;
}
///`reset()` method sets SC1CLKDIV to value 0x4000_0000
impl crate::Resettable for SC1CLKDIV_SPEC {
    #[inline(always)]
