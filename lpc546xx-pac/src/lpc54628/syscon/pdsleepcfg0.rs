...
impl From<crate::R<PDSLEEPCFG0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PDSLEEPCFG0_SPEC>) -> Self {
        R(reader)
    }
}
///Register `PDSLEEPCFG0` writer
...
impl From<crate::W<PDSLEEPCFG0_SPEC>> for W {
    #[inline(always)]
...
///`read()` method returns [pdsleepcfg0::R](R) reader structure
impl crate::Readable for PDSLEEPCFG0_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pdsleepcfg0::W](W) writer structure
impl crate::Writable for PDSLEEPCFG0_SPEC {
    type Writer = W;
}
///`reset()` method sets PDSLEEPCFG0 to value 0x00f8_1f40
