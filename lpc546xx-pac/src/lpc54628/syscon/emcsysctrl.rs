...
///Field `EMCSC` reader - EMC Shift Control.
...
///Field `EMCSC` writer - EMC Shift Control.
...
///Field `EMCRD` reader - EMC Reset Disable.
...
///Field `EMCRD` writer - EMC Reset Disable.
...
///Field `EMCBC` reader - External Memory Controller burst control.
...
///Field `EMCBC` writer - External Memory Controller burst control.
...
///Field `EMCFBCLKINSEL` reader - External Memory Controller clock select.
...
///Field `EMCFBCLKINSEL` writer - External Memory Controller clock select.
...
///`read()` method returns [emcsysctrl::R](R) reader structure
impl crate::Readable for EMCSYSCTRL_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [emcsysctrl::W](W) writer structure
impl crate::Writable for EMCSYSCTRL_SPEC {
    type Writer = W;
}
///`reset()` method sets EMCSYSCTRL to value 0x01
