...
///`read()` method returns [clkoutdiv::R](R) reader structure
impl crate::Readable for CLKOUTDIV_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [clkoutdiv::W](W) writer structure
impl crate::Writable for CLKOUTDIV_SPEC {
    type Writer = W;
}
///`reset()` method sets CLKOUTDIV to value 0x4000_0000
