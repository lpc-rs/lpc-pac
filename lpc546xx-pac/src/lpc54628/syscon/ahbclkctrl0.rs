...
///Field `ROM` reader - Enables the clock for the Boot ROM. 0 = Disable; 1 = Enable.
...
///Field `ROM` writer - Enables the clock for the Boot ROM. 0 = Disable; 1 = Enable.
pub struct ROM_W<'a> {
    w: &'a mut W,
}
impl<'a> ROM_W<'a> {
...
///Field `SRAM1` reader - Enables the clock for SRAM1. 0 = Disable; 1 = Enable.
...
///Field `SRAM1` writer - Enables the clock for SRAM1. 0 = Disable; 1 = Enable.
...
///Field `SRAM2` reader - Enables the clock for SRAM2. 0 = Disable; 1 = Enable.
...
///Field `SRAM2` writer - Enables the clock for SRAM2. 0 = Disable; 1 = Enable.
...
///Field `SRAM3` reader - Enables the clock for SRAM3.
...
///Field `SRAM3` writer - Enables the clock for SRAM3.
...
///Field `FLASH` reader - Enables the clock for the flash controller. 0 = Disable; 1 = Enable. This clock is needed for flash programming, not for flash read.
...
///Field `FLASH` writer - Enables the clock for the flash controller. 0 = Disable; 1 = Enable. This clock is needed for flash programming, not for flash read.
...
///Field `FMC` reader - Enables the clock for the Flash accelerator. 0 = Disable; 1 = Enable. This clock is needed if the flash is being read.
...
///Field `FMC` writer - Enables the clock for the Flash accelerator. 0 = Disable; 1 = Enable. This clock is needed if the flash is being read.
pub struct FMC_W<'a> {
    w: &'a mut W,
}
impl<'a> FMC_W<'a> {
...
///Field `EEPROM` reader - Enables the clock for EEPROM.
...
///Field `EEPROM` writer - Enables the clock for EEPROM.
...
///Field `SPIFI` reader - Enables the clock for the SPIFI. 0 = Disable; 1 = Enable.
...
///Field `SPIFI` writer - Enables the clock for the SPIFI. 0 = Disable; 1 = Enable.
...
///Field `INPUTMUX` reader - Enables the clock for the input muxes. 0 = Disable; 1 = Enable.
...
///Field `INPUTMUX` writer - Enables the clock for the input muxes. 0 = Disable; 1 = Enable.
...
///Field `IOCON` reader - Enables the clock for the IOCON block. 0 = Disable; 1 = Enable.
...
///Field `IOCON` writer - Enables the clock for the IOCON block. 0 = Disable; 1 = Enable.
...
///Field `GPIO0` reader - Enables the clock for the GPIO0 port registers. 0 = Disable; 1 = Enable.
...
///Field `GPIO0` writer - Enables the clock for the GPIO0 port registers. 0 = Disable; 1 = Enable.
...
///Field `GPIO1` reader - Enables the clock for the GPIO1 port registers. 0 = Disable; 1 = Enable.
...
///Field `GPIO1` writer - Enables the clock for the GPIO1 port registers. 0 = Disable; 1 = Enable.
...
///Field `GPIO2` reader - Enables the clock for the GPIO2 port registers.
...
///Field `GPIO2` writer - Enables the clock for the GPIO2 port registers.
...
///Field `GPIO3` reader - Enables the clock for the GPIO3 port registers.
...
///Field `GPIO3` writer - Enables the clock for the GPIO3 port registers.
...
///Field `PINT` reader - Enables the clock for the pin interrupt block.0 = Disable; 1 = Enable.
...
///Field `PINT` writer - Enables the clock for the pin interrupt block.0 = Disable; 1 = Enable.
pub struct PINT_W<'a> {
    w: &'a mut W,
}
impl<'a> PINT_W<'a> {
...
///Field `GINT` reader - Enables the clock for the grouped pin interrupt block. 0 = Disable; 1 = Enable.
...
///Field `GINT` writer - Enables the clock for the grouped pin interrupt block. 0 = Disable; 1 = Enable.
pub struct GINT_W<'a> {
    w: &'a mut W,
}
impl<'a> GINT_W<'a> {
...
///Field `DMA` reader - Enables the clock for the DMA controller. 0 = Disable; 1 = Enable.
...
///Field `DMA` writer - Enables the clock for the DMA controller. 0 = Disable; 1 = Enable.
pub struct DMA_W<'a> {
    w: &'a mut W,
}
impl<'a> DMA_W<'a> {
...
///Field `CRC` reader - Enables the clock for the CRC engine. 0 = Disable; 1 = Enable.
...
///Field `CRC` writer - Enables the clock for the CRC engine. 0 = Disable; 1 = Enable.
pub struct CRC_W<'a> {
    w: &'a mut W,
}
impl<'a> CRC_W<'a> {
...
///Field `WWDT` reader - Enables the clock for the Watchdog Timer. 0 = Disable; 1 = Enable.
...
///Field `WWDT` writer - Enables the clock for the Watchdog Timer. 0 = Disable; 1 = Enable.
pub struct WWDT_W<'a> {
    w: &'a mut W,
}
impl<'a> WWDT_W<'a> {
...
///Field `RTC` reader - Enables the bus clock for the RTC. 0 = Disable; 1 = Enable.
...
///Field `RTC` writer - Enables the bus clock for the RTC. 0 = Disable; 1 = Enable.
pub struct RTC_W<'a> {
    w: &'a mut W,
}
impl<'a> RTC_W<'a> {
...
///Field `ADC0` reader - Enables the clock for the ADC0 register interface.
...
///Field `ADC0` writer - Enables the clock for the ADC0 register interface.
pub struct ADC0_W<'a> {
    w: &'a mut W,
}
impl<'a> ADC0_W<'a> {
...
///`read()` method returns [ahbclkctrl0::R](R) reader structure
impl crate::Readable for AHBCLKCTRL0_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [ahbclkctrl0::W](W) writer structure
impl crate::Writable for AHBCLKCTRL0_SPEC {
    type Writer = W;
}
///`reset()` method sets AHBCLKCTRL0 to value 0x0183
