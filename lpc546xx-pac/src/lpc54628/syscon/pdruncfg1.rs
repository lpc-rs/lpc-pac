...
impl From<crate::R<PDRUNCFG1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PDRUNCFG1_SPEC>) -> Self {
        R(reader)
    }
}
///Register `PDRUNCFG1` writer
...
impl From<crate::W<PDRUNCFG1_SPEC>> for W {
    #[inline(always)]
...
///`read()` method returns [pdruncfg1::R](R) reader structure
impl crate::Readable for PDRUNCFG1_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pdruncfg1::W](W) writer structure
impl crate::Writable for PDRUNCFG1_SPEC {
    type Writer = W;
}
///`reset()` method sets PDRUNCFG1 to value 0x14f8_1f40
