...
///Field `Minor_Rev` reader - Minor revision of module implementation, starting at 0.
...
///Field `Major_Rev` reader - Major revision of module implementation, starting at 0.
...
///Field `ID` reader - Unique module identifier for this IP block.
...
///`reset()` method sets ID to value 0xe090_0000
