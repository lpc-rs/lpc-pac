///Register `ASYNCPRESETCTRL` reader
...
///Register `ASYNCPRESETCTRL` writer
...
///Field `CTIMER3` reader - Standard counter/timer CTIMER3 reset control. 0 = Clear reset to this function. 1 = Assert reset to this function.
...
///Field `CTIMER3` writer - Standard counter/timer CTIMER3 reset control. 0 = Clear reset to this function. 1 = Assert reset to this function.
...
///Field `CTIMER4` reader - Standard counter/timer CTIMER4 reset control. 0 = Clear reset to this function. 1 = Assert reset to this function.
...
///Field `CTIMER4` writer - Standard counter/timer CTIMER4 reset control. 0 = Clear reset to this function. 1 = Assert reset to this function.
...
///`read()` method returns [asyncpresetctrl::R](R) reader structure
impl crate::Readable for ASYNCPRESETCTRL_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [asyncpresetctrl::W](W) writer structure
impl crate::Writable for ASYNCPRESETCTRL_SPEC {
    type Writer = W;
}
///`reset()` method sets ASYNCPRESETCTRL to value 0
