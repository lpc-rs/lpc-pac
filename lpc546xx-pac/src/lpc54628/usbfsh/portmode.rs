...
///Field `ID` reader - Port ID pin value.
...
///Field `ID` writer - Port ID pin value.
pub struct ID_W<'a> {
    w: &'a mut W,
}
impl<'a> ID_W<'a> {
...
///Field `ID_EN` reader - Port ID pin pull-up enable.
...
///Field `ID_EN` writer - Port ID pin pull-up enable.
...
///Field `DEV_ENABLE` reader - 1: device 0: host.
...
///Field `DEV_ENABLE` writer - 1: device 0: host.
...
///`reset()` method sets PORTMODE to value 0
