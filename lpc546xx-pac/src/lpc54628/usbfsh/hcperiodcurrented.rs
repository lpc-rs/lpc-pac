///Register `HCPERIODCURRENTED` reader
...
///Register `HCPERIODCURRENTED` writer
...
///Field `PCED` reader - The content of this register is updated by HC after a periodic ED is processed.
...
///Field `PCED` writer - The content of this register is updated by HC after a periodic ED is processed.
pub struct PCED_W<'a> {
    w: &'a mut W,
}
impl<'a> PCED_W<'a> {
...
///`read()` method returns [hcperiodcurrented::R](R) reader structure
impl crate::Readable for HCPERIODCURRENTED_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [hcperiodcurrented::W](W) writer structure
impl crate::Writable for HCPERIODCURRENTED_SPEC {
    type Writer = W;
}
///`reset()` method sets HCPERIODCURRENTED to value 0
