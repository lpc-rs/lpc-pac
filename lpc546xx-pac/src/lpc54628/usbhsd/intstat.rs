...
///Field `EP0OUT` reader - Interrupt status register bit for the Control EP0 OUT direction.
...
///Field `EP0OUT` writer - Interrupt status register bit for the Control EP0 OUT direction.
...
///Field `EP0IN` reader - Interrupt status register bit for the Control EP0 IN direction.
...
///Field `EP0IN` writer - Interrupt status register bit for the Control EP0 IN direction.
...
///Field `EP1OUT` reader - Interrupt status register bit for the EP1 OUT direction.
...
///Field `EP1OUT` writer - Interrupt status register bit for the EP1 OUT direction.
...
///Field `EP1IN` reader - Interrupt status register bit for the EP1 IN direction.
...
///Field `EP1IN` writer - Interrupt status register bit for the EP1 IN direction.
...
///Field `EP2OUT` reader - Interrupt status register bit for the EP2 OUT direction.
...
///Field `EP2OUT` writer - Interrupt status register bit for the EP2 OUT direction.
...
///Field `EP2IN` reader - Interrupt status register bit for the EP2 IN direction.
...
///Field `EP2IN` writer - Interrupt status register bit for the EP2 IN direction.
...
///Field `EP3OUT` reader - Interrupt status register bit for the EP3 OUT direction.
...
///Field `EP3OUT` writer - Interrupt status register bit for the EP3 OUT direction.
...
///Field `EP3IN` reader - Interrupt status register bit for the EP3 IN direction.
...
///Field `EP3IN` writer - Interrupt status register bit for the EP3 IN direction.
...
///Field `EP4OUT` reader - Interrupt status register bit for the EP4 OUT direction.
...
///Field `EP4OUT` writer - Interrupt status register bit for the EP4 OUT direction.
...
///Field `EP4IN` reader - Interrupt status register bit for the EP4 IN direction.
...
///Field `EP4IN` writer - Interrupt status register bit for the EP4 IN direction.
...
///Field `EP5OUT` reader - Interrupt status register bit for the EP5 OUT direction.
...
///Field `EP5OUT` writer - Interrupt status register bit for the EP5 OUT direction.
...
///Field `EP5IN` reader - Interrupt status register bit for the EP5 IN direction.
...
///Field `EP5IN` writer - Interrupt status register bit for the EP5 IN direction.
...
///Field `FRAME_INT` reader - Frame interrupt.
...
///Field `FRAME_INT` writer - Frame interrupt.
...
///Field `DEV_INT` reader - Device status interrupt.
...
///Field `DEV_INT` writer - Device status interrupt.
