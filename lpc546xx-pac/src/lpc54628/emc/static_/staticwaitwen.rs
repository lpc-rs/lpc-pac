...
///Field `WAITWEN` reader - Wait write enable.
...
///Field `WAITWEN` writer - Wait write enable.
...
///`read()` method returns [staticwaitwen::R](R) reader structure
impl crate::Readable for STATICWAITWEN_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [staticwaitwen::W](W) writer structure
impl crate::Writable for STATICWAITWEN_SPEC {
    type Writer = W;
}
///`reset()` method sets STATICWAITWEN to value 0
