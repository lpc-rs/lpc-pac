...
///`read()` method returns [staticwaitrd::R](R) reader structure
impl crate::Readable for STATICWAITRD_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [staticwaitrd::W](W) writer structure
impl crate::Writable for STATICWAITRD_SPEC {
    type Writer = W;
}
///`reset()` method sets STATICWAITRD to value 0x1f
