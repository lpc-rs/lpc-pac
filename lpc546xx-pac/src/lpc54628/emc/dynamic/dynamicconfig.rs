...
///Field `AM0` reader - See Table 933.
...
///Field `AM0` writer - See Table 933.
pub struct AM0_W<'a> {
    w: &'a mut W,
}
impl<'a> AM0_W<'a> {
...
///Field `AM1` reader - See Table 933.
...
///Field `AM1` writer - See Table 933.
pub struct AM1_W<'a> {
    w: &'a mut W,
}
impl<'a> AM1_W<'a> {
...
///`read()` method returns [dynamicconfig::R](R) reader structure
impl crate::Readable for DYNAMICCONFIG_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [dynamicconfig::W](W) writer structure
impl crate::Writable for DYNAMICCONFIG_SPEC {
    type Writer = W;
}
///`reset()` method sets DYNAMICCONFIG to value 0
