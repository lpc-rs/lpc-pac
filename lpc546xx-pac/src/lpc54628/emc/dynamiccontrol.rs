///Register `DYNAMICCONTROL` reader
...
///Register `DYNAMICCONTROL` writer
...
///Field `CE` reader - Dynamic memory clock enable.
...
///Field `CE` writer - Dynamic memory clock enable.
pub struct CE_W<'a> {
    w: &'a mut W,
}
impl<'a> CE_W<'a> {
...
///Field `CS` reader - Dynamic memory clock control.
...
///Field `CS` writer - Dynamic memory clock control.
pub struct CS_W<'a> {
    w: &'a mut W,
}
impl<'a> CS_W<'a> {
...
///Field `SR` reader - Self-refresh request, EMCSREFREQ.
...
///Field `SR` writer - Self-refresh request, EMCSREFREQ.
pub struct SR_W<'a> {
    w: &'a mut W,
}
impl<'a> SR_W<'a> {
...
///Field `MMC` reader - Memory clock control.
...
///Field `MMC` writer - Memory clock control.
pub struct MMC_W<'a> {
    w: &'a mut W,
}
impl<'a> MMC_W<'a> {
...
///Field `I` reader - SDRAM initialization.
...
///Field `I` writer - SDRAM initialization.
pub struct I_W<'a> {
    w: &'a mut W,
}
impl<'a> I_W<'a> {
...
///`read()` method returns [dynamiccontrol::R](R) reader structure
impl crate::Readable for DYNAMICCONTROL_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [dynamiccontrol::W](W) writer structure
impl crate::Writable for DYNAMICCONTROL_SPEC {
    type Writer = W;
}
///`reset()` method sets DYNAMICCONTROL to value 0x06
