...
///Field `PWRDWN` reader - Power down mode bit.
...
///Field `PWRDWN` writer - Power down mode bit.
...
///`read()` method returns [pwrdwn::R](R) reader structure
impl crate::Readable for PWRDWN_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pwrdwn::W](W) writer structure
impl crate::Writable for PWRDWN_SPEC {
    type Writer = W;
}
///`reset()` method sets PWRDWN to value 0
