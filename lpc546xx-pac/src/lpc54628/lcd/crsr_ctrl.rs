...
///Field `CRSRON` reader - Cursor enable.
...
///Field `CRSRON` writer - Cursor enable.
...
///Field `CRSRNUM1_0` reader - Cursor image number.
...
///Field `CRSRNUM1_0` writer - Cursor image number.
...
///`read()` method returns [crsr_ctrl::R](R) reader structure
impl crate::Readable for CRSR_CTRL_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [crsr_ctrl::W](W) writer structure
impl crate::Writable for CRSR_CTRL_SPEC {
    type Writer = W;
}
///`reset()` method sets CRSR_CTRL to value 0
