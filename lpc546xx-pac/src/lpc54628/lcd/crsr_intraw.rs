...
///Field `CRSRRIS` reader - Cursor raw interrupt status.
...
impl R {
    ///Bit 0 - Cursor raw interrupt status.
    #[inline(always)]
...
///`read()` method returns [crsr_intraw::R](R) reader structure
impl crate::Readable for CRSR_INTRAW_SPEC {
    type Reader = R;
}
///`reset()` method sets CRSR_INTRAW to value 0
