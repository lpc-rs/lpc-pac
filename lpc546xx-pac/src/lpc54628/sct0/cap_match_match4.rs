...
///`read()` method returns [cap_match_match4::R](R) reader structure
impl crate::Readable for CAP_MATCH_MATCH4_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [cap_match_match4::W](W) writer structure
impl crate::Writable for CAP_MATCH_MATCH4_SPEC {
    type Writer = W;
}
///`reset()` method sets MATCH4 to value 0
