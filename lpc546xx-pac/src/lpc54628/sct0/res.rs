...
pub enum O0RES_A {
    ///0: No change.
    NO_CHANGE = 0,
    ///1: Set output (or clear based on the SETCLR0 field in the OUTPUTDIRCTRL register).
    SET = 1,
    ///2: Clear output (or set based on the SETCLR0 field).
    CLEAR = 2,
    ///3: Toggle output.
    TOGGLE_OUTPUT = 3,
}
...
///Field `O0RES` reader - Effect of simultaneous set and clear on output 0.
...
///Field `O0RES` writer - Effect of simultaneous set and clear on output 0.
...
pub enum O1RES_A {
    ///0: No change.
    NO_CHANGE = 0,
    ///1: Set output (or clear based on the SETCLR1 field in the OUTPUTDIRCTRL register).
    SET = 1,
    ///2: Clear output (or set based on the SETCLR1 field).
    CLEAR = 2,
    ///3: Toggle output.
    TOGGLE_OUTPUT = 3,
}
...
///Field `O1RES` reader - Effect of simultaneous set and clear on output 1.
...
///Field `O1RES` writer - Effect of simultaneous set and clear on output 1.
...
pub enum O2RES_A {
    ///0: No change.
    NO_CHANGE = 0,
    ///1: Set output (or clear based on the SETCLR2 field in the OUTPUTDIRCTRL register).
    SET = 1,
    ///2: Clear output n (or set based on the SETCLR2 field).
    CLEAR = 2,
    ///3: Toggle output.
    TOGGLE_OUTPUT = 3,
}
...
///Field `O2RES` writer - Effect of simultaneous set and clear on output 2.
...
pub enum O3RES_A {
    ///0: No change.
    NO_CHANGE = 0,
    ///1: Set output (or clear based on the SETCLR3 field in the OUTPUTDIRCTRL register).
    SET = 1,
    ///2: Clear output (or set based on the SETCLR3 field).
    CLEAR = 2,
    ///3: Toggle output.
    TOGGLE_OUTPUT = 3,
}
...
///Field `O3RES` reader - Effect of simultaneous set and clear on output 3.
...
///Field `O3RES` writer - Effect of simultaneous set and clear on output 3.
...
pub enum O4RES_A {
    ///0: No change.
    NO_CHANGE = 0,
    ///1: Set output (or clear based on the SETCLR4 field in the OUTPUTDIRCTRL register).
    SET = 1,
    ///2: Clear output (or set based on the SETCLR4 field).
    CLEAR = 2,
    ///3: Toggle output.
    TOGGLE_OUTPUT = 3,
}
...
///Field `O4RES` reader - Effect of simultaneous set and clear on output 4.
...
///Field `O4RES` writer - Effect of simultaneous set and clear on output 4.
...
pub enum O5RES_A {
    ///0: No change.
    NO_CHANGE = 0,
    ///1: Set output (or clear based on the SETCLR5 field in the OUTPUTDIRCTRL register).
    SET = 1,
    ///2: Clear output (or set based on the SETCLR5 field).
    CLEAR = 2,
    ///3: Toggle output.
    TOGGLE_OUTPUT = 3,
}
...
///Field `O5RES` reader - Effect of simultaneous set and clear on output 5.
...
///Field `O5RES` writer - Effect of simultaneous set and clear on output 5.
...
pub enum O6RES_A {
    ///0: No change.
    NO_CHANGE = 0,
    ///1: Set output (or clear based on the SETCLR6 field in the OUTPUTDIRCTRL register).
    SET = 1,
    ///2: Clear output (or set based on the SETCLR6 field).
    CLEAR = 2,
    ///3: Toggle output.
    TOGGLE_OUTPUT = 3,
}
...
///Field `O6RES` reader - Effect of simultaneous set and clear on output 6.
...
///Field `O6RES` writer - Effect of simultaneous set and clear on output 6.
...
pub enum O7RES_A {
    ///0: No change.
    NO_CHANGE = 0,
    ///1: Set output (or clear based on the SETCLR7 field in the OUTPUTDIRCTRL register).
    SET = 1,
    ///2: Clear output n (or set based on the SETCLR7 field).
    CLEAR = 2,
    ///3: Toggle output.
    TOGGLE_OUTPUT = 3,
}
...
///Field `O7RES` reader - Effect of simultaneous set and clear on output 7.
...
///Field `O7RES` writer - Effect of simultaneous set and clear on output 7.
...
pub enum O8RES_A {
    ///0: No change.
    NO_CHANGE = 0,
    ///1: Set output (or clear based on the SETCLR8 field in the OUTPUTDIRCTRL register).
    SET = 1,
    ///2: Clear output (or set based on the SETCLR8 field).
    CLEAR = 2,
    ///3: Toggle output.
    TOGGLE_OUTPUT = 3,
}
...
///Field `O8RES` reader - Effect of simultaneous set and clear on output 8.
...
///Field `O8RES` writer - Effect of simultaneous set and clear on output 8.
...
pub enum O9RES_A {
    ///0: No change.
    NO_CHANGE = 0,
    ///1: Set output (or clear based on the SETCLR9 field in the OUTPUTDIRCTRL register).
    SET = 1,
    ///2: Clear output (or set based on the SETCLR9 field).
    CLEAR = 2,
    ///3: Toggle output.
    TOGGLE_OUTPUT = 3,
}
...
///Field `O9RES` reader - Effect of simultaneous set and clear on output 9.
...
///Field `O9RES` writer - Effect of simultaneous set and clear on output 9.
...
pub enum O10RES_A {
    ///0: No change.
    NO_CHANGE = 0,
    ///1: Set output (or clear based on the SETCLR10 field in the OUTPUTDIRCTRL register).
    SET = 1,
    ///2: Clear output (or set based on the SETCLR10 field).
    CLEAR = 2,
    ///3: Toggle output.
    TOGGLE_OUTPUT = 3,
}
...
///Field `O10RES` reader - Effect of simultaneous set and clear on output 10.
...
///Field `O10RES` writer - Effect of simultaneous set and clear on output 10.
...
pub enum O11RES_A {
    ///0: No change.
    NO_CHANGE = 0,
    ///1: Set output (or clear based on the SETCLR11 field in the OUTPUTDIRCTRL register).
    SET = 1,
    ///2: Clear output (or set based on the SETCLR11 field).
    CLEAR = 2,
    ///3: Toggle output.
    TOGGLE_OUTPUT = 3,
}
...
///Field `O11RES` reader - Effect of simultaneous set and clear on output 11.
...
///Field `O11RES` writer - Effect of simultaneous set and clear on output 11.
...
pub enum O12RES_A {
    ///0: No change.
    NO_CHANGE = 0,
    ///1: Set output (or clear based on the SETCLR12 field in the OUTPUTDIRCTRL register).
    SET = 1,
    ///2: Clear output (or set based on the SETCLR12 field).
    CLEAR = 2,
    ///3: Toggle output.
    TOGGLE_OUTPUT = 3,
}
...
///Field `O12RES` reader - Effect of simultaneous set and clear on output 12.
...
///Field `O12RES` writer - Effect of simultaneous set and clear on output 12.
...
pub enum O13RES_A {
    ///0: No change.
    NO_CHANGE = 0,
    ///1: Set output (or clear based on the SETCLR13 field in the OUTPUTDIRCTRL register).
    SET = 1,
    ///2: Clear output (or set based on the SETCLR13 field).
    CLEAR = 2,
    ///3: Toggle output.
    TOGGLE_OUTPUT = 3,
}
...
///Field `O13RES` reader - Effect of simultaneous set and clear on output 13.
...
///Field `O13RES` writer - Effect of simultaneous set and clear on output 13.
...
pub enum O14RES_A {
    ///0: No change.
    NO_CHANGE = 0,
    ///1: Set output (or clear based on the SETCLR14 field in the OUTPUTDIRCTRL register).
    SET = 1,
    ///2: Clear output (or set based on the SETCLR14 field).
    CLEAR = 2,
    ///3: Toggle output.
    TOGGLE_OUTPUT = 3,
}
...
///Field `O14RES` reader - Effect of simultaneous set and clear on output 14.
...
///Field `O14RES` writer - Effect of simultaneous set and clear on output 14.
...
///Field `O15RES` reader - Effect of simultaneous set and clear on output 15.
...
///Field `O15RES` writer - Effect of simultaneous set and clear on output 15.
...
///`read()` method returns [res::R](R) reader structure
impl crate::Readable for RES_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [res::W](W) writer structure
