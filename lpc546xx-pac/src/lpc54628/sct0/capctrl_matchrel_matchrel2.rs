///Register `MATCHREL2` reader
pub struct R(crate::R<CAPCTRL_MATCHREL_MATCHREL2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CAPCTRL_MATCHREL_MATCHREL2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CAPCTRL_MATCHREL_MATCHREL2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CAPCTRL_MATCHREL_MATCHREL2_SPEC>) -> Self {
        R(reader)
    }
}
///Register `MATCHREL2` writer
pub struct W(crate::W<CAPCTRL_MATCHREL_MATCHREL2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CAPCTRL_MATCHREL_MATCHREL2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CAPCTRL_MATCHREL_MATCHREL2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CAPCTRL_MATCHREL_MATCHREL2_SPEC>) -> Self {
        W(writer)
    }
}
...
///
///For information about available fields see [capctrl_matchrel_matchrel2](index.html) module
pub struct CAPCTRL_MATCHREL_MATCHREL2_SPEC;
impl crate::RegisterSpec for CAPCTRL_MATCHREL_MATCHREL2_SPEC {
    type Ux = u32;
}
///`read()` method returns [capctrl_matchrel_matchrel2::R](R) reader structure
impl crate::Readable for CAPCTRL_MATCHREL_MATCHREL2_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [capctrl_matchrel_matchrel2::W](W) writer structure
impl crate::Writable for CAPCTRL_MATCHREL_MATCHREL2_SPEC {
    type Writer = W;
}
///`reset()` method sets MATCHREL2 to value 0
impl crate::Resettable for CAPCTRL_MATCHREL_MATCHREL2_SPEC {
    #[inline(always)]
