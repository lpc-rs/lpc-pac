...
///Field `CENAF` writer - Ones written to this address clears bits in the IENF, thus disabling interrupts. Bit n clears bit n in the IENF register. 0 = No operation. 1 = LOW-active interrupt selected or falling edge interrupt disabled.
...
///`write(|w| ..)` method takes [cienf::W](W) writer structure
impl crate::Writable for CIENF_SPEC {
    type Writer = W;
}
///`reset()` method sets CIENF to value 0
