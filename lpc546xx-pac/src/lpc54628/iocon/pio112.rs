...
///`read()` method returns [pio112::R](R) reader structure
impl crate::Readable for PIO112_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio112::W](W) writer structure
impl crate::Writable for PIO112_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO112 to value 0x0320
