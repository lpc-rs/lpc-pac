...
///`read()` method returns [pio016::R](R) reader structure
impl crate::Readable for PIO016_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio016::W](W) writer structure
impl crate::Writable for PIO016_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO016 to value 0x0320
