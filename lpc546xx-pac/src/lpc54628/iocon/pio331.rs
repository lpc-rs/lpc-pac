...
///`read()` method returns [pio331::R](R) reader structure
impl crate::Readable for PIO331_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio331::W](W) writer structure
impl crate::Writable for PIO331_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO331 to value 0x0320
