...
///`read()` method returns [pio121::R](R) reader structure
impl crate::Readable for PIO121_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio121::W](W) writer structure
impl crate::Writable for PIO121_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO121 to value 0x0320
