...
///`read()` method returns [pio02::R](R) reader structure
impl crate::Readable for PIO02_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio02::W](W) writer structure
impl crate::Writable for PIO02_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO02 to value 0x0320
