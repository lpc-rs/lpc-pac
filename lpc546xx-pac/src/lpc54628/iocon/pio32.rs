...
///`read()` method returns [pio32::R](R) reader structure
impl crate::Readable for PIO32_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio32::W](W) writer structure
impl crate::Writable for PIO32_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO32 to value 0x0320
