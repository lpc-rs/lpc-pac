...
///`read()` method returns [pio424::R](R) reader structure
impl crate::Readable for PIO424_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio424::W](W) writer structure
impl crate::Writable for PIO424_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO424 to value 0x0320
