...
///`read()` method returns [pio218::R](R) reader structure
impl crate::Readable for PIO218_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio218::W](W) writer structure
impl crate::Writable for PIO218_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO218 to value 0x0320
