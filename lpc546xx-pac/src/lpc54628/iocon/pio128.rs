...
///`read()` method returns [pio128::R](R) reader structure
impl crate::Readable for PIO128_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio128::W](W) writer structure
impl crate::Writable for PIO128_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO128 to value 0x0320
