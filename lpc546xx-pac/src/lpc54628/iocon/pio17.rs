...
///`read()` method returns [pio17::R](R) reader structure
impl crate::Readable for PIO17_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio17::W](W) writer structure
impl crate::Writable for PIO17_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO17 to value 0x0320
