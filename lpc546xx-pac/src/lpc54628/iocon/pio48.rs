...
///`read()` method returns [pio48::R](R) reader structure
impl crate::Readable for PIO48_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio48::W](W) writer structure
impl crate::Writable for PIO48_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO48 to value 0x0320
