...
///`read()` method returns [pio511::R](R) reader structure
impl crate::Readable for PIO511_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio511::W](W) writer structure
impl crate::Writable for PIO511_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO511 to value 0x0320
