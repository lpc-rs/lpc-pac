...
///`read()` method returns [pio27::R](R) reader structure
impl crate::Readable for PIO27_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio27::W](W) writer structure
impl crate::Writable for PIO27_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO27 to value 0x0320
