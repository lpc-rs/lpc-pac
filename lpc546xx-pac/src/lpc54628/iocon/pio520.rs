...
///`read()` method returns [pio520::R](R) reader structure
impl crate::Readable for PIO520_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio520::W](W) writer structure
impl crate::Writable for PIO520_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO520 to value 0x0320
