...
///`read()` method returns [pio05::R](R) reader structure
impl crate::Readable for PIO05_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio05::W](W) writer structure
impl crate::Writable for PIO05_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO05 to value 0x0320
