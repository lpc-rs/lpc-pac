...
///`read()` method returns [pio425::R](R) reader structure
impl crate::Readable for PIO425_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio425::W](W) writer structure
impl crate::Writable for PIO425_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO425 to value 0x0320
