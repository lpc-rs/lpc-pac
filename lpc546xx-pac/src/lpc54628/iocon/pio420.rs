...
///`read()` method returns [pio420::R](R) reader structure
impl crate::Readable for PIO420_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio420::W](W) writer structure
impl crate::Writable for PIO420_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO420 to value 0x0320
