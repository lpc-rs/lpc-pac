...
///`read()` method returns [pio513::R](R) reader structure
impl crate::Readable for PIO513_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio513::W](W) writer structure
impl crate::Writable for PIO513_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO513 to value 0x0320
