...
///`read()` method returns [pio09::R](R) reader structure
impl crate::Readable for PIO09_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio09::W](W) writer structure
impl crate::Writable for PIO09_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO09 to value 0x0320
