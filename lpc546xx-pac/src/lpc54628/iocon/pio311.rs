...
///`read()` method returns [pio311::R](R) reader structure
impl crate::Readable for PIO311_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio311::W](W) writer structure
impl crate::Writable for PIO311_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO311 to value 0x0320
