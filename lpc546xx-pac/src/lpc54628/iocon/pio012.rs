...
///`read()` method returns [pio012::R](R) reader structure
impl crate::Readable for PIO012_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio012::W](W) writer structure
impl crate::Writable for PIO012_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO012 to value 0x0326
