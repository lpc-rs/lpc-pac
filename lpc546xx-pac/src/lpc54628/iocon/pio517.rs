...
///`read()` method returns [pio517::R](R) reader structure
impl crate::Readable for PIO517_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio517::W](W) writer structure
impl crate::Writable for PIO517_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO517 to value 0x0320
