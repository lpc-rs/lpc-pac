...
///`read()` method returns [pio026::R](R) reader structure
impl crate::Readable for PIO026_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio026::W](W) writer structure
impl crate::Writable for PIO026_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO026 to value 0x0320
