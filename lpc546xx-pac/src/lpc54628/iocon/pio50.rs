...
///`read()` method returns [pio50::R](R) reader structure
impl crate::Readable for PIO50_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio50::W](W) writer structure
impl crate::Writable for PIO50_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO50 to value 0x0320
