...
///`read()` method returns [pio215::R](R) reader structure
impl crate::Readable for PIO215_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio215::W](W) writer structure
impl crate::Writable for PIO215_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO215 to value 0x0320
