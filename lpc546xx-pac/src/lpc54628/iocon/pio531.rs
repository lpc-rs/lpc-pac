...
///`read()` method returns [pio531::R](R) reader structure
impl crate::Readable for PIO531_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio531::W](W) writer structure
impl crate::Writable for PIO531_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO531 to value 0x0320
