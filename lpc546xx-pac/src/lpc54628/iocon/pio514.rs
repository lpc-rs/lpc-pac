...
///`read()` method returns [pio514::R](R) reader structure
impl crate::Readable for PIO514_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio514::W](W) writer structure
impl crate::Writable for PIO514_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO514 to value 0x0320
