...
///`read()` method returns [pio123::R](R) reader structure
impl crate::Readable for PIO123_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio123::W](W) writer structure
impl crate::Writable for PIO123_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO123 to value 0x0320
