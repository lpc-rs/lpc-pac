...
///`read()` method returns [pio510::R](R) reader structure
impl crate::Readable for PIO510_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio510::W](W) writer structure
impl crate::Writable for PIO510_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO510 to value 0x0320
