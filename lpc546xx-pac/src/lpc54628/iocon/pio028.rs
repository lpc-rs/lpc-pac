...
///`read()` method returns [pio028::R](R) reader structure
impl crate::Readable for PIO028_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio028::W](W) writer structure
impl crate::Writable for PIO028_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO028 to value 0x0320
