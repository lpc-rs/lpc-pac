...
///`read()` method returns [pio04::R](R) reader structure
impl crate::Readable for PIO04_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio04::W](W) writer structure
impl crate::Writable for PIO04_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO04 to value 0x0320
