...
///`read()` method returns [pio47::R](R) reader structure
impl crate::Readable for PIO47_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio47::W](W) writer structure
impl crate::Writable for PIO47_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO47 to value 0x0320
