...
///`read()` method returns [pio53::R](R) reader structure
impl crate::Readable for PIO53_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio53::W](W) writer structure
impl crate::Writable for PIO53_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO53 to value 0x0320
