...
///`read()` method returns [pio07::R](R) reader structure
impl crate::Readable for PIO07_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio07::W](W) writer structure
impl crate::Writable for PIO07_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO07 to value 0x0320
