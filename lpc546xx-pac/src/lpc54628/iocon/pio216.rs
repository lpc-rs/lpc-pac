...
///`read()` method returns [pio216::R](R) reader structure
impl crate::Readable for PIO216_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio216::W](W) writer structure
impl crate::Writable for PIO216_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO216 to value 0x0320
