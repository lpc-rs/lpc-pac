...
///`read()` method returns [pio321::R](R) reader structure
impl crate::Readable for PIO321_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio321::W](W) writer structure
impl crate::Writable for PIO321_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO321 to value 0x0320
