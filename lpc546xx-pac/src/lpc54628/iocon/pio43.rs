...
///`read()` method returns [pio43::R](R) reader structure
impl crate::Readable for PIO43_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [pio43::W](W) writer structure
impl crate::Writable for PIO43_SPEC {
    type Writer = W;
}
///`reset()` method sets PIO43 to value 0x0320
