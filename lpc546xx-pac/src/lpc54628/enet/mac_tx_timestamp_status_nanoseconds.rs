///Register `MAC_Tx_TIMESTAMP_STATUS_NANOSECONDS` reader
...
///Field `TXTSSTSLO` reader - Transmit timestamp status low.
...
///Field `TXTSSTSMIS` reader - Transmit timestamp status missed.
...
///`read()` method returns [mac_tx_timestamp_status_nanoseconds::R](R) reader structure
impl crate::Readable for MAC_TX_TIMESTAMP_STATUS_NANOSECONDS_SPEC {
    type Reader = R;
}
///`reset()` method sets MAC_Tx_TIMESTAMP_STATUS_NANOSECONDS to value 0
