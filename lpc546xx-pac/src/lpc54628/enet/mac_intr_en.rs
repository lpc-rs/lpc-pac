...
///Field `RXSTSIS` reader - Receive Status Interrupt Enable.
...
///Field `RXSTSIS` writer - Receive Status Interrupt Enable.
...
///`read()` method returns [mac_intr_en::R](R) reader structure
impl crate::Readable for MAC_INTR_EN_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [mac_intr_en::W](W) writer structure
impl crate::Writable for MAC_INTR_EN_SPEC {
    type Writer = W;
}
///`reset()` method sets MAC_INTR_EN to value 0
