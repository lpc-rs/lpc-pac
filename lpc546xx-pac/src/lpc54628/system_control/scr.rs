...
///Field `SLEEPONEXIT` reader - no description available
...
///Field `SLEEPONEXIT` writer - no description available
...
///Field `SLEEPDEEP` reader - no description available
...
///Field `SLEEPDEEP` writer - no description available
...
///Field `SEVONPEND` reader - no description available
...
///Field `SEVONPEND` writer - no description available
