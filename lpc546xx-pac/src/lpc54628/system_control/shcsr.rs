...
pub enum MEMFAULTACT_A {
    ///0: exception is not active
    MEMFAULTACT_0 = 0,
    ///1: exception is active
    MEMFAULTACT_1 = 1,
}
...
///Field `MEMFAULTACT` reader - no description available
...
///Field `MEMFAULTACT` writer - no description available
...
///Field `BUSFAULTACT` reader - no description available
...
///Field `BUSFAULTACT` writer - no description available
...
///Field `USGFAULTACT` reader - no description available
...
///Field `USGFAULTACT` writer - no description available
...
///Field `SVCALLACT` reader - no description available
...
///Field `SVCALLACT` writer - no description available
...
///Field `MONITORACT` reader - no description available
...
///Field `MONITORACT` writer - no description available
...
///Field `PENDSVACT` reader - no description available
...
///Field `PENDSVACT` writer - no description available
...
///Field `SYSTICKACT` reader - no description available
...
///Field `SYSTICKACT` writer - no description available
...
pub enum USGFAULTPENDED_A {
    ///0: exception is not pending
    USGFAULTPENDED_0 = 0,
    ///1: exception is pending
    USGFAULTPENDED_1 = 1,
}
...
///Field `USGFAULTPENDED` reader - no description available
...
///Field `USGFAULTPENDED` writer - no description available
...
///Field `MEMFAULTPENDED` reader - no description available
...
///Field `MEMFAULTPENDED` writer - no description available
...
///Field `BUSFAULTPENDED` reader - no description available
...
///Field `BUSFAULTPENDED` writer - no description available
...
///Field `SVCALLPENDED` reader - no description available
...
///Field `SVCALLPENDED` writer - no description available
...
pub enum MEMFAULTENA_A {
    ///0: disable the exception
    MEMFAULTENA_0 = 0,
    ///1: enable the exception
    MEMFAULTENA_1 = 1,
}
...
///Field `MEMFAULTENA` reader - no description available
...
///Field `MEMFAULTENA` writer - no description available
...
///Field `BUSFAULTENA` reader - no description available
...
///Field `BUSFAULTENA` writer - no description available
...
///Field `USGFAULTENA` reader - no description available
...
///Field `USGFAULTENA` writer - no description available
...
///`read()` method returns [shcsr::R](R) reader structure
impl crate::Readable for SHCSR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [shcsr::W](W) writer structure
