...
///Field `TBLOFF` reader - Vector table base offset
...
///Field `TBLOFF` writer - Vector table base offset
...
///`read()` method returns [vtor::R](R) reader structure
impl crate::Readable for VTOR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [vtor::W](W) writer structure
