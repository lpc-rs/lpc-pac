#[doc = "Reader of register SCTCAPCTRL5"]
pub type R = crate::R<u32, super::SCTCAPCTRL5>;
#[doc = "Writer for register SCTCAPCTRL5"]
pub type W = crate::W<u32, super::SCTCAPCTRL5>;
#[doc = "Register SCTCAPCTRL5 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTCAPCTRL5 {
    type Type = u32;
    #[inline(always)]
