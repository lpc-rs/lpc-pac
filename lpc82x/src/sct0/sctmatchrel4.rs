#[doc = "Reader of register SCTMATCHREL4"]
pub type R = crate::R<u32, super::SCTMATCHREL4>;
#[doc = "Writer for register SCTMATCHREL4"]
pub type W = crate::W<u32, super::SCTMATCHREL4>;
#[doc = "Register SCTMATCHREL4 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTMATCHREL4 {
    type Type = u32;
    #[inline(always)]
