#[doc = "Reader of register SCTCAPCTRL2"]
pub type R = crate::R<u32, super::SCTCAPCTRL2>;
#[doc = "Writer for register SCTCAPCTRL2"]
pub type W = crate::W<u32, super::SCTCAPCTRL2>;
#[doc = "Register SCTCAPCTRL2 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTCAPCTRL2 {
    type Type = u32;
    #[inline(always)]
