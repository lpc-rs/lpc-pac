#[doc = "Register `DMA0REQUEST` reader"]
pub struct R(crate::R<DMA0REQUEST_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DMA0REQUEST_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<DMA0REQUEST_SPEC>> for R {
    fn from(reader: crate::R<DMA0REQUEST_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DMA0REQUEST` writer"]
pub struct W(crate::W<DMA0REQUEST_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DMA0REQUEST_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<DMA0REQUEST_SPEC>> for W {
    fn from(writer: crate::W<DMA0REQUEST_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct DEV_0_R(crate::FieldReader<u8, u8>);
impl DEV_0_R {
...
impl R {
    #[doc = "Bits 0:5 - If bit n is one, event n triggers DMA request 0 (event 0 = bit 0, event 1 = bit 1, etc.). The number of bits = number of events in this SCT."]
    #[inline(always)]
...
pub struct DMA0REQUEST_SPEC;
impl crate::RegisterSpec for DMA0REQUEST_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dma0request::R](R) reader structure"]
impl crate::Readable for DMA0REQUEST_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dma0request::W](W) writer structure"]
impl crate::Writable for DMA0REQUEST_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets DMA0REQUEST to value 0"]
impl crate::Resettable for DMA0REQUEST_SPEC {
    #[inline(always)]
