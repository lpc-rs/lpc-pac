#[doc = "Reader of register DMA0REQUEST"]
pub type R = crate::R<u32, super::DMA0REQUEST>;
#[doc = "Writer for register DMA0REQUEST"]
pub type W = crate::W<u32, super::DMA0REQUEST>;
#[doc = "Register DMA0REQUEST `reset()`'s with value 0"]
impl crate::ResetValue for super::DMA0REQUEST {
    type Type = u32;
    #[inline(always)]
...
pub type DEV_0_R = crate::R<u8, u8>;
