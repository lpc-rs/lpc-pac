#[doc = "Reader of register SCTMATCH0"]
pub type R = crate::R<u32, super::SCTMATCH0>;
#[doc = "Writer for register SCTMATCH0"]
pub type W = crate::W<u32, super::SCTMATCH0>;
#[doc = "Register SCTMATCH0 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTMATCH0 {
    type Type = u32;
    #[inline(always)]
