#[doc = "Reader of register SCTMATCHREL3"]
pub type R = crate::R<u32, super::SCTMATCHREL3>;
#[doc = "Writer for register SCTMATCHREL3"]
pub type W = crate::W<u32, super::SCTMATCHREL3>;
#[doc = "Register SCTMATCHREL3 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTMATCHREL3 {
    type Type = u32;
    #[inline(always)]
