#[doc = "Reader of register SCTMATCH1"]
pub type R = crate::R<u32, super::SCTMATCH1>;
#[doc = "Writer for register SCTMATCH1"]
pub type W = crate::W<u32, super::SCTMATCH1>;
#[doc = "Register SCTMATCH1 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTMATCH1 {
    type Type = u32;
    #[inline(always)]
