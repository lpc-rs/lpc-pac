#[doc = "Register `SCTCAP7` reader"]
pub struct R(crate::R<CAP_MATCH_SCTCAP7_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CAP_MATCH_SCTCAP7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<CAP_MATCH_SCTCAP7_SPEC>> for R {
    fn from(reader: crate::R<CAP_MATCH_SCTCAP7_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SCTCAP7` writer"]
pub struct W(crate::W<CAP_MATCH_SCTCAP7_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CAP_MATCH_SCTCAP7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<CAP_MATCH_SCTCAP7_SPEC>> for W {
    fn from(writer: crate::W<CAP_MATCH_SCTCAP7_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct CAP_MATCH_SCTCAP7_SPEC;
impl crate::RegisterSpec for CAP_MATCH_SCTCAP7_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cap_match_sctcap7::R](R) reader structure"]
impl crate::Readable for CAP_MATCH_SCTCAP7_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cap_match_sctcap7::W](W) writer structure"]
impl crate::Writable for CAP_MATCH_SCTCAP7_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SCTCAP7 to value 0"]
impl crate::Resettable for CAP_MATCH_SCTCAP7_SPEC {
    #[inline(always)]
