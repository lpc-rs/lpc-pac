#[doc = "Reader of register SCTMATCHREL6"]
pub type R = crate::R<u32, super::SCTMATCHREL6>;
#[doc = "Writer for register SCTMATCHREL6"]
pub type W = crate::W<u32, super::SCTMATCHREL6>;
#[doc = "Register SCTMATCHREL6 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTMATCHREL6 {
    type Type = u32;
    #[inline(always)]
