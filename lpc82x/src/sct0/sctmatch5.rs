#[doc = "Reader of register SCTMATCH5"]
pub type R = crate::R<u32, super::SCTMATCH5>;
#[doc = "Writer for register SCTMATCH5"]
pub type W = crate::W<u32, super::SCTMATCH5>;
#[doc = "Register SCTMATCH5 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTMATCH5 {
    type Type = u32;
    #[inline(always)]
