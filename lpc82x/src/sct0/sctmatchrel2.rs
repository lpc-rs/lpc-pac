#[doc = "Reader of register SCTMATCHREL2"]
pub type R = crate::R<u32, super::SCTMATCHREL2>;
#[doc = "Writer for register SCTMATCHREL2"]
pub type W = crate::W<u32, super::SCTMATCHREL2>;
#[doc = "Register SCTMATCHREL2 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTMATCHREL2 {
    type Type = u32;
    #[inline(always)]
