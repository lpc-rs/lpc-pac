#[doc = "Reader of register SCTMATCH2"]
pub type R = crate::R<u32, super::SCTMATCH2>;
#[doc = "Writer for register SCTMATCH2"]
pub type W = crate::W<u32, super::SCTMATCH2>;
#[doc = "Register SCTMATCH2 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTMATCH2 {
    type Type = u32;
    #[inline(always)]
