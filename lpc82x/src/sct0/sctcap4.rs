#[doc = "Reader of register SCTCAP4"]
pub type R = crate::R<u32, super::SCTCAP4>;
#[doc = "Writer for register SCTCAP4"]
pub type W = crate::W<u32, super::SCTCAP4>;
#[doc = "Register SCTCAP4 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTCAP4 {
    type Type = u32;
    #[inline(always)]
