#[doc = "Reader of register SCTCAPCTRL6"]
pub type R = crate::R<u32, super::SCTCAPCTRL6>;
#[doc = "Writer for register SCTCAPCTRL6"]
pub type W = crate::W<u32, super::SCTCAPCTRL6>;
#[doc = "Register SCTCAPCTRL6 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTCAPCTRL6 {
    type Type = u32;
    #[inline(always)]
