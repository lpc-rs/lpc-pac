#[doc = "Reader of register SCTCAP0"]
pub type R = crate::R<u32, super::SCTCAP0>;
#[doc = "Writer for register SCTCAP0"]
pub type W = crate::W<u32, super::SCTCAP0>;
#[doc = "Register SCTCAP0 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTCAP0 {
    type Type = u32;
    #[inline(always)]
