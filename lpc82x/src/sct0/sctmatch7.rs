#[doc = "Reader of register SCTMATCH7"]
pub type R = crate::R<u32, super::SCTMATCH7>;
#[doc = "Writer for register SCTMATCH7"]
pub type W = crate::W<u32, super::SCTMATCH7>;
#[doc = "Register SCTMATCH7 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTMATCH7 {
    type Type = u32;
    #[inline(always)]
