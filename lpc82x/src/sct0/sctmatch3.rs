#[doc = "Reader of register SCTMATCH3"]
pub type R = crate::R<u32, super::SCTMATCH3>;
#[doc = "Writer for register SCTMATCH3"]
pub type W = crate::W<u32, super::SCTMATCH3>;
#[doc = "Register SCTMATCH3 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTMATCH3 {
    type Type = u32;
    #[inline(always)]
