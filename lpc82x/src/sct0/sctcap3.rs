#[doc = "Reader of register SCTCAP3"]
pub type R = crate::R<u32, super::SCTCAP3>;
#[doc = "Writer for register SCTCAP3"]
pub type W = crate::W<u32, super::SCTCAP3>;
#[doc = "Register SCTCAP3 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTCAP3 {
    type Type = u32;
    #[inline(always)]
