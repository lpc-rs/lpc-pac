#[doc = "Reader of register THR0_HIGH"]
pub type R = crate::R<u32, super::THR0_HIGH>;
#[doc = "Writer for register THR0_HIGH"]
pub type W = crate::W<u32, super::THR0_HIGH>;
#[doc = "Register THR0_HIGH `reset()`'s with value 0"]
impl crate::ResetValue for super::THR0_HIGH {
    type Type = u32;
    #[inline(always)]
