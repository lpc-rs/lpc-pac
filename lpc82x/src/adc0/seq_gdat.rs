...
#[doc = "Writer for register SEQ_GDAT%s"]
pub type W = crate::W<u32, super::SEQ_GDAT>;
#[doc = "Register SEQ_GDAT%s `reset()`'s with value 0"]
impl crate::ResetValue for super::SEQ_GDAT {
    type Type = u32;
    #[inline(always)]
