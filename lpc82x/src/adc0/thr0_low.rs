#[doc = "Reader of register THR0_LOW"]
pub type R = crate::R<u32, super::THR0_LOW>;
#[doc = "Writer for register THR0_LOW"]
pub type W = crate::W<u32, super::THR0_LOW>;
#[doc = "Register THR0_LOW `reset()`'s with value 0"]
impl crate::ResetValue for super::THR0_LOW {
    type Type = u32;
    #[inline(always)]
