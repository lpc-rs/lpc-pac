...
impl core::convert::From<crate::R<PINASSIGN3_SPEC>> for R {
...
impl core::convert::From<crate::W<PINASSIGN3_SPEC>> for W {
    fn from(writer: crate::W<PINASSIGN3_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `U2_RTS_O` reader - U2_RTS function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0(= 0) to PIO0_28 (= 0x1C)."]
...
#[doc = "Field `U2_RTS_O` writer - U2_RTS function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0(= 0) to PIO0_28 (= 0x1C)."]
...
#[doc = "Field `U2_CTS_I` reader - U2_CTS function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0(= 0) to PIO0_28 (= 0x1C)."]
...
#[doc = "Field `U2_CTS_I` writer - U2_CTS function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0(= 0) to PIO0_28 (= 0x1C)."]
...
#[doc = "Field `U2_SCLK_IO` reader - U2_SCLK function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0(= 0) to PIO0_28 (= 0x1C)."]
...
#[doc = "Field `U2_SCLK_IO` writer - U2_SCLK function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0(= 0) to PIO0_28 (= 0x1C)."]
...
#[doc = "Field `SPI0_SCK_IO` reader - SPI0_SCK function assignment. The value is the pin number to be assigned to this function. The following pins are available:PIO0_0 (= 0) to PIO0_28 (= 0x1C)."]
...
#[doc = "Field `SPI0_SCK_IO` writer - SPI0_SCK function assignment. The value is the pin number to be assigned to this function. The following pins are available:PIO0_0 (= 0) to PIO0_28 (= 0x1C)."]
