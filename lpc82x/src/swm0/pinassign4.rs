...
impl core::convert::From<crate::R<PINASSIGN4_SPEC>> for R {
...
impl core::convert::From<crate::W<PINASSIGN4_SPEC>> for W {
...
#[doc = "Field `SPI0_MOSI_IO` writer - SPI0_MOSI function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0 (= 0) to PIO0_28 (= 0x1C)."]
...
#[doc = "Field `SPI0_MISO_IO` writer - SPI0_MISIO function assignment. The value is the pin number to be assigned to this function. The following pins are available:PIO0_0 (= 0) to PIO0_28 (= 0x1C)."]
...
#[doc = "Field `SPI0_SSEL0_IO` writer - SPI0_SSEL0 function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0 (= 0) to PIO0_28 (= 0x1C)."]
...
#[doc = "Field `SPI0_SSEL1_IO` writer - SPI0_SSEL1 function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0 (= 0) to PIO0_28 (= 0x1C)."]
