...
impl core::convert::From<crate::R<PINASSIGN5_SPEC>> for R {
...
impl core::convert::From<crate::W<PINASSIGN5_SPEC>> for W {
    fn from(writer: crate::W<PINASSIGN5_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `SPI0_SSEL2_IO` reader - SPI0_SSEL2 function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0 (= 0) to PIO0_28 (= 0x1C)."]
...
#[doc = "Field `SPI0_SSEL2_IO` writer - SPI0_SSEL2 function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0 (= 0) to PIO0_28 (= 0x1C)."]
...
#[doc = "Field `SPI0_SSEL3_IO` reader - SPI0_SSEL3 function assignment. The value is the pin number to be assigned to this function. The following pins are available:PIO0_0 (= 0) to PIO0_28 (= 0x1C)."]
...
#[doc = "Field `SPI0_SSEL3_IO` writer - SPI0_SSEL3 function assignment. The value is the pin number to be assigned to this function. The following pins are available:PIO0_0 (= 0) to PIO0_28 (= 0x1C)."]
...
#[doc = "Field `SPI1_SCK_IO` reader - SPI1_SCK function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0 (= 0) to PIO0_28 (= 0x1C)."]
...
#[doc = "Field `SPI1_SCK_IO` writer - SPI1_SCK function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0 (= 0) to PIO0_28 (= 0x1C)."]
...
#[doc = "Field `SPI1_MOSI_IO` reader - SPI1_MOSI function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0 (= 0) to PIO0_28 (= 0x1C)."]
...
#[doc = "Field `SPI1_MOSI_IO` writer - SPI1_MOSI function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0 (= 0) to PIO0_28 (= 0x1C)."]
