...
impl core::convert::From<crate::R<UARTCLKDIV_SPEC>> for R {
...
impl core::convert::From<crate::W<UARTCLKDIV_SPEC>> for W {
    fn from(writer: crate::W<UARTCLKDIV_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `DIV` reader - USART fractional baud rate generator clock divider values. 0: Clock disabled. 1: Divide by 1. to 255: Divide by 255."]
...
#[doc = "Field `DIV` writer - USART fractional baud rate generator clock divider values. 0: Clock disabled. 1: Divide by 1. to 255: Divide by 255."]
pub struct DIV_W<'a> {
    w: &'a mut W,
}
impl<'a> DIV_W<'a> {
