#[doc = "Reader of register UARTFRGMULT"]
pub type R = crate::R<u32, super::UARTFRGMULT>;
#[doc = "Writer for register UARTFRGMULT"]
pub type W = crate::W<u32, super::UARTFRGMULT>;
#[doc = "Register UARTFRGMULT `reset()`'s with value 0"]
impl crate::ResetValue for super::UARTFRGMULT {
    type Type = u32;
    #[inline(always)]
