...
impl CKSELR {
    ...
    pub fn bits(&self) -> u8 {
        match *self {
            ...
            CKSELR::FALLING_EDGES_INPUT_0 => 1,
            CKSELR::RISING_EDGES_INPUT_1 => 2,
            CKSELR::FALLING_EDGES_INPUT_1 => 3,
            CKSELR::RISING_EDGES_INPUT_2 => 4,
            CKSELR::FALLING_EDGES_INPUT_2 => 5,
            CKSELR::RISING_EDGES_INPUT_3 => 6,
            CKSELR::FALLING_EDGES_INPUT_3 => 7,
