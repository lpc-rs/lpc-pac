...
pub struct R(crate::R<B0_9_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<B0_9_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<B0_9_SPEC>> for R {
    fn from(reader: crate::R<B0_9_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `B0_9` writer"]
pub struct W(crate::W<B0_9_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<B0_9_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<B0_9_SPEC>> for W {
    fn from(writer: crate::W<B0_9_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct B0_9_SPEC;
impl crate::RegisterSpec for B0_9_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [b0_9::R](R) reader structure"]
impl crate::Readable for B0_9_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [b0_9::W](W) writer structure"]
impl crate::Writable for B0_9_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets B0_9 to value 0"]
impl crate::Resettable for B0_9_SPEC {
    #[inline(always)]
