#[doc = "Reader of register B0_0"]
pub type R = crate::R<u8, super::B0_0>;
#[doc = "Writer for register B0_0"]
pub type W = crate::W<u8, super::B0_0>;
#[doc = "Register B0_0 `reset()`'s with value 0"]
impl crate::ResetValue for super::B0_0 {
    type Type = u8;
    #[inline(always)]
