#[doc = "Reader of register B0_12"]
pub type R = crate::R<u8, super::B0_12>;
#[doc = "Writer for register B0_12"]
pub type W = crate::W<u8, super::B0_12>;
#[doc = "Register B0_12 `reset()`'s with value 0"]
impl crate::ResetValue for super::B0_12 {
    type Type = u8;
    #[inline(always)]
