#[doc = "Reader of register B0_10"]
pub type R = crate::R<u8, super::B0_10>;
#[doc = "Writer for register B0_10"]
pub type W = crate::W<u8, super::B0_10>;
#[doc = "Register B0_10 `reset()`'s with value 0"]
impl crate::ResetValue for super::B0_10 {
    type Type = u8;
    #[inline(always)]
