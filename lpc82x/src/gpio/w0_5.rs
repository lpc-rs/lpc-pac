#[doc = "Reader of register W0_5"]
pub type R = crate::R<u32, super::W0_5>;
#[doc = "Writer for register W0_5"]
pub type W = crate::W<u32, super::W0_5>;
#[doc = "Register W0_5 `reset()`'s with value 0"]
impl crate::ResetValue for super::W0_5 {
    type Type = u32;
    #[inline(always)]
