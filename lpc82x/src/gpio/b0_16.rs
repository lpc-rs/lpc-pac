#[doc = "Reader of register B0_16"]
pub type R = crate::R<u8, super::B0_16>;
#[doc = "Writer for register B0_16"]
pub type W = crate::W<u8, super::B0_16>;
#[doc = "Register B0_16 `reset()`'s with value 0"]
impl crate::ResetValue for super::B0_16 {
    type Type = u8;
    #[inline(always)]
