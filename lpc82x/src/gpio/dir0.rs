#[doc = "Reader of register DIR0"]
pub type R = crate::R<u32, super::DIR0>;
#[doc = "Writer for register DIR0"]
pub type W = crate::W<u32, super::DIR0>;
#[doc = "Register DIR0 `reset()`'s with value 0"]
impl crate::ResetValue for super::DIR0 {
    type Type = u32;
    #[inline(always)]
