#[doc = "Reader of register B0_14"]
pub type R = crate::R<u8, super::B0_14>;
#[doc = "Writer for register B0_14"]
pub type W = crate::W<u8, super::B0_14>;
#[doc = "Register B0_14 `reset()`'s with value 0"]
impl crate::ResetValue for super::B0_14 {
    type Type = u8;
    #[inline(always)]
