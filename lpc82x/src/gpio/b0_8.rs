#[doc = "Reader of register B0_8"]
pub type R = crate::R<u8, super::B0_8>;
#[doc = "Writer for register B0_8"]
pub type W = crate::W<u8, super::B0_8>;
#[doc = "Register B0_8 `reset()`'s with value 0"]
impl crate::ResetValue for super::B0_8 {
    type Type = u8;
    #[inline(always)]
