...
pub struct R(crate::R<W0_8_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<W0_8_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<W0_8_SPEC>> for R {
    fn from(reader: crate::R<W0_8_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `W0_8` writer"]
pub struct W(crate::W<W0_8_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<W0_8_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<W0_8_SPEC>> for W {
    fn from(writer: crate::W<W0_8_SPEC>) -> Self {
        W(writer)
    }
}
