#[doc = "Reader of register B0_2"]
pub type R = crate::R<u8, super::B0_2>;
#[doc = "Writer for register B0_2"]
pub type W = crate::W<u8, super::B0_2>;
#[doc = "Register B0_2 `reset()`'s with value 0"]
impl crate::ResetValue for super::B0_2 {
    type Type = u8;
    #[inline(always)]
