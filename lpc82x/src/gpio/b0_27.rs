#[doc = "Reader of register B0_27"]
pub type R = crate::R<u8, super::B0_27>;
#[doc = "Writer for register B0_27"]
pub type W = crate::W<u8, super::B0_27>;
#[doc = "Register B0_27 `reset()`'s with value 0"]
impl crate::ResetValue for super::B0_27 {
    type Type = u8;
    #[inline(always)]
