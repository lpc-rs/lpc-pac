...
pub struct R(crate::R<B0_5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<B0_5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<B0_5_SPEC>> for R {
    fn from(reader: crate::R<B0_5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `B0_5` writer"]
pub struct W(crate::W<B0_5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<B0_5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<B0_5_SPEC>> for W {
    fn from(writer: crate::W<B0_5_SPEC>) -> Self {
        W(writer)
    }
}
