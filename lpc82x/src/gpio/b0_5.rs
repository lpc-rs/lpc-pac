#[doc = "Reader of register B0_5"]
pub type R = crate::R<u8, super::B0_5>;
#[doc = "Writer for register B0_5"]
pub type W = crate::W<u8, super::B0_5>;
#[doc = "Register B0_5 `reset()`'s with value 0"]
impl crate::ResetValue for super::B0_5 {
    type Type = u8;
    #[inline(always)]
