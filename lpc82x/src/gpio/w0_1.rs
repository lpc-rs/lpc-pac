#[doc = "Reader of register W0_1"]
pub type R = crate::R<u32, super::W0_1>;
#[doc = "Writer for register W0_1"]
pub type W = crate::W<u32, super::W0_1>;
#[doc = "Register W0_1 `reset()`'s with value 0"]
impl crate::ResetValue for super::W0_1 {
    type Type = u32;
    #[inline(always)]
