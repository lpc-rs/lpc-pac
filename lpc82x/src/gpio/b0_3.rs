#[doc = "Reader of register B0_3"]
pub type R = crate::R<u8, super::B0_3>;
#[doc = "Writer for register B0_3"]
pub type W = crate::W<u8, super::B0_3>;
#[doc = "Register B0_3 `reset()`'s with value 0"]
impl crate::ResetValue for super::B0_3 {
    type Type = u8;
    #[inline(always)]
