...
pub struct R(crate::R<W0_6_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<W0_6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<W0_6_SPEC>> for R {
    fn from(reader: crate::R<W0_6_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `W0_6` writer"]
pub struct W(crate::W<W0_6_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<W0_6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<W0_6_SPEC>> for W {
    fn from(writer: crate::W<W0_6_SPEC>) -> Self {
        W(writer)
    }
}
