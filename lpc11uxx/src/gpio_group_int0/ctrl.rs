...
impl<'a> INT_W<'a> {
    ...
    pub fn no_interrupt_request(self) -> &'a mut W {
        self.variant(INT_A::NO_INTERRUPT_REQUEST)
    }
    #[doc = "Interrupt request is active."]
    #[inline(always)]
    pub fn interrupt_request_is(self) -> &'a mut W {
        self.variant(INT_A::INTERRUPT_REQUEST_IS)
    }
