#[doc = "Reader of register ADR0"]
pub type R = crate::R<u32, super::ADR0>;
#[doc = "Writer for register ADR0"]
pub type W = crate::W<u32, super::ADR0>;
#[doc = "Register ADR0 `reset()`'s with value 0"]
impl crate::ResetValue for super::ADR0 {
    type Type = u32;
    #[inline(always)]
