#[doc = "Reader of register USBCLKUEN"]
pub type R = crate::R<u32, super::USBCLKUEN>;
#[doc = "Writer for register USBCLKUEN"]
pub type W = crate::W<u32, super::USBCLKUEN>;
#[doc = "Register USBCLKUEN `reset()`'s with value 0"]
impl crate::ResetValue for super::USBCLKUEN {
    type Type = u32;
    #[inline(always)]
