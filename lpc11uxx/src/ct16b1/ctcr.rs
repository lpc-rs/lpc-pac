...
impl SELCCR {
    ...
    pub fn bits(&self) -> u8 {
        match *self {
            ...
            SELCCR::RISING_EDGE_OF_CT16B_CAP1 => 2,
            SELCCR::FALLING_EDGE_OF_CT16_CAP1 => 3,
            SELCCR::RESERVED_4 => 4,
            SELCCR::RESERVED_5 => 5,
    ...
    pub fn _from(value: u8) -> SELCCR {
        match value {
            ...
            2 => SELCCR::RISING_EDGE_OF_CT16B_CAP1,
            3 => SELCCR::FALLING_EDGE_OF_CT16_CAP1,
            4 => SELCCR::RESERVED_4,
            5 => SELCCR::RESERVED_5,
...
impl SELCCW {
    ...
    pub fn _bits(&self) -> u8 {
        match *self {
            ...
            SELCCW::RISING_EDGE_OF_CT16B_CAP1 => 2,
            SELCCW::FALLING_EDGE_OF_CT16_CAP1 => 3,
            SELCCW::RESERVED_4 => 4,
            SELCCW::RESERVED_5 => 5,
        }
    }
...
impl<'a> _SELCCW<'a> {
    ...
    #[doc = "Reserved."]
    #[inline]
    pub fn reserved_4(self) -> &'a mut W {
        self.variant(SELCCW::RESERVED_4)
    }
    #[doc = "Reserved."]
    #[inline]
    pub fn reserved_5(self) -> &'a mut W {
        self.variant(SELCCW::RESERVED_5)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
