...
impl From<SELCC_A> for u8 {
    ...
    fn from(variant: SELCC_A) -> Self {
        match variant {
            ...
            SELCC_A::RISING_EDGE_OF_CT16B_CAP1 => 2,
            SELCC_A::FALLING_EDGE_OF_CT16_CAP1 => 3,
            SELCC_A::RESERVED_4 => 4,
            SELCC_A::RESERVED_5 => 5,
        }
    }
}
...
impl<'a> SELCC_W<'a> {
    ...
    pub fn reserved_4(self) -> &'a mut W {
        self.variant(SELCC_A::RESERVED_4)
    }
    #[doc = "Reserved."]
    #[inline(always)]
    pub fn reserved_5(self) -> &'a mut W {
        self.variant(SELCC_A::RESERVED_5)
    }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
