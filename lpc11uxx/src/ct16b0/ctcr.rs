...
#[doc = "Count Input Select. In counter mode (when bits 1:0 in this register are not 00), these bits select which CAP pin or comparator output is sampled for clocking. Values 0x1 and 0x3 are reserved.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum CIS_A {
    #[doc = "0: CT16B0_CAP0."]
...
#[doc = "Field `CIS` reader - Count Input Select. In counter mode (when bits 1:0 in this register are not 00), these bits select which CAP pin or comparator output is sampled for clocking. Values 0x1 and 0x3 are reserved."]
...
impl CIS_R {
    ...
    pub fn variant(&self) -> Option<CIS_A> {
        match self.bits {
            0 => Some(CIS_A::CT16B0_CAP0),
            1 => Some(CIS_A::RESERVED_1),
            2 => Some(CIS_A::CT16B0_CAP1),
            _ => None,
        }
    }
...
#[doc = "Field `CIS` writer - Count Input Select. In counter mode (when bits 1:0 in this register are not 00), these bits select which CAP pin or comparator output is sampled for clocking. Values 0x1 and 0x3 are reserved."]
pub struct CIS_W<'a> {
    w: &'a mut W,
}
impl<'a> CIS_W<'a> {
    ...
    pub fn ct16b0_cap0(self) -> &'a mut W {
        self.variant(CIS_A::CT16B0_CAP0)
    }
    #[doc = "Reserved."]
    #[inline(always)]
    ...
    pub fn ct16b0_cap1(self) -> &'a mut W {
        self.variant(CIS_A::CT16B0_CAP1)
    }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
...
#[repr(u8)]
pub enum SELCC_A {
    #[doc = "0: Rising Edge of CT16B0_CAP0 clears the timer (if bit 4 is set)."]
    RISING_EDGE_OF_CT16B_CAP0 = 0,
    #[doc = "1: Falling Edge of CT16B0_CAP0 clears the timer (if bit 4 is set)."]
    FALLING_EDGE_OF_CT16_CAP0 = 1,
    #[doc = "2: Reserved."]
    RESERVED_2 = 2,
    #[doc = "3: Reserved."]
    RESERVED_3 = 3,
    #[doc = "4: Rising Edge of CT16B0_CAP1 clears the timer (if bit 4 is set)."]
    RISING_EDGE_OF_CT16B_CAP1 = 4,
    #[doc = "5: Falling Edge of CT16B0_CAP1 clears the timer (if bit 4 is set)."]
    FALLING_EDGE_OF_CT16_CAP1 = 5,
}
...
impl SELCC_R {
    ...
    pub fn variant(&self) -> Option<SELCC_A> {
        match self.bits {
            ...
            4 => Some(SELCC_A::RISING_EDGE_OF_CT16B_CAP1),
            5 => Some(SELCC_A::FALLING_EDGE_OF_CT16_CAP1),
            _ => None,
        }
    }
...
impl<'a> SELCC_W<'a> {
    ...
    #[doc = "Rising Edge of CT16B0_CAP0 clears the timer (if bit 4 is set)."]
    #[inline(always)]
    pub fn rising_edge_of_ct16b_cap0(self) -> &'a mut W {
        self.variant(SELCC_A::RISING_EDGE_OF_CT16B_CAP0)
    }
    #[doc = "Falling Edge of CT16B0_CAP0 clears the timer (if bit 4 is set)."]
    #[inline(always)]
    pub fn falling_edge_of_ct16_cap0(self) -> &'a mut W {
        self.variant(SELCC_A::FALLING_EDGE_OF_CT16_CAP0)
    }
    #[doc = "Reserved."]
    #[inline(always)]
    ...
    #[doc = "Rising Edge of CT16B0_CAP1 clears the timer (if bit 4 is set)."]
    #[inline(always)]
    pub fn rising_edge_of_ct16b_cap1(self) -> &'a mut W {
        self.variant(SELCC_A::RISING_EDGE_OF_CT16B_CAP1)
    }
    #[doc = "Falling Edge of CT16B0_CAP1 clears the timer (if bit 4 is set)."]
    #[inline(always)]
    pub fn falling_edge_of_ct16_cap1(self) -> &'a mut W {
        self.variant(SELCC_A::FALLING_EDGE_OF_CT16_CAP1)
    }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
impl R {
    ...
    #[doc = "Bits 2:3 - Count Input Select. In counter mode (when bits 1:0 in this register are not 00), these bits select which CAP pin or comparator output is sampled for clocking. Values 0x1 and 0x3 are reserved."]
    #[inline(always)]
