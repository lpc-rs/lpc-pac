...
impl CIS_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, CIS_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(CIS_A::CT16B0_CAP0),
            1 => Val(CIS_A::RESERVED_1),
            2 => Val(CIS_A::CT16B0_CAP1),
            i => Res(i),
        }
    }
...
impl From<SELCC_A> for u8 {
    ...
    fn from(variant: SELCC_A) -> Self {
        match variant {
            SELCC_A::RISING_EDGE_OF_CT16B_CAP0 => 0,
            SELCC_A::FALLING_EDGE_OF_CT16_CAP0 => 1,
            SELCC_A::RESERVED_2 => 2,
            SELCC_A::RESERVED_3 => 3,
            SELCC_A::RISING_EDGE_OF_CT16B_CAP1 => 4,
            SELCC_A::FALLING_EDGE_OF_CT16_CAP1 => 5,
        }
    }
}
...
impl SELCC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, SELCC_A> {
        ...
        match self.bits {
            ...
            4 => Val(SELCC_A::RISING_EDGE_OF_CT16B_CAP1),
            5 => Val(SELCC_A::FALLING_EDGE_OF_CT16_CAP1),
            i => Res(i),
        }
    }
