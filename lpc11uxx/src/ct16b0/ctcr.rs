...
impl SELCCR {
    ...
    pub fn bits(&self) -> u8 {
        match *self {
            SELCCR::RISING_EDGE_OF_CT16B_CAP0 => 0,
            SELCCR::FALLING_EDGE_OF_CT16_CAP0 => 1,
            SELCCR::RESERVED_2 => 2,
            SELCCR::RESERVED_3 => 3,
            SELCCR::RISING_EDGE_OF_CT16B_CAP1 => 4,
            SELCCR::FALLING_EDGE_OF_CT16_CAP1 => 5,
    ...
    pub fn _from(value: u8) -> SELCCR {
        match value {
            0 => SELCCR::RISING_EDGE_OF_CT16B_CAP0,
            1 => SELCCR::FALLING_EDGE_OF_CT16_CAP0,
            2 => SELCCR::RESERVED_2,
            3 => SELCCR::RESERVED_3,
            4 => SELCCR::RISING_EDGE_OF_CT16B_CAP1,
            5 => SELCCR::FALLING_EDGE_OF_CT16_CAP1,
...
impl SELCCW {
    ...
    pub fn _bits(&self) -> u8 {
        match *self {
            SELCCW::RISING_EDGE_OF_CT16B_CAP0 => 0,
            SELCCW::FALLING_EDGE_OF_CT16_CAP0 => 1,
            SELCCW::RESERVED_2 => 2,
            SELCCW::RESERVED_3 => 3,
            SELCCW::RISING_EDGE_OF_CT16B_CAP1 => 4,
            SELCCW::FALLING_EDGE_OF_CT16_CAP1 => 5,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _SELCCW<'a> {
    ...
    pub fn rising_edge_of_ct16b_cap0(self) -> &'a mut W {
        self.variant(SELCCW::RISING_EDGE_OF_CT16B_CAP0)
    }
    #[doc = "Falling Edge of CT16B0_CAP0 clears the timer (if bit 4 is set)."]
    #[inline]
    pub fn falling_edge_of_ct16_cap0(self) -> &'a mut W {
        self.variant(SELCCW::FALLING_EDGE_OF_CT16_CAP0)
    }
    #[doc = "Reserved."]
    #[inline]
    ...
    pub fn rising_edge_of_ct16b_cap1(self) -> &'a mut W {
        self.variant(SELCCW::RISING_EDGE_OF_CT16B_CAP1)
    }
    #[doc = "Falling Edge of CT16B0_CAP1 clears the timer (if bit 4 is set)."]
    #[inline]
    pub fn falling_edge_of_ct16_cap1(self) -> &'a mut W {
        self.variant(SELCCW::FALLING_EDGE_OF_CT16_CAP1)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
