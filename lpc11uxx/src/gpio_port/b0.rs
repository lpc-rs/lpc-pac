#[doc = "Reader of register B0%s"]
pub type R = crate::R<u8, super::B0>;
#[doc = "Writer for register B0%s"]
pub type W = crate::W<u8, super::B0>;
#[doc = "Register B0%s `reset()`'s with value 0"]
