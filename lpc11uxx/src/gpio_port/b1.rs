...
impl core::convert::From<crate::R<B1_SPEC>> for R {
    fn from(reader: crate::R<B1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `B1%s` writer"]
...
impl core::convert::From<crate::W<B1_SPEC>> for W {
...
#[doc = "Field `PBYTE` writer - Read: state of the pin P1_n, regardless of direction, masking, or alternate function, except that pins configured as analog I/O always read as 0. Write: loads the pin's output bit."]
...
impl R {
    #[doc = "Bit 0 - Read: state of the pin P1_n, regardless of direction, masking, or alternate function, except that pins configured as analog I/O always read as 0. Write: loads the pin's output bit."]
    #[inline(always)]
...
#[doc = "`reset()` method sets B1%s to value 0"]
