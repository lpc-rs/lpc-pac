#[doc = "Reader of register W_1%s"]
pub type R = crate::R<u32, super::W_1>;
#[doc = "Writer for register W_1%s"]
pub type W = crate::W<u32, super::W_1>;
#[doc = "Register W_1%s `reset()`'s with value 0"]
impl crate::ResetValue for super::W_1 {
    type Type = u32;
    #[inline(always)]
