#[doc = "Reader of register TDO_PIO0_13"]
pub type R = crate::R<u32, super::TDO_PIO0_13>;
#[doc = "Writer for register TDO_PIO0_13"]
pub type W = crate::W<u32, super::TDO_PIO0_13>;
#[doc = "Register TDO_PIO0_13 `reset()`'s with value 0x90"]
impl crate::ResetValue for super::TDO_PIO0_13 {
    type Type = u32;
    #[inline(always)]
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::TDO),
            1 => Val(FUNC_A::PIO0_13),
            2 => Val(FUNC_A::AD2),
            3 => Val(FUNC_A::CT32B1_MAT0),
            i => Res(i),
        }
    }
