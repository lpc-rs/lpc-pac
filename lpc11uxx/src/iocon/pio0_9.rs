...
pub struct R(crate::R<PIO0_9_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PIO0_9_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<PIO0_9_SPEC>> for R {
    fn from(reader: crate::R<PIO0_9_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PIO0_9` writer"]
pub struct W(crate::W<PIO0_9_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PIO0_9_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<PIO0_9_SPEC>> for W {
    fn from(writer: crate::W<PIO0_9_SPEC>) -> Self {
        W(writer)
    }
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            0 => Some(FUNC_A::PIO0_9),
            1 => Some(FUNC_A::MOSI0),
            2 => Some(FUNC_A::CT16B0_MAT1),
            _ => None,
        }
    }
...
impl<'a> FUNC_W<'a> {
    ...
    pub fn pio0_9(self) -> &'a mut W {
        self.variant(FUNC_A::PIO0_9)
    }
    #[doc = "MOSI0."]
    #[inline(always)]
    pub fn mosi0(self) -> &'a mut W {
        self.variant(FUNC_A::MOSI0)
    }
    #[doc = "CT16B0_MAT1."]
    #[inline(always)]
    pub fn ct16b0_mat1(self) -> &'a mut W {
        self.variant(FUNC_A::CT16B0_MAT1)
    }
...
#[doc = "I/O configuration for pin PIO0_9/MOSI0/CT16B0_MAT1\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pio0_9](index.html) module"]
pub struct PIO0_9_SPEC;
impl crate::RegisterSpec for PIO0_9_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pio0_9::R](R) reader structure"]
impl crate::Readable for PIO0_9_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pio0_9::W](W) writer structure"]
impl crate::Writable for PIO0_9_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PIO0_9 to value 0x90"]
impl crate::Resettable for PIO0_9_SPEC {
    #[inline(always)]
