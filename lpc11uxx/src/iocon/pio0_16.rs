...
impl From<crate::R<PIO0_16_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<PIO0_16_SPEC>> for W {
    #[inline(always)]
...
#[doc = "Field `FUNC` reader - Selects pin function. This pin functions as WAKEUP pin if the LPC11Uxx is in Deep power-down mode regardless of the value of FUNC. Values 0x3 to 0x7 are reserved."]
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            0 => Some(FUNC_A::PIO0_16),
            1 => Some(FUNC_A::AD5),
            2 => Some(FUNC_A::CT32B1_MAT3),
            _ => None,
        }
    }
...
#[doc = "Field `FUNC` writer - Selects pin function. This pin functions as WAKEUP pin if the LPC11Uxx is in Deep power-down mode regardless of the value of FUNC. Values 0x3 to 0x7 are reserved."]
pub struct FUNC_W<'a> {
    w: &'a mut W,
}
impl<'a> FUNC_W<'a> {
...
#[doc = "`reset()` method sets PIO0_16 to value 0x90"]
