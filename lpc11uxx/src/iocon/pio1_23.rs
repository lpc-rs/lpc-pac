#[doc = "Reader of register PIO1_23"]
pub type R = crate::R<u32, super::PIO1_23>;
#[doc = "Writer for register PIO1_23"]
pub type W = crate::W<u32, super::PIO1_23>;
#[doc = "Register PIO1_23 `reset()`'s with value 0x90"]
impl crate::ResetValue for super::PIO1_23 {
    type Type = u32;
    #[inline(always)]
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(FUNC_A::PIO1_23),
            1 => Val(FUNC_A::CT16B1_MAT1),
            2 => Val(FUNC_A::SSEL1),
            i => Res(i),
        }
    }
