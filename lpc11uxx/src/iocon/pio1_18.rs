...
pub struct R(crate::R<PIO1_18_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PIO1_18_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<PIO1_18_SPEC>> for R {
    fn from(reader: crate::R<PIO1_18_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PIO1_18` writer"]
pub struct W(crate::W<PIO1_18_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PIO1_18_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<PIO1_18_SPEC>> for W {
    fn from(writer: crate::W<PIO1_18_SPEC>) -> Self {
        W(writer)
    }
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            0 => Some(FUNC_A::PIO1_18),
            1 => Some(FUNC_A::CT16B1_CAP1),
            2 => Some(FUNC_A::TXD),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `PIO1_18`"]
    #[inline(always)]
    pub fn is_pio1_18(&self) -> bool {
        **self == FUNC_A::PIO1_18
    }
    #[doc = "Checks if the value of the field is `CT16B1_CAP1`"]
    #[inline(always)]
    pub fn is_ct16b1_cap1(&self) -> bool {
        **self == FUNC_A::CT16B1_CAP1
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[doc = "PIO1_18"]
    #[inline(always)]
    pub fn pio1_18(self) -> &'a mut W {
        self.variant(FUNC_A::PIO1_18)
    }
    #[doc = "CT16B1_CAP1"]
    #[inline(always)]
    pub fn ct16b1_cap1(self) -> &'a mut W {
        self.variant(FUNC_A::CT16B1_CAP1)
    }
    #[doc = "TXD"]
    #[inline(always)]
    pub fn txd(self) -> &'a mut W {
        self.variant(FUNC_A::TXD)
    }
...
#[doc = "I/O configuration for PIO1_18/CT16B1_CAP1/TXD\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pio1_18](index.html) module"]
pub struct PIO1_18_SPEC;
impl crate::RegisterSpec for PIO1_18_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pio1_18::R](R) reader structure"]
impl crate::Readable for PIO1_18_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pio1_18::W](W) writer structure"]
impl crate::Writable for PIO1_18_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PIO1_18 to value 0x90"]
impl crate::Resettable for PIO1_18_SPEC {
    #[inline(always)]
