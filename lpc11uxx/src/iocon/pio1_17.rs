...
pub struct R(crate::R<PIO1_17_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PIO1_17_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<PIO1_17_SPEC>> for R {
    fn from(reader: crate::R<PIO1_17_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PIO1_17` writer"]
pub struct W(crate::W<PIO1_17_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PIO1_17_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<PIO1_17_SPEC>> for W {
    fn from(writer: crate::W<PIO1_17_SPEC>) -> Self {
        W(writer)
    }
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            0 => Some(FUNC_A::PIO1_17),
            1 => Some(FUNC_A::CT16B0_CAP1),
            2 => Some(FUNC_A::RXD),
            _ => None,
        }
    }
...
impl<'a> FUNC_W<'a> {
    ...
    pub fn pio1_17(self) -> &'a mut W {
        self.variant(FUNC_A::PIO1_17)
    }
    #[doc = "CT16B0_CAP1"]
    #[inline(always)]
    pub fn ct16b0_cap1(self) -> &'a mut W {
        self.variant(FUNC_A::CT16B0_CAP1)
    }
    #[doc = "RXD"]
    #[inline(always)]
...
#[doc = "I/O configuration for PIO1_17/CT16B0_CAP1/RXD\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pio1_17](index.html) module"]
pub struct PIO1_17_SPEC;
impl crate::RegisterSpec for PIO1_17_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pio1_17::R](R) reader structure"]
impl crate::Readable for PIO1_17_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pio1_17::W](W) writer structure"]
impl crate::Writable for PIO1_17_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PIO1_17 to value 0x90"]
impl crate::Resettable for PIO1_17_SPEC {
    #[inline(always)]
