#[doc = "Reader of register PIO1_13"]
pub type R = crate::R<u32, super::PIO1_13>;
#[doc = "Writer for register PIO1_13"]
pub type W = crate::W<u32, super::PIO1_13>;
#[doc = "Register PIO1_13 `reset()`'s with value 0x90"]
impl crate::ResetValue for super::PIO1_13 {
    type Type = u32;
    #[inline(always)]
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(FUNC_A::PIO1_13),
            1 => Val(FUNC_A::DTR),
            2 => Val(FUNC_A::CT16B0_MAT0),
            3 => Val(FUNC_A::TXD),
            i => Res(i),
        }
    }
