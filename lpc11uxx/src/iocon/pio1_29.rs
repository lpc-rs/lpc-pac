#[doc = "Reader of register PIO1_29"]
pub type R = crate::R<u32, super::PIO1_29>;
#[doc = "Writer for register PIO1_29"]
pub type W = crate::W<u32, super::PIO1_29>;
#[doc = "Register PIO1_29 `reset()`'s with value 0x90"]
impl crate::ResetValue for super::PIO1_29 {
    type Type = u32;
    #[inline(always)]
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(FUNC_A::PIO1_29),
            1 => Val(FUNC_A::SCK0),
            2 => Val(FUNC_A::CT32B0_CAP1),
            i => Res(i),
        }
    }
