#[doc = "Reader of register PIO0_1"]
pub type R = crate::R<u32, super::PIO0_1>;
#[doc = "Writer for register PIO0_1"]
pub type W = crate::W<u32, super::PIO0_1>;
#[doc = "Register PIO0_1 `reset()`'s with value 0x90"]
impl crate::ResetValue for super::PIO0_1 {
    type Type = u32;
    #[inline(always)]
...
impl From<FUNC_A> for u8 {
    ...
    fn from(variant: FUNC_A) -> Self {
        match variant {
            FUNC_A::PIO0_1 => 0,
            FUNC_A::CLKOUT => 1,
            FUNC_A::CT32B0_MAT2 => 2,
            FUNC_A::USB_FTOGGLE => 3,
        }
    }
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::PIO0_1),
            1 => Val(FUNC_A::CLKOUT),
            2 => Val(FUNC_A::CT32B0_MAT2),
            3 => Val(FUNC_A::USB_FTOGGLE),
            i => Res(i),
        }
    }
...
impl<'a> FUNC_W<'a> {
    ...
    pub fn usb_ftoggle(self) -> &'a mut W {
        self.variant(FUNC_A::USB_FTOGGLE)
    }
