...
impl core::convert::From<crate::R<PIO0_1_SPEC>> for R {
...
impl core::convert::From<crate::W<PIO0_1_SPEC>> for W {
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            ...
            1 => Some(FUNC_A::CLKOUT),
            2 => Some(FUNC_A::CT32B0_MAT2),
            3 => Some(FUNC_A::USB_FTOGGLE),
            _ => None,
        }
    }
...
#[doc = "`reset()` method sets PIO0_1 to value 0x90"]
