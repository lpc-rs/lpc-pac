...
pub struct R(crate::R<PIO0_21_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PIO0_21_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<PIO0_21_SPEC>> for R {
    fn from(reader: crate::R<PIO0_21_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PIO0_21` writer"]
pub struct W(crate::W<PIO0_21_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PIO0_21_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<PIO0_21_SPEC>> for W {
    fn from(writer: crate::W<PIO0_21_SPEC>) -> Self {
        W(writer)
    }
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            0 => Some(FUNC_A::PIO0_21),
            1 => Some(FUNC_A::CT16B1_MAT0),
            2 => Some(FUNC_A::MOSI1),
            _ => None,
        }
    }
...
impl<'a> FUNC_W<'a> {
    ...
    pub fn pio0_21(self) -> &'a mut W {
        self.variant(FUNC_A::PIO0_21)
    }
    #[doc = "CT16B1_MAT0."]
    #[inline(always)]
    pub fn ct16b1_mat0(self) -> &'a mut W {
        self.variant(FUNC_A::CT16B1_MAT0)
    }
    #[doc = "MOSI1."]
    #[inline(always)]
    pub fn mosi1(self) -> &'a mut W {
        self.variant(FUNC_A::MOSI1)
    }
...
#[doc = "I/O configuration for pin PIO0_21/CT16B1_MAT0/MOSI1\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pio0_21](index.html) module"]
pub struct PIO0_21_SPEC;
impl crate::RegisterSpec for PIO0_21_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pio0_21::R](R) reader structure"]
impl crate::Readable for PIO0_21_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pio0_21::W](W) writer structure"]
impl crate::Writable for PIO0_21_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PIO0_21 to value 0x90"]
impl crate::Resettable for PIO0_21_SPEC {
    #[inline(always)]
