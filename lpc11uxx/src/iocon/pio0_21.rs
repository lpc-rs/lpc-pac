#[doc = "Reader of register PIO0_21"]
pub type R = crate::R<u32, super::PIO0_21>;
#[doc = "Writer for register PIO0_21"]
pub type W = crate::W<u32, super::PIO0_21>;
#[doc = "Register PIO0_21 `reset()`'s with value 0x90"]
impl crate::ResetValue for super::PIO0_21 {
    type Type = u32;
    #[inline(always)]
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(FUNC_A::PIO0_21),
            1 => Val(FUNC_A::CT16B1_MAT0),
            2 => Val(FUNC_A::MOSI1),
            i => Res(i),
        }
    }
