#[doc = "Reader of register TDI_PIO0_11"]
pub type R = crate::R<u32, super::TDI_PIO0_11>;
#[doc = "Writer for register TDI_PIO0_11"]
pub type W = crate::W<u32, super::TDI_PIO0_11>;
#[doc = "Register TDI_PIO0_11 `reset()`'s with value 0x90"]
impl crate::ResetValue for super::TDI_PIO0_11 {
    type Type = u32;
    #[inline(always)]
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::TDI),
            1 => Val(FUNC_A::PIO0_11),
            2 => Val(FUNC_A::AD0),
            3 => Val(FUNC_A::CT32B0_MAT3),
            i => Res(i),
        }
    }
