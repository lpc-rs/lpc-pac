#[doc = "Reader of register PIO0_3"]
pub type R = crate::R<u32, super::PIO0_3>;
#[doc = "Writer for register PIO0_3"]
pub type W = crate::W<u32, super::PIO0_3>;
#[doc = "Register PIO0_3 `reset()`'s with value 0x90"]
impl crate::ResetValue for super::PIO0_3 {
    type Type = u32;
    #[inline(always)]
