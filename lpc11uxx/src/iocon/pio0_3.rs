...
pub struct R(crate::R<PIO0_3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PIO0_3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<PIO0_3_SPEC>> for R {
    fn from(reader: crate::R<PIO0_3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PIO0_3` writer"]
pub struct W(crate::W<PIO0_3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PIO0_3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<PIO0_3_SPEC>> for W {
    fn from(writer: crate::W<PIO0_3_SPEC>) -> Self {
        W(writer)
    }
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            0 => Some(FUNC_A::PIO0_3),
            1 => Some(FUNC_A::USB_VBUS),
            _ => None,
        }
    }
...
#[doc = "I/O configuration for pin PIO0_3/USB_VBUS\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pio0_3](index.html) module"]
pub struct PIO0_3_SPEC;
impl crate::RegisterSpec for PIO0_3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pio0_3::R](R) reader structure"]
impl crate::Readable for PIO0_3_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pio0_3::W](W) writer structure"]
impl crate::Writable for PIO0_3_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PIO0_3 to value 0x90"]
impl crate::Resettable for PIO0_3_SPEC {
    #[inline(always)]
