...
pub struct R(crate::R<PIO1_5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PIO1_5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<PIO1_5_SPEC>> for R {
    fn from(reader: crate::R<PIO1_5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PIO1_5` writer"]
pub struct W(crate::W<PIO1_5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PIO1_5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<PIO1_5_SPEC>> for W {
    fn from(writer: crate::W<PIO1_5_SPEC>) -> Self {
        W(writer)
    }
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            0 => Some(FUNC_A::PIO1_5),
            1 => Some(FUNC_A::CT32B1_CAP1),
            _ => None,
        }
    }
...
impl<'a> FUNC_W<'a> {
    ...
    pub fn pio1_5(self) -> &'a mut W {
        self.variant(FUNC_A::PIO1_5)
    }
    #[doc = "CT32B1_CAP1."]
    #[inline(always)]
    pub fn ct32b1_cap1(self) -> &'a mut W {
        self.variant(FUNC_A::CT32B1_CAP1)
    }
...
pub struct PIO1_5_SPEC;
impl crate::RegisterSpec for PIO1_5_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pio1_5::R](R) reader structure"]
impl crate::Readable for PIO1_5_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pio1_5::W](W) writer structure"]
impl crate::Writable for PIO1_5_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PIO1_5 to value 0x90"]
impl crate::Resettable for PIO1_5_SPEC {
    #[inline(always)]
