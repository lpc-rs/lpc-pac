#[doc = "Reader of register TRST_PIO0_14"]
pub type R = crate::R<u32, super::TRST_PIO0_14>;
#[doc = "Writer for register TRST_PIO0_14"]
pub type W = crate::W<u32, super::TRST_PIO0_14>;
#[doc = "Register TRST_PIO0_14 `reset()`'s with value 0x90"]
impl crate::ResetValue for super::TRST_PIO0_14 {
    type Type = u32;
    #[inline(always)]
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::TRST),
            1 => Val(FUNC_A::PIO0_14),
            2 => Val(FUNC_A::AD3),
            3 => Val(FUNC_A::CT32B1_MAT1),
            i => Res(i),
        }
    }
...
impl From<ADMODE_A> for bool {
    ...
    fn from(variant: ADMODE_A) -> Self {
        match variant {
            ADMODE_A::ANALOG => false,
            ADMODE_A::DIGITAL => true,
        }
    }
}
...
impl From<FILTR_A> for bool {
    ...
    fn from(variant: FILTR_A) -> Self {
        match variant {
            FILTR_A::ENABLED => false,
            FILTR_A::DISABLED => true,
        }
    }
}
