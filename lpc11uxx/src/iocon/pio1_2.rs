...
pub struct R(crate::R<PIO1_2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PIO1_2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<PIO1_2_SPEC>> for R {
    fn from(reader: crate::R<PIO1_2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PIO1_2` writer"]
pub struct W(crate::W<PIO1_2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PIO1_2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<PIO1_2_SPEC>> for W {
    fn from(writer: crate::W<PIO1_2_SPEC>) -> Self {
        W(writer)
    }
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            0 => Some(FUNC_A::PIO1_2),
            1 => Some(FUNC_A::CT32B1_MAT2),
            _ => None,
        }
    }
...
#[doc = "I/O configuration for pin PIO1_2/CT32B1_MAT2\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pio1_2](index.html) module"]
pub struct PIO1_2_SPEC;
impl crate::RegisterSpec for PIO1_2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pio1_2::R](R) reader structure"]
impl crate::Readable for PIO1_2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pio1_2::W](W) writer structure"]
impl crate::Writable for PIO1_2_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PIO1_2 to value 0x90"]
impl crate::Resettable for PIO1_2_SPEC {
    #[inline(always)]
