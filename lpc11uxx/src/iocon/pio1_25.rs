...
pub struct R(crate::R<PIO1_25_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PIO1_25_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<PIO1_25_SPEC>> for R {
    fn from(reader: crate::R<PIO1_25_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PIO1_25` writer"]
pub struct W(crate::W<PIO1_25_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PIO1_25_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<PIO1_25_SPEC>> for W {
    fn from(writer: crate::W<PIO1_25_SPEC>) -> Self {
        W(writer)
    }
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            0 => Some(FUNC_A::PIO1_25),
            1 => Some(FUNC_A::CT32B0_MAT1),
            _ => None,
        }
    }
...
impl<'a> FUNC_W<'a> {
    ...
    pub fn pio1_25(self) -> &'a mut W {
        self.variant(FUNC_A::PIO1_25)
    }
    #[doc = "CT32B0_MAT1."]
    #[inline(always)]
    pub fn ct32b0_mat1(self) -> &'a mut W {
        self.variant(FUNC_A::CT32B0_MAT1)
    }
...
#[doc = "I/O configuration for pin PIO1_25/CT32B0_MAT1\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pio1_25](index.html) module"]
pub struct PIO1_25_SPEC;
impl crate::RegisterSpec for PIO1_25_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pio1_25::R](R) reader structure"]
impl crate::Readable for PIO1_25_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pio1_25::W](W) writer structure"]
impl crate::Writable for PIO1_25_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PIO1_25 to value 0x90"]
impl crate::Resettable for PIO1_25_SPEC {
    #[inline(always)]
