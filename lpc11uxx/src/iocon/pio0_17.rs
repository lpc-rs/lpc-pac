...
#[doc = "Register PIO0_17 `reset()`'s with value 0x90"]
...
impl From<FUNC_A> for u8 {
    ...
    fn from(variant: FUNC_A) -> Self {
        match variant {
            FUNC_A::PIO0_17 => 0,
            FUNC_A::RTS => 1,
            FUNC_A::CT32B0_CAP0 => 2,
            FUNC_A::SCLK_UART_SYNCHRONO => 3,
        }
    }
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(FUNC_A::PIO0_17),
            1 => Val(FUNC_A::RTS),
            2 => Val(FUNC_A::CT32B0_CAP0),
            3 => Val(FUNC_A::SCLK_UART_SYNCHRONO),
            i => Res(i),
        }
    }
