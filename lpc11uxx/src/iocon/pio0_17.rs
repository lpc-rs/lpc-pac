...
pub enum FUNC_A {
    ...
    #[doc = "2: CT32B0_CAP0."]
    CT32B0_CAP0 = 2,
    #[doc = "3: SCLK (UART synchronous clock)."]
    SCLK_UART_SYNCHRONO = 3,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            0 => Some(FUNC_A::PIO0_17),
            1 => Some(FUNC_A::RTS),
            2 => Some(FUNC_A::CT32B0_CAP0),
            3 => Some(FUNC_A::SCLK_UART_SYNCHRONO),
            _ => None,
        }
    }
...
#[doc = "`reset()` method sets PIO0_17 to value 0x90"]
