...
pub struct R(crate::R<PIO0_6_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PIO0_6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<PIO0_6_SPEC>> for R {
    fn from(reader: crate::R<PIO0_6_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PIO0_6` writer"]
pub struct W(crate::W<PIO0_6_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PIO0_6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<PIO0_6_SPEC>> for W {
    fn from(writer: crate::W<PIO0_6_SPEC>) -> Self {
        W(writer)
    }
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> Option<FUNC_A> {
        match self.bits {
            0 => Some(FUNC_A::PIO0_6),
            1 => Some(FUNC_A::USB_CONNECT),
            2 => Some(FUNC_A::SCK0),
            _ => None,
        }
    }
...
impl<'a> FUNC_W<'a> {
    ...
    pub fn pio0_6(self) -> &'a mut W {
        self.variant(FUNC_A::PIO0_6)
    }
    #[doc = "USB_CONNECT."]
    #[inline(always)]
    pub fn usb_connect(self) -> &'a mut W {
        self.variant(FUNC_A::USB_CONNECT)
    }
    #[doc = "SCK0."]
    #[inline(always)]
    pub fn sck0(self) -> &'a mut W {
        self.variant(FUNC_A::SCK0)
    }
...
#[doc = "I/O configuration for pin PIO0_6/USB_CONNECT/SCK0\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pio0_6](index.html) module"]
pub struct PIO0_6_SPEC;
impl crate::RegisterSpec for PIO0_6_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pio0_6::R](R) reader structure"]
impl crate::Readable for PIO0_6_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pio0_6::W](W) writer structure"]
impl crate::Writable for PIO0_6_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PIO0_6 to value 0x90"]
impl crate::Resettable for PIO0_6_SPEC {
    #[inline(always)]
