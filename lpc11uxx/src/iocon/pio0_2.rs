...
pub struct R(crate::R<PIO0_2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PIO0_2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<PIO0_2_SPEC>> for R {
    fn from(reader: crate::R<PIO0_2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PIO0_2` writer"]
pub struct W(crate::W<PIO0_2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PIO0_2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<PIO0_2_SPEC>> for W {
    fn from(writer: crate::W<PIO0_2_SPEC>) -> Self {
        W(writer)
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    pub fn pio0_2(self) -> &'a mut W {
        self.variant(FUNC_A::PIO0_2)
    }
    #[doc = "SSEL0."]
    #[inline(always)]
    pub fn ssel0(self) -> &'a mut W {
        self.variant(FUNC_A::SSEL0)
    }
    #[doc = "CT16B0_CAP0."]
    #[inline(always)]
...
#[doc = "I/O configuration for pin PIO0_2/SSEL0/CT16B0_CAP0\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pio0_2](index.html) module"]
pub struct PIO0_2_SPEC;
impl crate::RegisterSpec for PIO0_2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pio0_2::R](R) reader structure"]
impl crate::Readable for PIO0_2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pio0_2::W](W) writer structure"]
impl crate::Writable for PIO0_2_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PIO0_2 to value 0x90"]
impl crate::Resettable for PIO0_2_SPEC {
    #[inline(always)]
