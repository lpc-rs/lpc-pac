#[doc = "Reader of register PIO0_19"]
pub type R = crate::R<u32, super::PIO0_19>;
#[doc = "Writer for register PIO0_19"]
pub type W = crate::W<u32, super::PIO0_19>;
#[doc = "Register PIO0_19 `reset()`'s with value 0x90"]
impl crate::ResetValue for super::PIO0_19 {
    type Type = u32;
    #[inline(always)]
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(FUNC_A::PIO0_19),
            1 => Val(FUNC_A::TXD),
            2 => Val(FUNC_A::CT32B0_MAT1),
            i => Res(i),
        }
    }
