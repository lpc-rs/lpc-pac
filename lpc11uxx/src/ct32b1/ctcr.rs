...
impl CIS_R {
    ...
    pub fn variant(&self) -> Option<CIS_A> {
        match self.bits {
            0 => Some(CIS_A::CT32B1_CAP0),
            1 => Some(CIS_A::CT32B1_CAP1),
            _ => None,
        }
    }
...
impl<'a> CIS_W<'a> {
    ...
    pub fn ct32b1_cap0(self) -> &'a mut W {
        self.variant(CIS_A::CT32B1_CAP0)
    }
    #[doc = "CT32B1_CAP1"]
    #[inline(always)]
    pub fn ct32b1_cap1(self) -> &'a mut W {
        self.variant(CIS_A::CT32B1_CAP1)
    }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
...
#[doc = "Field `SElCC` reader - When bit 4 is a 1, these bits select which capture input edge will cause the timer and prescaler to be cleared. These bits have no effect when bit 4 is low. Values 0x3 to 0x7 are reserved."]
...
impl SELCC_R {
    ...
    pub fn variant(&self) -> Option<SELCC_A> {
        match self.bits {
            ...
            2 => Some(SELCC_A::RISING_EDGE_OF_CT32B_CAP1),
            3 => Some(SELCC_A::FALLING_EDGE_OF_CT32_CAP1),
            _ => None,
        }
    }
...
#[doc = "Field `SElCC` writer - When bit 4 is a 1, these bits select which capture input edge will cause the timer and prescaler to be cleared. These bits have no effect when bit 4 is low. Values 0x3 to 0x7 are reserved."]
...
impl R {
    ...
    #[doc = "Bits 5:7 - When bit 4 is a 1, these bits select which capture input edge will cause the timer and prescaler to be cleared. These bits have no effect when bit 4 is low. Values 0x3 to 0x7 are reserved."]
    #[inline(always)]
