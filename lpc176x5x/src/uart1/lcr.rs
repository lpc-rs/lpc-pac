...
impl From<PS_A> for u8 {
    ...
    fn from(variant: PS_A) -> Self {
        match variant {
            ...
            PS_A::FORCED1STICK_PAR => 2,
            PS_A::FORCED0STICK_PAR => 3,
        }
    }
}
...
impl PS_R {
    ...
    pub fn variant(&self) -> PS_A {
        match self.bits {
            ...
            2 => PS_A::FORCED1STICK_PAR,
            3 => PS_A::FORCED0STICK_PAR,
            _ => unreachable!(),
        }
    }
...
impl<'a> PS_W<'a> {
    ...
    pub fn forced1stick_par(self) -> &'a mut W {
        self.variant(PS_A::FORCED1STICK_PAR)
    }
    #[doc = "Forced 0 stick parity."]
    #[inline(always)]
    pub fn forced0stick_par(self) -> &'a mut W {
        self.variant(PS_A::FORCED0STICK_PAR)
    }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub fn bits(self, value: u8) -> &'a mut W {
