#[doc = "Reader of register TXRATE"]
pub type R = crate::R<u32, super::TXRATE>;
#[doc = "Writer for register TXRATE"]
pub type W = crate::W<u32, super::TXRATE>;
#[doc = "Register TXRATE `reset()`'s with value 0"]
impl crate::ResetValue for super::TXRATE {
    type Type = u32;
    #[inline(always)]
