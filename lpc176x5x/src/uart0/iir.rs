...
#[doc = "Interrupt status. Note that UnIIR\\[0\\] is active low. The pending interrupt can be determined by evaluating UnIIR\\[3:1\\].\n\nValue on reset: 1"]
...
impl From<INTID_A> for u8 {
    ...
    fn from(variant: INTID_A) -> Self {
        match variant {
            INTID_A::_1_RECEIVE_LINE_S => 3,
            INTID_A::_2A__RECEIVE_DATA_AV => 2,
            INTID_A::_2B__CHARACTER_TIME_ => 6,
            INTID_A::_3_THRE_INTERRUPT => 1,
        }
    }
}
