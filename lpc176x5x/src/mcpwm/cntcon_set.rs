#[doc = "Writer for register CNTCON_SET"]
pub type W = crate::W<u32, super::CNTCON_SET>;
#[doc = "Register CNTCON_SET `reset()`'s with value 0"]
impl crate::ResetValue for super::CNTCON_SET {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Write proxy for field `TC0MCI0_RE_SET`"]
...
#[doc = "Write proxy for field `TC0MCI0_FE_SET`"]
...
#[doc = "Write proxy for field `TC0MCI1_RE_SET`"]
...
#[doc = "Write proxy for field `TC0MCI1_FE_SET`"]
...
#[doc = "Write proxy for field `TC0MCI2_RE_SET`"]
...
#[doc = "Write proxy for field `TC0MCI2_FE_SET`"]
...
#[doc = "Write proxy for field `TC1MCI0_RE_SET`"]
...
#[doc = "Write proxy for field `TC1MCI0_FE_SET`"]
...
#[doc = "Write proxy for field `TC1MCI1_RE_SET`"]
...
#[doc = "Write proxy for field `TC1MCI1_FE_SET`"]
...
#[doc = "Write proxy for field `TC1MCI2_RE_SET`"]
...
#[doc = "Write proxy for field `TC1MCI2_FE_SET`"]
...
#[doc = "Write proxy for field `TC2MCI0_RE_SET`"]
...
#[doc = "Write proxy for field `TC2MCI0_FE_SET`"]
...
#[doc = "Write proxy for field `TC2MCI1_RE_SET`"]
...
#[doc = "Write proxy for field `TC2MCI1_FE_SET`"]
...
#[doc = "Write proxy for field `TC2MCI2_RE_SET`"]
...
#[doc = "Write proxy for field `TC2MCI2_FE_SET`"]
...
#[doc = "Write proxy for field `CNTR0_SET`"]
...
#[doc = "Write proxy for field `CNTR1_SET`"]
...
#[doc = "Write proxy for field `CNTR2_SET`"]
