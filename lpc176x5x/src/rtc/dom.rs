#[doc = "Reader of register DOM"]
pub type R = crate::R<u32, super::DOM>;
#[doc = "Writer for register DOM"]
pub type W = crate::W<u32, super::DOM>;
#[doc = "Register DOM `reset()`'s with value 0"]
impl crate::ResetValue for super::DOM {
    type Type = u32;
    #[inline(always)]
