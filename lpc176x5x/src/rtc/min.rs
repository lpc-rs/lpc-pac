#[doc = "Reader of register MIN"]
pub type R = crate::R<u32, super::MIN>;
#[doc = "Writer for register MIN"]
pub type W = crate::W<u32, super::MIN>;
#[doc = "Register MIN `reset()`'s with value 0"]
impl crate::ResetValue for super::MIN {
    type Type = u32;
    #[inline(always)]
