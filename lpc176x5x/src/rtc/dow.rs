#[doc = "Reader of register DOW"]
pub type R = crate::R<u32, super::DOW>;
#[doc = "Writer for register DOW"]
pub type W = crate::W<u32, super::DOW>;
#[doc = "Register DOW `reset()`'s with value 0"]
impl crate::ResetValue for super::DOW {
    type Type = u32;
    #[inline(always)]
