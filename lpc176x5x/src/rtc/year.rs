#[doc = "Reader of register YEAR"]
pub type R = crate::R<u32, super::YEAR>;
#[doc = "Writer for register YEAR"]
pub type W = crate::W<u32, super::YEAR>;
#[doc = "Register YEAR `reset()`'s with value 0"]
impl crate::ResetValue for super::YEAR {
    type Type = u32;
    #[inline(always)]
