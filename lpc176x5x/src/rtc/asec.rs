#[doc = "Reader of register ASEC"]
pub type R = crate::R<u32, super::ASEC>;
#[doc = "Writer for register ASEC"]
pub type W = crate::W<u32, super::ASEC>;
#[doc = "Register ASEC `reset()`'s with value 0"]
impl crate::ResetValue for super::ASEC {
    type Type = u32;
    #[inline(always)]
