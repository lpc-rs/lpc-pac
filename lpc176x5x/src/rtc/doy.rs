#[doc = "Reader of register DOY"]
pub type R = crate::R<u32, super::DOY>;
#[doc = "Writer for register DOY"]
pub type W = crate::W<u32, super::DOY>;
#[doc = "Register DOY `reset()`'s with value 0"]
impl crate::ResetValue for super::DOY {
    type Type = u32;
    #[inline(always)]
