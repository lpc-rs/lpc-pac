#[doc = "Writer for register DEVINTCLR"]
pub type W = crate::W<u32, super::DEVINTCLR>;
#[doc = "Register DEVINTCLR `reset()`'s with value 0"]
impl crate::ResetValue for super::DEVINTCLR {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Write proxy for field `FRAMECLR`"]
...
#[doc = "Write proxy for field `EP_FASTCLR`"]
...
#[doc = "Write proxy for field `EP_SLOWCLR`"]
...
#[doc = "Write proxy for field `DEV_STATCLR`"]
...
#[doc = "Write proxy for field `CCEMPTYCLR`"]
...
#[doc = "Write proxy for field `CDFULLCLR`"]
...
#[doc = "Write proxy for field `RxENDPKTCLR`"]
...
#[doc = "Write proxy for field `TxENDPKTCLR`"]
...
#[doc = "Write proxy for field `EP_RLZEDCLR`"]
...
#[doc = "Write proxy for field `ERR_INTCLR`"]
