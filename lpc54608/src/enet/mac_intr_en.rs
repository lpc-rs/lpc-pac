#[doc = "Reader of register MAC_INTR_EN"]
pub type R = crate::R<u32, super::MAC_INTR_EN>;
#[doc = "Writer for register MAC_INTR_EN"]
pub type W = crate::W<u32, super::MAC_INTR_EN>;
#[doc = "Register MAC_INTR_EN `reset()`'s with value 0"]
impl crate::ResetValue for super::MAC_INTR_EN {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Write proxy for field `RXSTSIS`"]
