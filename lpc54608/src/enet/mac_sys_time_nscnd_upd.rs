#[doc = "Reader of register MAC_SYS_TIME_NSCND_UPD"]
pub type R = crate::R<u32, super::MAC_SYS_TIME_NSCND_UPD>;
#[doc = "Writer for register MAC_SYS_TIME_NSCND_UPD"]
pub type W = crate::W<u32, super::MAC_SYS_TIME_NSCND_UPD>;
#[doc = "Register MAC_SYS_TIME_NSCND_UPD `reset()`'s with value 0"]
impl crate::ResetValue for super::MAC_SYS_TIME_NSCND_UPD {
    type Type = u32;
    #[inline(always)]
