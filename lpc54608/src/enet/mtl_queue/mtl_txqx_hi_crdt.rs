#[doc = "Register `MTL_TXQx_HI_CRDT` reader"]
...
impl core::convert::From<crate::R<MTL_TXQX_HI_CRDT_SPEC>> for R {
    fn from(reader: crate::R<MTL_TXQX_HI_CRDT_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MTL_TXQx_HI_CRDT` writer"]
...
impl core::convert::From<crate::W<MTL_TXQX_HI_CRDT_SPEC>> for W {
    fn from(writer: crate::W<MTL_TXQX_HI_CRDT_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `HC` reader - hiCredit."]
...
#[doc = "`read()` method returns [mtl_txqx_hi_crdt::R](R) reader structure"]
impl crate::Readable for MTL_TXQX_HI_CRDT_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [mtl_txqx_hi_crdt::W](W) writer structure"]
impl crate::Writable for MTL_TXQX_HI_CRDT_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets MTL_TXQx_HI_CRDT to value 0"]
