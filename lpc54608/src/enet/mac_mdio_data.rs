#[doc = "Register `MAC_MDIO_DATA` reader"]
...
impl core::convert::From<crate::R<MAC_MDIO_DATA_SPEC>> for R {
    fn from(reader: crate::R<MAC_MDIO_DATA_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MAC_MDIO_DATA` writer"]
...
impl core::convert::From<crate::W<MAC_MDIO_DATA_SPEC>> for W {
...
#[doc = "`read()` method returns [mac_mdio_data::R](R) reader structure"]
impl crate::Readable for MAC_MDIO_DATA_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [mac_mdio_data::W](W) writer structure"]
impl crate::Writable for MAC_MDIO_DATA_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets MAC_MDIO_DATA to value 0"]
