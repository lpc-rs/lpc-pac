#[doc = "Register `STATICWAITOEN` reader"]
...
impl core::convert::From<crate::R<STATICWAITOEN_SPEC>> for R {
    fn from(reader: crate::R<STATICWAITOEN_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `STATICWAITOEN` writer"]
...
impl core::convert::From<crate::W<STATICWAITOEN_SPEC>> for W {
    fn from(writer: crate::W<STATICWAITOEN_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `WAITOEN` reader - Wait output enable."]
...
#[doc = "Field `WAITOEN` writer - Wait output enable."]
...
#[doc = "`reset()` method sets STATICWAITOEN to value 0"]
