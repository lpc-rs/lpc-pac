...
impl core::convert::From<crate::R<CRSR_PAL1_SPEC>> for R {
    fn from(reader: crate::R<CRSR_PAL1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CRSR_PAL1` writer"]
...
impl core::convert::From<crate::W<CRSR_PAL1_SPEC>> for W {
...
#[doc = "`read()` method returns [crsr_pal1::R](R) reader structure"]
impl crate::Readable for CRSR_PAL1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [crsr_pal1::W](W) writer structure"]
impl crate::Writable for CRSR_PAL1_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CRSR_PAL1 to value 0"]
