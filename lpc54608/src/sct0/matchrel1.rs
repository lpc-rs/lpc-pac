#[doc = "Reader of register MATCHREL1"]
pub type R = crate::R<u32, super::MATCHREL1>;
#[doc = "Writer for register MATCHREL1"]
pub type W = crate::W<u32, super::MATCHREL1>;
#[doc = "Register MATCHREL1 `reset()`'s with value 0"]
impl crate::ResetValue for super::MATCHREL1 {
    type Type = u32;
    #[inline(always)]
