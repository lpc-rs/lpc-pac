#[doc = "Reader of register MATCH9"]
pub type R = crate::R<u32, super::MATCH9>;
#[doc = "Writer for register MATCH9"]
pub type W = crate::W<u32, super::MATCH9>;
#[doc = "Register MATCH9 `reset()`'s with value 0"]
impl crate::ResetValue for super::MATCH9 {
    type Type = u32;
    #[inline(always)]
