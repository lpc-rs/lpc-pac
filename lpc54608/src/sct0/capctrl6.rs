#[doc = "Reader of register CAPCTRL6"]
pub type R = crate::R<u32, super::CAPCTRL6>;
#[doc = "Writer for register CAPCTRL6"]
pub type W = crate::W<u32, super::CAPCTRL6>;
#[doc = "Register CAPCTRL6 `reset()`'s with value 0"]
impl crate::ResetValue for super::CAPCTRL6 {
    type Type = u32;
    #[inline(always)]
