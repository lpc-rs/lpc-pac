#[doc = "Reader of register CAP4"]
pub type R = crate::R<u32, super::CAP4>;
#[doc = "Writer for register CAP4"]
pub type W = crate::W<u32, super::CAP4>;
#[doc = "Register CAP4 `reset()`'s with value 0"]
impl crate::ResetValue for super::CAP4 {
    type Type = u32;
    #[inline(always)]
