#[doc = "Reader of register MATCHREL7"]
pub type R = crate::R<u32, super::MATCHREL7>;
#[doc = "Writer for register MATCHREL7"]
pub type W = crate::W<u32, super::MATCHREL7>;
#[doc = "Register MATCHREL7 `reset()`'s with value 0"]
impl crate::ResetValue for super::MATCHREL7 {
    type Type = u32;
    #[inline(always)]
