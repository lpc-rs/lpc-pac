#[doc = "Reader of register MATCHREL2"]
pub type R = crate::R<u32, super::MATCHREL2>;
#[doc = "Writer for register MATCHREL2"]
pub type W = crate::W<u32, super::MATCHREL2>;
#[doc = "Register MATCHREL2 `reset()`'s with value 0"]
impl crate::ResetValue for super::MATCHREL2 {
    type Type = u32;
    #[inline(always)]
