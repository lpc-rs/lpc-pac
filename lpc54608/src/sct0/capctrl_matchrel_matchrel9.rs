...
impl core::convert::From<crate::R<CAPCTRL_MATCHREL_MATCHREL9_SPEC>> for R {
    fn from(reader: crate::R<CAPCTRL_MATCHREL_MATCHREL9_SPEC>) -> Self {
        R(reader)
    }
}
...
impl core::convert::From<crate::W<CAPCTRL_MATCHREL_MATCHREL9_SPEC>> for W {
    fn from(writer: crate::W<CAPCTRL_MATCHREL_MATCHREL9_SPEC>) -> Self {
        W(writer)
    }
}
