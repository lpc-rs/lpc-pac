#[doc = "Reader of register MATCHREL9"]
pub type R = crate::R<u32, super::MATCHREL9>;
#[doc = "Writer for register MATCHREL9"]
pub type W = crate::W<u32, super::MATCHREL9>;
#[doc = "Register MATCHREL9 `reset()`'s with value 0"]
impl crate::ResetValue for super::MATCHREL9 {
    type Type = u32;
    #[inline(always)]
