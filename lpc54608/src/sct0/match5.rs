#[doc = "Reader of register MATCH5"]
pub type R = crate::R<u32, super::MATCH5>;
#[doc = "Writer for register MATCH5"]
pub type W = crate::W<u32, super::MATCH5>;
#[doc = "Register MATCH5 `reset()`'s with value 0"]
impl crate::ResetValue for super::MATCH5 {
    type Type = u32;
    #[inline(always)]
