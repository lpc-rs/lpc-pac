#[doc = "Reader of register CAPCTRL3"]
pub type R = crate::R<u32, super::CAPCTRL3>;
#[doc = "Writer for register CAPCTRL3"]
pub type W = crate::W<u32, super::CAPCTRL3>;
#[doc = "Register CAPCTRL3 `reset()`'s with value 0"]
impl crate::ResetValue for super::CAPCTRL3 {
    type Type = u32;
    #[inline(always)]
