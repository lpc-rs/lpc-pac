#[doc = "Reader of register MATCHREL6"]
pub type R = crate::R<u32, super::MATCHREL6>;
#[doc = "Writer for register MATCHREL6"]
pub type W = crate::W<u32, super::MATCHREL6>;
#[doc = "Register MATCHREL6 `reset()`'s with value 0"]
impl crate::ResetValue for super::MATCHREL6 {
    type Type = u32;
    #[inline(always)]
