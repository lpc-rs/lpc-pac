#[doc = "Reader of register CAP9"]
pub type R = crate::R<u32, super::CAP9>;
#[doc = "Writer for register CAP9"]
pub type W = crate::W<u32, super::CAP9>;
#[doc = "Register CAP9 `reset()`'s with value 0"]
impl crate::ResetValue for super::CAP9 {
    type Type = u32;
    #[inline(always)]
