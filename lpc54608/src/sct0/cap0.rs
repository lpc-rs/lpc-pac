#[doc = "Reader of register CAP0"]
pub type R = crate::R<u32, super::CAP0>;
#[doc = "Writer for register CAP0"]
pub type W = crate::W<u32, super::CAP0>;
#[doc = "Register CAP0 `reset()`'s with value 0"]
impl crate::ResetValue for super::CAP0 {
    type Type = u32;
    #[inline(always)]
