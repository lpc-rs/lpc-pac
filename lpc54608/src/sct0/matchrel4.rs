#[doc = "Reader of register MATCHREL4"]
pub type R = crate::R<u32, super::MATCHREL4>;
#[doc = "Writer for register MATCHREL4"]
pub type W = crate::W<u32, super::MATCHREL4>;
#[doc = "Register MATCHREL4 `reset()`'s with value 0"]
impl crate::ResetValue for super::MATCHREL4 {
    type Type = u32;
    #[inline(always)]
