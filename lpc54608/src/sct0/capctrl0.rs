#[doc = "Reader of register CAPCTRL0"]
pub type R = crate::R<u32, super::CAPCTRL0>;
#[doc = "Writer for register CAPCTRL0"]
pub type W = crate::W<u32, super::CAPCTRL0>;
#[doc = "Register CAPCTRL0 `reset()`'s with value 0"]
impl crate::ResetValue for super::CAPCTRL0 {
    type Type = u32;
    #[inline(always)]
