#[doc = "Reader of register CAPCTRL9"]
pub type R = crate::R<u32, super::CAPCTRL9>;
#[doc = "Writer for register CAPCTRL9"]
pub type W = crate::W<u32, super::CAPCTRL9>;
#[doc = "Register CAPCTRL9 `reset()`'s with value 0"]
impl crate::ResetValue for super::CAPCTRL9 {
    type Type = u32;
    #[inline(always)]
