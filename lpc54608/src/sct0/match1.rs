#[doc = "Reader of register MATCH1"]
pub type R = crate::R<u32, super::MATCH1>;
#[doc = "Writer for register MATCH1"]
pub type W = crate::W<u32, super::MATCH1>;
#[doc = "Register MATCH1 `reset()`'s with value 0"]
impl crate::ResetValue for super::MATCH1 {
    type Type = u32;
    #[inline(always)]
