#[doc = "Reader of register CAP1"]
pub type R = crate::R<u32, super::CAP1>;
#[doc = "Writer for register CAP1"]
pub type W = crate::W<u32, super::CAP1>;
#[doc = "Register CAP1 `reset()`'s with value 0"]
impl crate::ResetValue for super::CAP1 {
    type Type = u32;
    #[inline(always)]
