#[doc = "Reader of register MATCHREL3"]
pub type R = crate::R<u32, super::MATCHREL3>;
#[doc = "Writer for register MATCHREL3"]
pub type W = crate::W<u32, super::MATCHREL3>;
#[doc = "Register MATCHREL3 `reset()`'s with value 0"]
impl crate::ResetValue for super::MATCHREL3 {
    type Type = u32;
    #[inline(always)]
