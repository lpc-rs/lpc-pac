#[doc = "Reader of register CAPCTRL4"]
pub type R = crate::R<u32, super::CAPCTRL4>;
#[doc = "Writer for register CAPCTRL4"]
pub type W = crate::W<u32, super::CAPCTRL4>;
#[doc = "Register CAPCTRL4 `reset()`'s with value 0"]
impl crate::ResetValue for super::CAPCTRL4 {
    type Type = u32;
    #[inline(always)]
