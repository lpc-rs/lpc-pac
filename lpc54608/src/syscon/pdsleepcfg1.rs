#[doc = "Reader of register PDSLEEPCFG1"]
pub type R = crate::R<u32, super::PDSLEEPCFG1>;
#[doc = "Writer for register PDSLEEPCFG1"]
pub type W = crate::W<u32, super::PDSLEEPCFG1>;
#[doc = "Register PDSLEEPCFG1 `reset()`'s with value 0x00f8_1f40"]
impl crate::ResetValue for super::PDSLEEPCFG1 {
    type Type = u32;
    #[inline(always)]
