#[doc = "Register `DMICCLKDIV` reader"]
...
impl core::convert::From<crate::R<DMICCLKDIV_SPEC>> for R {
    fn from(reader: crate::R<DMICCLKDIV_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DMICCLKDIV` writer"]
...
impl core::convert::From<crate::W<DMICCLKDIV_SPEC>> for W {
...
#[doc = "`read()` method returns [dmicclkdiv::R](R) reader structure"]
impl crate::Readable for DMICCLKDIV_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dmicclkdiv::W](W) writer structure"]
impl crate::Writable for DMICCLKDIV_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets DMICCLKDIV to value 0x4000_0000"]
