#[doc = "Register `USB1CLKSEL` reader"]
...
impl core::convert::From<crate::R<USB1CLKSEL_SPEC>> for R {
    fn from(reader: crate::R<USB1CLKSEL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USB1CLKSEL` writer"]
...
impl core::convert::From<crate::W<USB1CLKSEL_SPEC>> for W {
    fn from(writer: crate::W<USB1CLKSEL_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "USB1 PHY clock source selection.\n\nValue on reset: 7"]
...
#[doc = "Field `SEL` reader - USB1 PHY clock source selection."]
...
#[doc = "Field `SEL` writer - USB1 PHY clock source selection."]
pub struct SEL_W<'a> {
    w: &'a mut W,
}
impl<'a> SEL_W<'a> {
...
impl R {
    #[doc = "Bits 0:2 - USB1 PHY clock source selection."]
    #[inline(always)]
...
#[doc = "`read()` method returns [usb1clksel::R](R) reader structure"]
impl crate::Readable for USB1CLKSEL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [usb1clksel::W](W) writer structure"]
impl crate::Writable for USB1CLKSEL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets USB1CLKSEL to value 0x07"]
