...
impl core::convert::From<crate::R<LCDCLKDIV_SPEC>> for R {
    fn from(reader: crate::R<LCDCLKDIV_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `LCDCLKDIV` writer"]
...
impl core::convert::From<crate::W<LCDCLKDIV_SPEC>> for W {
...
#[doc = "`read()` method returns [lcdclkdiv::R](R) reader structure"]
impl crate::Readable for LCDCLKDIV_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [lcdclkdiv::W](W) writer structure"]
impl crate::Writable for LCDCLKDIV_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets LCDCLKDIV to value 0x4000_0000"]
