#[doc = "Reader of register USB1CLKDIV"]
pub type R = crate::R<u32, super::USB1CLKDIV>;
#[doc = "Writer for register USB1CLKDIV"]
pub type W = crate::W<u32, super::USB1CLKDIV>;
#[doc = "Register USB1CLKDIV `reset()`'s with value 0x4000_0000"]
impl crate::ResetValue for super::USB1CLKDIV {
    type Type = u32;
    #[inline(always)]
