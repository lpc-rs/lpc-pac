#[doc = "Reader of register SYSPLLPDEC"]
pub type R = crate::R<u32, super::SYSPLLPDEC>;
#[doc = "Writer for register SYSPLLPDEC"]
pub type W = crate::W<u32, super::SYSPLLPDEC>;
#[doc = "Register SYSPLLPDEC `reset()`'s with value 0"]
impl crate::ResetValue for super::SYSPLLPDEC {
    type Type = u32;
    #[inline(always)]
