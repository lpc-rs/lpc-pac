#[doc = "Reader of register AUDPLLNDEC"]
pub type R = crate::R<u32, super::AUDPLLNDEC>;
#[doc = "Writer for register AUDPLLNDEC"]
pub type W = crate::W<u32, super::AUDPLLNDEC>;
#[doc = "Register AUDPLLNDEC `reset()`'s with value 0"]
impl crate::ResetValue for super::AUDPLLNDEC {
    type Type = u32;
    #[inline(always)]
