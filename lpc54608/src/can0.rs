...
#[doc = "`write(|w| ..)` method takes [txfqs::W](txfqs::W) writer structure"]
impl crate::Writable for TXFQS {}
#[doc = "Tx FIFO/Queue Status"]
pub mod txfqs;
...
#[doc = "`write(|w| ..)` method takes [txbrp::W](txbrp::W) writer structure"]
impl crate::Writable for TXBRP {}
#[doc = "Tx Buffer Request Pending"]
pub mod txbrp;
...
#[doc = "`write(|w| ..)` method takes [txbcf::W](txbcf::W) writer structure"]
impl crate::Writable for TXBCF {}
#[doc = "Tx Buffer Cancellation Finished"]
pub mod txbcf;
...
#[doc = "Tx Event FIFO Acknowledge"]
pub mod txefa;
#[doc = "CAN Message RAM Base Address\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [mrba](mrba) module"]
pub type MRBA = crate::Reg<u32, _MRBA>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _MRBA;
#[doc = "`read()` method returns [mrba::R](mrba::R) reader structure"]
impl crate::Readable for MRBA {}
#[doc = "`write(|w| ..)` method takes [mrba::W](mrba::W) writer structure"]
impl crate::Writable for MRBA {}
#[doc = "CAN Message RAM Base Address"]
pub mod mrba;
#[doc = "External Timestamp Counter Configuration\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [etscc](etscc) module"]
pub type ETSCC = crate::Reg<u32, _ETSCC>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _ETSCC;
#[doc = "`read()` method returns [etscc::R](etscc::R) reader structure"]
impl crate::Readable for ETSCC {}
#[doc = "`write(|w| ..)` method takes [etscc::W](etscc::W) writer structure"]
impl crate::Writable for ETSCC {}
#[doc = "External Timestamp Counter Configuration"]
pub mod etscc;
#[doc = "External Timestamp Counter Value\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [etscv](etscv) module"]
pub type ETSCV = crate::Reg<u32, _ETSCV>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _ETSCV;
#[doc = "`read()` method returns [etscv::R](etscv::R) reader structure"]
impl crate::Readable for ETSCV {}
#[doc = "`write(|w| ..)` method takes [etscv::W](etscv::W) writer structure"]
impl crate::Writable for ETSCV {}
#[doc = "External Timestamp Counter Value"]
pub mod etscv;
