...
impl core::convert::From<crate::W<RBR_THR_DLL_THR_SPEC>> for W {
    fn from(writer: crate::W<RBR_THR_DLL_THR_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `THR` writer - Writing to the SCIn Transmit Holding Register causes the data to be stored in the SCIn transmit FIFO."]
pub struct THR_W<'a> {
    w: &'a mut W,
}
impl<'a> THR_W<'a> {
...
#[doc = "`write(|w| ..)` method takes [rbr_thr_dll_thr::W](W) writer structure"]
