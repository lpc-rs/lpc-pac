...
impl core::convert::From<crate::R<DATA_SPEC>> for R {
...
impl core::convert::From<crate::W<DATA_SPEC>> for W {
    fn from(writer: crate::W<DATA_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `DATA` reader - Input or output data"]
...
#[doc = "Field `DATA` writer - Input or output data"]
pub struct DATA_W<'a> {
    w: &'a mut W,
}
impl<'a> DATA_W<'a> {
...
impl R {
    #[doc = "Bits 0:31 - Input or output data"]
    #[inline(always)]
