#[doc = "Writer for register FIFOWR48H"]
pub type W = crate::W<u32, super::FIFOWR48H>;
#[doc = "Register FIFOWR48H `reset()`'s with value 0"]
impl crate::ResetValue for super::FIFOWR48H {
    type Type = u32;
    #[inline(always)]
