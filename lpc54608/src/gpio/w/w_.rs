...
impl core::convert::From<crate::R<W__SPEC>> for R {
    fn from(reader: crate::R<W__SPEC>) -> Self {
        R(reader)
    }
}
...
impl core::convert::From<crate::W<W__SPEC>> for W {
    fn from(writer: crate::W<W__SPEC>) -> Self {
        W(writer)
    }
}
