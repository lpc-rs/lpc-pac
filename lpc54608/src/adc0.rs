...
#[doc = "ADC Control register. Contains the clock divide value, resolution selection, sampling time selection, and mode controls."]
pub mod ctrl;
#[doc = "Input Select. Allows selection of the temperature sensor as an alternate input to ADC channel 0.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [insel](insel) module"]
pub type INSEL = crate::Reg<u32, _INSEL>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _INSEL;
#[doc = "`read()` method returns [insel::R](insel::R) reader structure"]
impl crate::Readable for INSEL {}
#[doc = "`write(|w| ..)` method takes [insel::W](insel::W) writer structure"]
impl crate::Writable for INSEL {}
#[doc = "Input Select. Allows selection of the temperature sensor as an alternate input to ADC channel 0."]
pub mod insel;
