#[doc = "Reader of register PIO40"]
pub type R = crate::R<u32, super::PIO40>;
#[doc = "Writer for register PIO40"]
pub type W = crate::W<u32, super::PIO40>;
#[doc = "Register PIO40 `reset()`'s with value 0x0320"]
impl crate::ResetValue for super::PIO40 {
    type Type = u32;
    #[inline(always)]
