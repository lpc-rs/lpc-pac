...
impl core::convert::From<crate::R<PIO42_SPEC>> for R {
    fn from(reader: crate::R<PIO42_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PIO42` writer"]
...
impl core::convert::From<crate::W<PIO42_SPEC>> for W {
...
#[doc = "`read()` method returns [pio42::R](R) reader structure"]
impl crate::Readable for PIO42_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pio42::W](W) writer structure"]
impl crate::Writable for PIO42_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PIO42 to value 0x0320"]
