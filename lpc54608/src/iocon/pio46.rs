#[doc = "Reader of register PIO46"]
pub type R = crate::R<u32, super::PIO46>;
#[doc = "Writer for register PIO46"]
pub type W = crate::W<u32, super::PIO46>;
#[doc = "Register PIO46 `reset()`'s with value 0x0320"]
impl crate::ResetValue for super::PIO46 {
    type Type = u32;
    #[inline(always)]
