#[doc = "Reader of register PIO41"]
pub type R = crate::R<u32, super::PIO41>;
#[doc = "Writer for register PIO41"]
pub type W = crate::W<u32, super::PIO41>;
#[doc = "Register PIO41 `reset()`'s with value 0x0320"]
impl crate::ResetValue for super::PIO41 {
    type Type = u32;
    #[inline(always)]
