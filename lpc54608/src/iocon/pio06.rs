#[doc = "Reader of register PIO06"]
pub type R = crate::R<u32, super::PIO06>;
#[doc = "Writer for register PIO06"]
pub type W = crate::W<u32, super::PIO06>;
#[doc = "Register PIO06 `reset()`'s with value 0x0320"]
impl crate::ResetValue for super::PIO06 {
    type Type = u32;
    #[inline(always)]
