#[doc = "Reader of register PIO04"]
pub type R = crate::R<u32, super::PIO04>;
#[doc = "Writer for register PIO04"]
pub type W = crate::W<u32, super::PIO04>;
#[doc = "Register PIO04 `reset()`'s with value 0x0320"]
impl crate::ResetValue for super::PIO04 {
    type Type = u32;
    #[inline(always)]
