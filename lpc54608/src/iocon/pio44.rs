#[doc = "Reader of register PIO44"]
pub type R = crate::R<u32, super::PIO44>;
#[doc = "Writer for register PIO44"]
pub type W = crate::W<u32, super::PIO44>;
#[doc = "Register PIO44 `reset()`'s with value 0x0320"]
impl crate::ResetValue for super::PIO44 {
    type Type = u32;
    #[inline(always)]
