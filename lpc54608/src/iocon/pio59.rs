#[doc = "Reader of register PIO59"]
pub type R = crate::R<u32, super::PIO59>;
#[doc = "Writer for register PIO59"]
pub type W = crate::W<u32, super::PIO59>;
#[doc = "Register PIO59 `reset()`'s with value 0x0320"]
impl crate::ResetValue for super::PIO59 {
    type Type = u32;
    #[inline(always)]
