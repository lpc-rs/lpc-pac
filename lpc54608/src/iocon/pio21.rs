#[doc = "Reader of register PIO21"]
pub type R = crate::R<u32, super::PIO21>;
#[doc = "Writer for register PIO21"]
pub type W = crate::W<u32, super::PIO21>;
#[doc = "Register PIO21 `reset()`'s with value 0x0320"]
impl crate::ResetValue for super::PIO21 {
    type Type = u32;
    #[inline(always)]
