#[doc = "Reader of register PIO05"]
pub type R = crate::R<u32, super::PIO05>;
#[doc = "Writer for register PIO05"]
pub type W = crate::W<u32, super::PIO05>;
#[doc = "Register PIO05 `reset()`'s with value 0x0320"]
impl crate::ResetValue for super::PIO05 {
    type Type = u32;
    #[inline(always)]
