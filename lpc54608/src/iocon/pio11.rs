#[doc = "Reader of register PIO11"]
pub type R = crate::R<u32, super::PIO11>;
#[doc = "Writer for register PIO11"]
pub type W = crate::W<u32, super::PIO11>;
#[doc = "Register PIO11 `reset()`'s with value 0x0320"]
impl crate::ResetValue for super::PIO11 {
    type Type = u32;
    #[inline(always)]
