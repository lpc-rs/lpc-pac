#[doc = "Register `PIO55` reader"]
pub struct R(crate::R<PIO55_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PIO55_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<PIO55_SPEC>> for R {
    fn from(reader: crate::R<PIO55_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PIO55` writer"]
pub struct W(crate::W<PIO55_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PIO55_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<PIO55_SPEC>> for W {
    fn from(writer: crate::W<PIO55_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Digital I/O control for port 5 pins PIO5_5\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pio55](index.html) module"]
pub struct PIO55_SPEC;
impl crate::RegisterSpec for PIO55_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pio55::R](R) reader structure"]
impl crate::Readable for PIO55_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pio55::W](W) writer structure"]
impl crate::Writable for PIO55_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PIO55 to value 0x0320"]
impl crate::Resettable for PIO55_SPEC {
    #[inline(always)]
