#[doc = "Reader of register PIO36"]
pub type R = crate::R<u32, super::PIO36>;
#[doc = "Writer for register PIO36"]
pub type W = crate::W<u32, super::PIO36>;
#[doc = "Register PIO36 `reset()`'s with value 0x0320"]
impl crate::ResetValue for super::PIO36 {
    type Type = u32;
    #[inline(always)]
