#[doc = "Register `PIO320` reader"]
pub struct R(crate::R<PIO320_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PIO320_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<PIO320_SPEC>> for R {
    fn from(reader: crate::R<PIO320_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PIO320` writer"]
pub struct W(crate::W<PIO320_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PIO320_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<PIO320_SPEC>> for W {
    fn from(writer: crate::W<PIO320_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Digital I/O control for port 3 pins PIO3_20\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pio320](index.html) module"]
pub struct PIO320_SPEC;
impl crate::RegisterSpec for PIO320_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pio320::R](R) reader structure"]
impl crate::Readable for PIO320_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pio320::W](W) writer structure"]
impl crate::Writable for PIO320_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PIO320 to value 0x0320"]
impl crate::Resettable for PIO320_SPEC {
    #[inline(always)]
