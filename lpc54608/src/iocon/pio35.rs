#[doc = "Reader of register PIO35"]
pub type R = crate::R<u32, super::PIO35>;
#[doc = "Writer for register PIO35"]
pub type W = crate::W<u32, super::PIO35>;
#[doc = "Register PIO35 `reset()`'s with value 0x0320"]
impl crate::ResetValue for super::PIO35 {
    type Type = u32;
    #[inline(always)]
