#[doc = "Reader of register PREAC4FSCOEF"]
pub type R = crate::R<u32, super::PREAC4FSCOEF>;
#[doc = "Writer for register PREAC4FSCOEF"]
pub type W = crate::W<u32, super::PREAC4FSCOEF>;
#[doc = "Register PREAC4FSCOEF `reset()`'s with value 0"]
impl crate::ResetValue for super::PREAC4FSCOEF {
    type Type = u32;
    #[inline(always)]
