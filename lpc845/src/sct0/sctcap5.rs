#[doc = "Reader of register SCTCAP5"]
pub type R = crate::R<u32, super::SCTCAP5>;
#[doc = "Writer for register SCTCAP5"]
pub type W = crate::W<u32, super::SCTCAP5>;
#[doc = "Register SCTCAP5 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTCAP5 {
    type Type = u32;
    #[inline(always)]
