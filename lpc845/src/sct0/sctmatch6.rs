#[doc = "Reader of register SCTMATCH6"]
pub type R = crate::R<u32, super::SCTMATCH6>;
#[doc = "Writer for register SCTMATCH6"]
pub type W = crate::W<u32, super::SCTMATCH6>;
#[doc = "Register SCTMATCH6 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTMATCH6 {
    type Type = u32;
    #[inline(always)]
