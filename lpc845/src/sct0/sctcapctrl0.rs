#[doc = "Reader of register SCTCAPCTRL0"]
pub type R = crate::R<u32, super::SCTCAPCTRL0>;
#[doc = "Writer for register SCTCAPCTRL0"]
pub type W = crate::W<u32, super::SCTCAPCTRL0>;
#[doc = "Register SCTCAPCTRL0 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTCAPCTRL0 {
    type Type = u32;
    #[inline(always)]
