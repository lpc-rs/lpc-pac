#[doc = "Register `SCTCAPCTRL[%s]` reader"]
pub struct R(crate::R<CAPCTRL_MATCHREL_SCTCAPCTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CAPCTRL_MATCHREL_SCTCAPCTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<CAPCTRL_MATCHREL_SCTCAPCTRL_SPEC>> for R {
    fn from(reader: crate::R<CAPCTRL_MATCHREL_SCTCAPCTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SCTCAPCTRL[%s]` writer"]
pub struct W(crate::W<CAPCTRL_MATCHREL_SCTCAPCTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CAPCTRL_MATCHREL_SCTCAPCTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<CAPCTRL_MATCHREL_SCTCAPCTRL_SPEC>> for W {
    fn from(writer: crate::W<CAPCTRL_MATCHREL_SCTCAPCTRL_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "SCT capture control register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [capctrl_matchrel_sctcapctrl](index.html) module"]
pub struct CAPCTRL_MATCHREL_SCTCAPCTRL_SPEC;
impl crate::RegisterSpec for CAPCTRL_MATCHREL_SCTCAPCTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [capctrl_matchrel_sctcapctrl::R](R) reader structure"]
impl crate::Readable for CAPCTRL_MATCHREL_SCTCAPCTRL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [capctrl_matchrel_sctcapctrl::W](W) writer structure"]
impl crate::Writable for CAPCTRL_MATCHREL_SCTCAPCTRL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SCTCAPCTRL[%s]
to value 0"]
impl crate::Resettable for CAPCTRL_MATCHREL_SCTCAPCTRL_SPEC {
    #[inline(always)]
