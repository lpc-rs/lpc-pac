#[doc = "Reader of register SCTCAP1"]
pub type R = crate::R<u32, super::SCTCAP1>;
#[doc = "Writer for register SCTCAP1"]
pub type W = crate::W<u32, super::SCTCAP1>;
#[doc = "Register SCTCAP1 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTCAP1 {
    type Type = u32;
    #[inline(always)]
