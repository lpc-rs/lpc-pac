#[doc = "Reader of register SCTCAPCTRL1"]
pub type R = crate::R<u32, super::SCTCAPCTRL1>;
#[doc = "Writer for register SCTCAPCTRL1"]
pub type W = crate::W<u32, super::SCTCAPCTRL1>;
#[doc = "Register SCTCAPCTRL1 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTCAPCTRL1 {
    type Type = u32;
    #[inline(always)]
