#[doc = "Reader of register DMA1REQUEST"]
pub type R = crate::R<u32, super::DMA1REQUEST>;
#[doc = "Writer for register DMA1REQUEST"]
pub type W = crate::W<u32, super::DMA1REQUEST>;
#[doc = "Register DMA1REQUEST `reset()`'s with value 0"]
impl crate::ResetValue for super::DMA1REQUEST {
    type Type = u32;
    #[inline(always)]
...
pub type DEV_1_R = crate::R<u8, u8>;
