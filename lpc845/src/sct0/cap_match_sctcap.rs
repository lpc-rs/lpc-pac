#[doc = "Register `SCTCAP[%s]` reader"]
pub struct R(crate::R<CAP_MATCH_SCTCAP_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CAP_MATCH_SCTCAP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<CAP_MATCH_SCTCAP_SPEC>> for R {
    fn from(reader: crate::R<CAP_MATCH_SCTCAP_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SCTCAP[%s]` writer"]
pub struct W(crate::W<CAP_MATCH_SCTCAP_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CAP_MATCH_SCTCAP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<CAP_MATCH_SCTCAP_SPEC>> for W {
    fn from(writer: crate::W<CAP_MATCH_SCTCAP_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "SCT capture register of capture channel\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cap_match_sctcap](index.html) module"]
pub struct CAP_MATCH_SCTCAP_SPEC;
impl crate::RegisterSpec for CAP_MATCH_SCTCAP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cap_match_sctcap::R](R) reader structure"]
impl crate::Readable for CAP_MATCH_SCTCAP_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cap_match_sctcap::W](W) writer structure"]
impl crate::Writable for CAP_MATCH_SCTCAP_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SCTCAP[%s]
to value 0"]
impl crate::Resettable for CAP_MATCH_SCTCAP_SPEC {
    #[inline(always)]
