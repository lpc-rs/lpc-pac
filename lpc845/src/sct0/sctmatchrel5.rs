#[doc = "Reader of register SCTMATCHREL5"]
pub type R = crate::R<u32, super::SCTMATCHREL5>;
#[doc = "Writer for register SCTMATCHREL5"]
pub type W = crate::W<u32, super::SCTMATCHREL5>;
#[doc = "Register SCTMATCHREL5 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTMATCHREL5 {
    type Type = u32;
    #[inline(always)]
