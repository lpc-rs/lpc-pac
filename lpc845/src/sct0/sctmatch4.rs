#[doc = "Reader of register SCTMATCH4"]
pub type R = crate::R<u32, super::SCTMATCH4>;
#[doc = "Writer for register SCTMATCH4"]
pub type W = crate::W<u32, super::SCTMATCH4>;
#[doc = "Register SCTMATCH4 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTMATCH4 {
    type Type = u32;
    #[inline(always)]
