#[doc = "Reader of register SCTCAP2"]
pub type R = crate::R<u32, super::SCTCAP2>;
#[doc = "Writer for register SCTCAP2"]
pub type W = crate::W<u32, super::SCTCAP2>;
#[doc = "Register SCTCAP2 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTCAP2 {
    type Type = u32;
    #[inline(always)]
