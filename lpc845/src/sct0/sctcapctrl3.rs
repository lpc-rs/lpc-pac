#[doc = "Reader of register SCTCAPCTRL3"]
pub type R = crate::R<u32, super::SCTCAPCTRL3>;
#[doc = "Writer for register SCTCAPCTRL3"]
pub type W = crate::W<u32, super::SCTCAPCTRL3>;
#[doc = "Register SCTCAPCTRL3 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTCAPCTRL3 {
    type Type = u32;
    #[inline(always)]
