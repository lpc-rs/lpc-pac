#[doc = "Reader of register SCTCAP7"]
pub type R = crate::R<u32, super::SCTCAP7>;
#[doc = "Writer for register SCTCAP7"]
pub type W = crate::W<u32, super::SCTCAP7>;
#[doc = "Register SCTCAP7 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTCAP7 {
    type Type = u32;
    #[inline(always)]
