...
#[doc = "Field `SIG_DONE_CLR` writer - When the bit is written to 1, the SIGNATURE_DONE bit is cleared."]
...
impl W {
    #[doc = "Bit 1 - When the bit is written to 1, the SIGNATURE_DONE bit is cleared."]
    #[inline(always)]
