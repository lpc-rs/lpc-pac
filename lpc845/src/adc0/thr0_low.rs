...
impl core::convert::From<crate::R<THR0_LOW_SPEC>> for R {
    fn from(reader: crate::R<THR0_LOW_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `THR0_LOW` writer"]
...
impl core::convert::From<crate::W<THR0_LOW_SPEC>> for W {
...
#[doc = "`read()` method returns [thr0_low::R](R) reader structure"]
impl crate::Readable for THR0_LOW_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [thr0_low::W](W) writer structure"]
impl crate::Writable for THR0_LOW_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets THR0_LOW to value 0"]
