#[doc = "Reader of register PIO0_17"]
pub type R = crate::R<u32, super::PIO0_17>;
#[doc = "Writer for register PIO0_17"]
pub type W = crate::W<u32, super::PIO0_17>;
#[doc = "Register PIO0_17 `reset()`'s with value 0xb0"]
impl crate::ResetValue for super::PIO0_17 {
    type Type = u32;
    #[inline(always)]
...
impl From<DACMODE_A> for bool {
    ...
    fn from(variant: DACMODE_A) -> Self {
        match variant {
            DACMODE_A::DISABLE => false,
            DACMODE_A::ENABLE => true,
        }
    }
}
#[doc = "Reader of field `DACMODE`"]
pub type DACMODE_R = crate::R<bool, DACMODE_A>;
impl DACMODE_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
#[doc = "Write proxy for field `DACMODE`"]
