...
#[doc = "Possible values of the field `DACMODE`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum DACMODER {
    #[doc = "Disable."]
    DISABLE,
...
impl DACMODER {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            DACMODER::DISABLE => false,
            DACMODER::ENABLE => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> DACMODER {
        match value {
            false => DACMODER::DISABLE,
            true => DACMODER::ENABLE,
        }
    }
    #[doc = "Checks if the value of the field is `DISABLE`"]
    #[inline]
    pub fn is_disable(&self) -> bool {
        *self == DACMODER::DISABLE
    }
    #[doc = "Checks if the value of the field is `ENABLE`"]
    #[inline]
    pub fn is_enable(&self) -> bool {
        *self == DACMODER::ENABLE
    }
}
...
#[doc = "Values that can be written to the field `DACMODE`"]
pub enum DACMODEW {
    #[doc = "Disable."]
    DISABLE,
    #[doc = "Enable."]
...
impl DACMODEW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            DACMODEW::DISABLE => false,
            DACMODEW::ENABLE => true,
        }
    }
}
#[doc = r" Proxy"]
pub struct _DACMODEW<'a> {
    w: &'a mut W,
}
impl<'a> _DACMODEW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: DACMODEW) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
    ...
    #[inline]
    pub fn disable(self) -> &'a mut W {
        self.variant(DACMODEW::DISABLE)
    }
    #[doc = "Enable."]
    #[inline]
    pub fn enable(self) -> &'a mut W {
        self.variant(DACMODEW::ENABLE)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl W {
    ...
    #[doc = "Bit 16 - DAC mode enable."]
    #[inline]
    pub fn dacmode(&mut self) -> _DACMODEW {
        _DACMODEW { w: self }
    }
}
