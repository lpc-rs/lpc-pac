...
impl core::convert::From<crate::R<SCTCLKSEL_SPEC>> for R {
...
impl core::convert::From<crate::W<SCTCLKSEL_SPEC>> for W {
...
#[doc = "Field `SEL` reader - Clock source for SCT clock"]
...
#[doc = "Field `SEL` writer - Clock source for SCT clock"]
pub struct SEL_W<'a> {
    w: &'a mut W,
}
impl<'a> SEL_W<'a> {
...
#[doc = "`reset()` method sets SCTCLKSEL to value 0"]
