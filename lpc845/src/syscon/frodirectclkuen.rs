#[doc = "Reader of register FRODIRECTCLKUEN"]
pub type R = crate::R<u32, super::FRODIRECTCLKUEN>;
#[doc = "Writer for register FRODIRECTCLKUEN"]
pub type W = crate::W<u32, super::FRODIRECTCLKUEN>;
#[doc = "Register FRODIRECTCLKUEN `reset()`'s with value 0"]
impl crate::ResetValue for super::FRODIRECTCLKUEN {
    type Type = u32;
    #[inline(always)]
