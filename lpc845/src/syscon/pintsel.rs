...
impl core::convert::From<crate::R<PINTSEL_SPEC>> for R {
...
impl core::convert::From<crate::W<PINTSEL_SPEC>> for W {
    fn from(writer: crate::W<PINTSEL_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `INTPIN` reader - Pin number select for pin interrupt or pattern match engine input. (PIO0_0 to PIO0_31correspond to numbers 0 to 31 and PIO1_0 to PIO1_31 correspond to numbers 32 to 63)."]
...
#[doc = "Field `INTPIN` writer - Pin number select for pin interrupt or pattern match engine input. (PIO0_0 to PIO0_31correspond to numbers 0 to 31 and PIO1_0 to PIO1_31 correspond to numbers 32 to 63)."]
...
impl R {
    #[doc = "Bits 0:5 - Pin number select for pin interrupt or pattern match engine input. (PIO0_0 to PIO0_31correspond to numbers 0 to 31 and PIO1_0 to PIO1_31 correspond to numbers 32 to 63)."]
    #[inline(always)]
