...
impl From<crate::R<PINASSIGN6_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<PINASSIGN6_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PINASSIGN6_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `SPI1_MISO_IO` reader - SPI1_MISO function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0 (= 0) to PIO0_31 (= 0x1F) and from PIO1_0 (=0x20) to PIO1_21(=0x35)."]
...
#[doc = "Field `SPI1_MISO_IO` writer - SPI1_MISO function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0 (= 0) to PIO0_31 (= 0x1F) and from PIO1_0 (=0x20) to PIO1_21(=0x35)."]
...
#[doc = "Field `SPI1_SSEL0_IO` reader - SPI1_SSEL0 function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0 (= 0) to PIO0_31 (= 0x1F) and from PIO1_0 (=0x20) to PIO1_21(=0x35)."]
...
#[doc = "Field `SPI1_SSEL0_IO` writer - SPI1_SSEL0 function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0 (= 0) to PIO0_31 (= 0x1F) and from PIO1_0 (=0x20) to PIO1_21(=0x35)."]
...
#[doc = "Field `SPI1_SSEL1_IO` reader - SPI1_SSEL1 function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0 (= 0) to PIO0_31 (= 0x1F) and from PIO1_0 (=0x20) to PIO1_21(=0x35)."]
...
#[doc = "Field `SPI1_SSEL1_IO` writer - SPI1_SSEL1 function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0 (= 0) to PIO0_31 (= 0x1F) and from PIO1_0 (=0x20) to PIO1_21(=0x35)."]
...
#[doc = "Field `SCT0_GPIO_IN_A_I` reader - SCT0_GPIO_IN_A function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0 (= 0) to PIO0_31 (= 0x1F) and from PIO1_0 (=0x20) to PIO1_21(=0x35)."]
pub struct SCT0_GPIO_IN_A_I_R(crate::FieldReader<u8, u8>);
impl SCT0_GPIO_IN_A_I_R {
    pub(crate) fn new(bits: u8) -> Self {
        SCT0_GPIO_IN_A_I_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SCT0_GPIO_IN_A_I_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
#[doc = "Field `SCT0_GPIO_IN_A_I` writer - SCT0_GPIO_IN_A function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0 (= 0) to PIO0_31 (= 0x1F) and from PIO1_0 (=0x20) to PIO1_21(=0x35)."]
