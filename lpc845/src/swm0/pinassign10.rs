...
impl core::convert::From<crate::R<PINASSIGN10_SPEC>> for R {
...
impl core::convert::From<crate::W<PINASSIGN10_SPEC>> for W {
...
impl core::ops::Deref for I2C2_SDA_IO_R {
...
#[doc = "Field `I2C2_SDA_IO` writer - I2C1_SDA function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0 (= 0) to PIO0_31 (= 0x1F) and from PIO1_0 (=0x20) to PIO1_21(=0x35)."]
pub struct I2C2_SDA_IO_W<'a> {
    w: &'a mut W,
}
impl<'a> I2C2_SDA_IO_W<'a> {
...
#[doc = "Field `I2C2_SCL_IO` writer - I2C1_SCL function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0 (= 0) to PIO0_31 (= 0x1F) and from PIO1_0 (=0x20) to PIO1_21(=0x35)."]
...
#[doc = "Field `I2C3_SDA_IO` writer - I2C3_SDA function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0 (= 0) to PIO0_31 (= 0x1F) and from PIO1_0 (=0x20) to PIO1_21(=0x35)."]
...
#[doc = "Field `I2C3_SCL_IO` writer - I2C3_SCL function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0 (= 0) to PIO0_31 (= 0x1F) and from PIO1_0 (=0x20) to PIO1_21(=0x35)."]
...
impl R {
    #[doc = "Bits 0:7 - I2C1_SDA function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0 (= 0) to PIO0_31 (= 0x1F) and from PIO1_0 (=0x20) to PIO1_21(=0x35)."]
    #[inline(always)]
    pub fn i2c2_sda_io(&self) -> I2C2_SDA_IO_R {
        I2C2_SDA_IO_R::new((self.bits & 0xff) as u8)
    }
    #[doc = "Bits 8:15 - I2C1_SCL function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0 (= 0) to PIO0_31 (= 0x1F) and from PIO1_0 (=0x20) to PIO1_21(=0x35)."]
    #[inline(always)]
    pub fn i2c2_scl_io(&self) -> I2C2_SCL_IO_R {
        I2C2_SCL_IO_R::new(((self.bits >> 8) & 0xff) as u8)
    }
    #[doc = "Bits 16:23 - I2C3_SDA function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0 (= 0) to PIO0_31 (= 0x1F) and from PIO1_0 (=0x20) to PIO1_21(=0x35)."]
    #[inline(always)]
    pub fn i2c3_sda_io(&self) -> I2C3_SDA_IO_R {
        I2C3_SDA_IO_R::new(((self.bits >> 16) & 0xff) as u8)
    }
    #[doc = "Bits 24:31 - I2C3_SCL function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0 (= 0) to PIO0_31 (= 0x1F) and from PIO1_0 (=0x20) to PIO1_21(=0x35)."]
    #[inline(always)]
    pub fn i2c3_scl_io(&self) -> I2C3_SCL_IO_R {
        I2C3_SCL_IO_R::new(((self.bits >> 24) & 0xff) as u8)
    }
}
impl W {
    #[doc = "Bits 0:7 - I2C1_SDA function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0 (= 0) to PIO0_31 (= 0x1F) and from PIO1_0 (=0x20) to PIO1_21(=0x35)."]
    #[inline(always)]
    pub fn i2c2_sda_io(&mut self) -> I2C2_SDA_IO_W {
        I2C2_SDA_IO_W { w: self }
    }
    #[doc = "Bits 8:15 - I2C1_SCL function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0 (= 0) to PIO0_31 (= 0x1F) and from PIO1_0 (=0x20) to PIO1_21(=0x35)."]
    #[inline(always)]
