...
pub struct SCT0_GPIO_IN_B_IR {
    bits: u8,
}
impl SCT0_GPIO_IN_B_IR {
...
#[doc = r" Value of the field"]
pub struct SCT0_GPIO_IN_C_IR {
    bits: u8,
}
impl SCT0_GPIO_IN_C_IR {
    #[doc = r" Value of the field as raw bits"]
    #[inline]
    pub fn bits(&self) -> u8 {
        self.bits
...
#[doc = r" Value of the field"]
pub struct SCT0_GPIO_IN_D_IR {
    bits: u8,
}
impl SCT0_GPIO_IN_D_IR {
    #[doc = r" Value of the field as raw bits"]
    #[inline]
    pub fn bits(&self) -> u8 {
        self.bits
...
#[doc = r" Proxy"]
pub struct _SCT0_GPIO_IN_B_IW<'a> {
    w: &'a mut W,
}
impl<'a> _SCT0_GPIO_IN_B_IW<'a> {
...
#[doc = r" Proxy"]
pub struct _SCT0_GPIO_IN_C_IW<'a> {
    w: &'a mut W,
}
impl<'a> _SCT0_GPIO_IN_C_IW<'a> {
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
        const MASK: u8 = 255;
...
#[doc = r" Proxy"]
pub struct _SCT0_GPIO_IN_D_IW<'a> {
    w: &'a mut W,
}
impl<'a> _SCT0_GPIO_IN_D_IW<'a> {
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
        const MASK: u8 = 255;
...
impl R {
    ...
    #[inline]
    pub fn sct0_gpio_in_b_i(&self) -> SCT0_GPIO_IN_B_IR {
        let bits = {
            const MASK: u8 = 255;
            const OFFSET: u8 = 0;
            ((self.bits >> OFFSET) & MASK as u32) as u8
        };
        SCT0_GPIO_IN_B_IR { bits }
    }
    ...
    #[inline]
    pub fn sct0_gpio_in_c_i(&self) -> SCT0_GPIO_IN_C_IR {
        let bits = {
            const MASK: u8 = 255;
            const OFFSET: u8 = 8;
            ((self.bits >> OFFSET) & MASK as u32) as u8
        };
        SCT0_GPIO_IN_C_IR { bits }
    }
    ...
    #[inline]
    pub fn sct0_gpio_in_d_i(&self) -> SCT0_GPIO_IN_D_IR {
        let bits = {
            const MASK: u8 = 255;
            const OFFSET: u8 = 16;
            ((self.bits >> OFFSET) & MASK as u32) as u8
        };
        SCT0_GPIO_IN_D_IR { bits }
    }
...
impl W {
    ...
    #[doc = "Bits 0:7 - SCT0_GPIO_IN_B function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0 (= 0) to PIO0_31 (= 0x1F) and from PIO1_0 (=0x20) to PIO1_21(=0x35)."]
    #[inline]
    pub fn sct0_gpio_in_b_i(&mut self) -> _SCT0_GPIO_IN_B_IW {
        _SCT0_GPIO_IN_B_IW { w: self }
    }
    #[doc = "Bits 8:15 - SCT0_GPIO_IN_C function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0 (= 0) to PIO0_31 (= 0x1F) and from PIO1_0 (=0x20) to PIO1_21(=0x35)."]
    #[inline]
    pub fn sct0_gpio_in_c_i(&mut self) -> _SCT0_GPIO_IN_C_IW {
        _SCT0_GPIO_IN_C_IW { w: self }
    }
    #[doc = "Bits 16:23 - SCT0_GPIO_IN_D function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0 (= 0) to PIO0_31 (= 0x1F) and from PIO1_0 (=0x20) to PIO1_21(=0x35)."]
    #[inline]
    pub fn sct0_gpio_in_d_i(&mut self) -> _SCT0_GPIO_IN_D_IW {
        _SCT0_GPIO_IN_D_IW { w: self }
    }
    #[doc = "Bits 24:31 - SCT_OUT0 function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0 (= 0) to PIO0_31 (= 0x1F) and from PIO1_0 (=0x20) to PIO1_21(=0x35)."]
    #[inline]
